...
CPP_PROJ=/nologo /MDd /W3 /GX /ZI /Od /I "$(KZD):\$(KZV)\w\incz" /I "$(KZD):\$(KZV)\w\incr" /I "$(KZD):\$(KZV)\a\incz" /I "$(KZD):\$(KZV)\a\incr" /I "$(KZD):\$(KZV)\a\zdr" /I "..\tzaxctl" /D "_DEBUG" /D "_WINDLL" /D "_AFXEXT" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "__WIN32__" /D "_USE_DATASET_" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /TP /c
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\tzaxcfgd.bsc"
BSC32_SBRS= \
