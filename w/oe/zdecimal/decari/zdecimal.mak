...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /GX /O2 /Zp /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "TB_NT" \
 /Fp"$(INTDIR)\zdecimal.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c
CPP_OBJS=.\Release/
CPP_SBRS=.
...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /Gm /GX /Zp /Zi /Od /I $(DecariInc) \
 /I "..\..\..\incr" /I "..\..\..\..\a\incr" /I "..\..\..\..\a\incz" /D\
 "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "TB_NT"\
 /Fp"$(INTDIR)\zdecimal.pch" /YX /Fo"$(INTDIR)\\" /Fd"..\..\..\bin\zdecimal.pdb" /FD /c
CPP_OBJS=.\Debug/
CPP_SBRS=.
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /out:"..\..\..\bin\zdecimal.dll" /implib:"..\..\..\libz\zdecimal.lib" /pdbtype:sept
DEF_FILE= \
   ".\ZDECIMAL.DEF"
LINK32_OBJS= \
   "$(INTDIR)\decari.obj" \
