...
typedef LNameRecord zFAR *LPLNAME;
#define LPLNAME_DEF
...
typedef DataRecordRecord zFAR *LPDATARECORD;

typedef struct DataFieldStruct DataFieldRecord;
typedef DataFieldRecord zFAR *LPDATAFIELD;

typedef struct RelRecordStruct RelRecordRecord;
typedef RelRecordRecord zFAR *LPRELRECORD;

typedef struct RelFieldStruct RelFieldRecord;
typedef RelFieldRecord zFAR *LPRELFIELD;
...
typedef HandlerRecord zFAR *LPHANDLER;

typedef struct DBHandlerStruct DBHandlerRecord;
typedef DBHandlerRecord zFAR *LPDBHANDLER;

typedef struct GKHandlerStruct GKHandlerRecord;
typedef GKHandlerRecord zFAR *LPGKHANDLER;

typedef struct ViewNameStruct ViewNameRecord;
typedef ViewNameRecord zFAR *LPVIEWNAME;
...
typedef TaskOperationRecord zFAR *LPTASKOPER;
...
typedef zSHORT (POPERATION zPDBHOPER)( zLONG        hTask,
                                       ...
                                       zVIEW        lpQualView,
                                       zPVOID       lpPtr );
typedef zPDBHOPER zFAR *zlpPDBHOPER;
