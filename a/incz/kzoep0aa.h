...
void LOCALOPER
fnConvertEnvironmentString( zPCHAR pszTarget, zPCHAR pszSource );
...
zSHORT
fnValidateAttributeParameters( LPTASK          zFAR *plpReturnTask,
                               LPVIEWENTITY    zFAR *plpReturnViewEntity,
                               LPVIEWENTITYCSR zFAR *plpReturnViewEntityCsr,
                               LPVIEWATTRIB    zFAR *plpReturnViewAttrib,
                               zSHORT          iOperationID,
...
zSHORT
fnValidateCursorParameters( LPTASK          zFAR *lpReturnTask,
                            LPVIEWENTITY    zFAR *lpReturnViewEntity,
                            LPVIEWENTITY    zFAR *lpReturnScopingViewEntity,
                            LPVIEWENTITYCSR zFAR *lpReturnViewEntityCsr,
                            LPVIEWENTITYCSR zFAR *lpReturnScopingViewEntityCsr,
                            zSHORT  iOperationID,
                            zVIEW   zView,
                            zCPCHAR  szEntityName,
...
fnCheckChildEntities( zVIEW            lpView,
                      LPENTITYINSTANCE zFAR *lpEntityInstance,
...
fnValidViewEntity( LPVIEWENTITYCSR zFAR *lpReturnViewEntityCsr,
