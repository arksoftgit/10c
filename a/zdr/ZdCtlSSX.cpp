...
SS_TraceDone( )
{
   ...
   while ( clf->m_pNext )
   {
      ...
      zstrcpy( szBuffer, "   Function: " );
      zstrcat( szBuffer, clf->m_pNext->m_pchFunctionName );
      zstrcat( szBuffer, " access count: " );
                      ...
                      zCHAR const *pchFunctionName )
{
   ...
   zstrcpy( m_pchFunctionName, pchFunctionName );
   m_nLth = strlen( pchFileName );
   m_pchFileName = new char[ m_nLth + 1 ];
   zstrcpy( m_pchFileName, pchFileName );
   m_pNext = 0;
   m_lCnt = 1;
}
...
// zsprintf( szMsg, "SelectFont new: %d   old: %d",
...
// zsprintf( szMsg, "SelectPen new: %d   old: %d",
...
// zsprintf( szMsg, "SelectBrush new: %d   old: %d",
...
// zsprintf( szMsg, "SelectBitmap new: %d   old: %d",
