                       ...
                       zULONG   ulZFlags )
{
   ...
   if ( GetWindowAndCtrl( &pZSubtask, 0, vSubtask, 0 ) == 0 )
   {
      ...
      {
         pchDfltExt = new char[ zstrlen( cpcDefaultExtension ) + 1 ];
         zstrcpy( pchDfltExt, cpcDefaultExtension );
      }
      else
         pchDfltExt = 0;
      ...
      if ( ulZFlags & zOFN_GETDIRECTORY )
      {
         ...
         {
            nRC = IDOK;
            zstrcpy( pchFileName, dlg.m_csPath );
         }
         else
         {
            nRC = 2;
      ...
      else
      {
         ...
         if ( nRC == IDOK )
         {
            zstrcpy( pchFileName, dlg.GetPathName( ) );
         }
         else
         {
