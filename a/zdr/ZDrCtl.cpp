...
// this case it just compares the names embedded in the ZMapAct type.
zSHORT
...
//
// PURPOSE: This routine finds a control ensuring that the requested
//          control ID is valid.  First ... first use the incoming id
//          as an index into the ZBinCtrl collection array ... if that
//          doesn't yield the correct control, sequentially search
//          through the collection array until found.  If not found,
//          return 0.
//
/////////////////////////////////////////////////////////////////////////////
ZMapAct *
