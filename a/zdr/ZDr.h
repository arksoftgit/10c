...
#ifdef __WIN16__
   // Members which are implemented only in the later
   // versions of the mfc. For 16-bit we have to implement them.
   void ParseCommandLine( ZCommandLineInfo& rCmdInfo );
   BOOL ProcessShellCommand( ZCommandLineInfo& rCmdInfo );

   ZCommandLineInfo *m_pCmdInfo;
#endif
...
#undef zstrcmp
#define zstrcmp( sz1, sz2 ) ((*((LPCTSTR) (sz1)) == *((LPCTSTR) (sz2))) ? strcmp( (LPCTSTR) (sz1), (LPCTSTR) (sz2) ) : (*((LPCTSTR) (sz1)) - *((LPCTSTR) (sz2))) > 0 ? 1 : -1)
