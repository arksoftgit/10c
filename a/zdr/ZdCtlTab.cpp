                    ...
                    "NotePage" )
{
   ...
   m_pchCaption = new char[ zstrlen( pCtrlDef->Text ) + 1 ];
   zstrcpy( m_pchCaption, pCtrlDef->Text );
                             ...
                             zCPCHAR cpcStringProperty )
{
   switch ( lPropertyType )
   {
      case zCONTROL_PROPERTY_STRING_DATA:
      {
         ...
         pch = new char[ zstrlen( cpcStringProperty ) + 1 ];
         zstrcpy( pch, cpcStringProperty );
                     ...
                     zPCHAR   pchSubCtrlTag )
{
   ...
   if ( GetWindowAndCtrl( &pZSubtask, &pzma, vSubtask, cpcCtrlTag ) == 0 )
   {
      ...
      if ( pTab )
      {
         ...
         if ( pNotePage )
         {
            zstrcpy( pchSubCtrlTag, *(pNotePage->m_pzsTag) );
            return( pNotePage->m_nTabIdx + 1 );
         }
         else
            return( 0 );
                     ...
                     zCPCHAR  cpcTabToActivate )
{
   ...
   if ( GetWindowAndCtrl( &pZSubtask, &pzma, vSubtask, cpcCtrlTag ) == 0 )
   {
      ...
      if ( pTab )
      {
         ...
         while ( pNotePage )
         {
            if ( zstrcmp( *(pNotePage->m_pzsTag), cpcTabToActivate ) == 0 )
            {
                     ...
                     zLONG    lClrTab )
{
   ...
   if ( GetWindowAndCtrl( &pZSubtask, &pzma, vSubtask, cpcCtrlTag ) == 0 )
   {
      ...
      if ( pTab )
      {
         ...
         while ( pNotePage )
         {
            if ( zstrcmp( *(pNotePage->m_pzsTag), cpcSubTab ) == 0 )
            {
               if ( lClrText != -1 )
...
// nHide /= nHide - nHide;
   ...
   if ( GetWindowAndCtrl( &pZSubtask, &pzma, vSubtask, cpcCtrlTag ) == 0 )
   {
      ...
      if ( pTab )
      {
         ...
         while ( pNotePage )
         {
            if ( zstrcmp( *(pNotePage->m_pzsTag), cpcTabToHide ) == 0 )
