...

{
   ...
   zPCHAR pchValidHTML_TagList = new char[ zstrlen( cpcValidHTML_TagList ) + 1 ];
   CString csSpace = "                                                                                                    ";
   CString cs;
   zLONG   lLevel = 0;
   ...
   m_lFlags = lFlags;
   zstrcpy( pchValidHTML_TagList, cpcValidHTML_TagList );
   csHTML = "";
   ...
   while ( nRC == zCURSOR_SET )
   {
      ...
      if ( pch[ 0 ] == 'Y' )
      {
         ...
         if ( lTagType & 1 )
         {
            ...
            while ( nRC == zCURSOR_SET )
            {
               GetStringFromAttribute( szDelimiter, vSrc, m_csAttributeEntity, m_csAttributeDelimiter );
                                ...
                                zCPCHAR cpcHTML_SrcAttributeDelimiter )
{
   ...
   zstrncpy( pchHTML_Text, csPage, ulMaxLth );
                              ...
                              zLONG   lFlag )
{
   ...
   zstrcpy( pchSrcListEntity, cpcSrcListEntityScope );
   ...
   pch = new char[ zstrlen( cpcSrcEAC ) + 1 ];
   zstrcpy( pch, cpcSrcEAC );
                             ...
                             zLONG   lFlag )
{
   ...
   pch = new char[ zstrlen( cpcTgtEAC ) + 1 ];
   zstrcpy( pch, cpcTgtEAC );
   ...
   GetStringFromAttribute( pch, vSrc, cpcSrcEntity, cpcSrcAttribute );
                               ...
                               zCPCHAR cpcValidHTML_TagList )
{
   ...
   zstrcpy( pchUnformattedHTML, pchHTML );
                               ...
                               zCPCHAR cpcValidHTML_TagList )
{
   ...
   else
   {
      ...
      TraceLine( "RemoveFormattingFromHTML_Text length: %d   HTML: %s",
                 csPage.GetLength( ), csPage );
                   ...
                   zCPCHAR cpcTag )
{
   ...
   // Things are good.  Send back the revised HTML.
   zstrcpy( pchReturnTag, csReturnTag );
   zstrcpy( pchHTML_Text, csPage );
