                           ...
                           lType, bPlaceHolder, lZKey, lTabStopNbr, lCtrlID )
{
   ...
   if ( vCtrl )
   {
      ...
      m_pchCaption = new char[ zstrlen( pch ) + 1 ];
      zstrcpy( m_pchCaption, pch );
      ...
      {
         SetAttributeFromAttribute( vCtrl, szlControl, szlSyncKey,
                                    vCtrl, szlControl, szlType );
      }
   }
   else
   {
      ...
      m_pchCaption = new char[ zstrlen( pchText ) + 1 ];
      zstrcpy( m_pchCaption, pchText );
   }
