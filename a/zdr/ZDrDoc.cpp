                       ...
                       CWnd *pNewView )
{
   ...
   zsprintf( szMsg, "ZSplitterWnd::AddView(0x%08x) Row: %ld, Col: %ld, "
                    "PaneId: 0x%08x, ViewId: 0x%08x, View: 0x%08x",
             this, (zLONG) nRow, (zLONG) nCol, lPaneId, lViewId, pNewView );
   TraceLineS( szMsg, "" );
   zsprintf( szMsg, "PaneViews After AddView: 0x%08x", pNewView );
   m_mapIdPaneViews.Display( szMsg );
   zsprintf( szMsg, "CurrentViews After AddView: 0x%08x", pNewView );
...
ZSplitterWnd::RemoveView( zLONG lViewId )
{
   ...
   zsprintf( szMsg, "PaneViews After RemoveView: 0x%08x", pZView );
   m_mapIdPaneViews.Display( szMsg );
   zsprintf( szMsg, "CurrentViews After RemoveView: 0x%08x", pZView );
   m_mapCurrentViews.Display( szMsg );
...
ZSplitterWnd::SetCurrentView( zSHORT nRow, zSHORT nCol, zLONG lViewId )
{
   ...
   zsprintf( szMsg, "ZSplitterWnd::SetCurrentView(0x%08x) Row: %d  Col: %d  View: 0x%08x",
             this, nRow, nCol, pZView );
   TraceLineS( szMsg, "" );
}
...
ZSplitterWnd::SetSubtaskForViewId( zLONG lViewId, ZSubtask *pZSubtask )
{
   ...
   if ( pItem )
   {
      ...
      zsprintf( szMsg, "ZSplitterWnd::SetSubtaskForViewId Row: %ld, Col: %ld, "
                       "PaneId: 0x%08x, ViewId: 0x%08x, ZSubtask: 0x%08x  ZView: 0x%08x",
                p.x, p.y, pItem->m_lValue2, lViewId, pZSubtask,
                pZSubtask ? pZSubtask->m_pZView : 0 );
      TraceLineS( szMsg, "" );
      ...
      for ( zSHORT nRow = 0; nRow < 2; nRow++ )
      {
         ...
         if ( pZView )
         {
            ...
            zsprintf( szMsg, "ZSplitterWnd::DispView(0x%08x) Row: %ld, Col: %ld, "
                             "PaneId: 0x%08x, ViewId: 0x%08x, View: 0x%08x, ZSubtask: 0x%08x",
                      this, (zLONG) nRow, (zLONG) nCol, lPaneId, lViewId, pZView, pZSubtask );
            TraceLineS( szMsg, "" );
         }
      }
#endif
