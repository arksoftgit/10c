   ...
   if ( lCtrlBOI_Size && pchCtrlBOI )
   {
      ...
      if ( pch0 != pchEnd )
      {
         ...
         if ( *pch1 == ';' )
         {
            ...
            zstrcpy( pBMP->szBMPUpOrIconName, ++pch1 );
         }
         else
         {
            zstrcpy( pBMP->szBMPUpOrIconName, pch0 );
         }
         ...
         if ( pch0 != pchEnd )
         {
            ...
            if ( *pch1 == ';' )
            {
               ...
               zstrcpy( pBMP->szBMPDownName, ++pch1 );
            }
            else
            {
               zstrcpy( pBMP->szBMPDownName, pch0 );
            }
            ...
            if ( pch0 != pchEnd )
            {
               ...
               if ( *pch1 == ';' )
               {
                  ...
                  zstrcpy( pBMP->szBMPFocusName, ++pch1 );
               }
               else
               {
                  zstrcpy( pBMP->szBMPFocusName, pch0 );
               }
               ...
               if ( pch0 != pchEnd )
               {
                  ...
                  if ( *pch1 == ';' )
                  {
                     ...
                     zstrcpy( pBMP->szBMPDisabledName, ++pch1 );
                  }
                  else
                  {
                     zstrcpy( pBMP->szBMPDisabledName, pch0 );
                  }
               }
            }
         }
