...
//    wc.hbrBackground = (HBRUSH) (COLOR_WINDOW + 1);
      ...
      {
         zstrcpy( szErrorClass, VA_SPREAD_CLASS_NAME );
         break;
      }
      ...
      if ( AfxRegisterClass( &wc ) == 0 )
      {
         zstrcpy( szErrorClass, VA_GENERAL_CLASS_NAME );
         break;
      }
      ...
      if ( GetClassInfo( 0, SSClassNames[ 0 ].TBEdit, &wc ) )
      {
         ...
         if ( AfxRegisterClass( &wc ) == 0 )
         {
            zstrcpy( szErrorClass, SSClassNames[ 0 ].SSEdit );
            break;
         }
      }
      ...
      if ( GetClassInfo( 0, "Edit", &wc ) )
      {
         ...
         if ( AfxRegisterClass( &wc ) == 0 )
         {
            zstrcpy( szErrorClass, SSClassNames[ 0 ].SSEditHScroll );
            break;
         }
      }
...
//    wc.style         = CS_HREDRAW | CS_VREDRAW | CS_DBLCLKS | CS_GLOBALCLASS;
      ...
      if ( AfxRegisterClass( &wc ) == 0 )
      {
         zstrcpy( szErrorClass, SSClassNames[ 0 ].TBCheckBox );
         break;
      }
      ...
      if ( GetClassInfo( 0, SSClassNames[ 0 ].TBCheckBox, &wc ) )
      {
         ...
         if ( AfxRegisterClass( &wc ) == 0 )
         {
            zstrcpy( szErrorClass, SSClassNames[ 0 ].SSCheckBox );
            break;
         }
      }
      ...
      if ( GetClassInfo( 0, "ListBox", &wc ) )
      {
         ...
         if ( AfxRegisterClass( &wc ) == 0 )
         {
            zstrcpy( szErrorClass, SSClassNames[ 0 ].SSListBox );
            break;
         }
      }
...
//    wc.style         = CS_HREDRAW | CS_VREDRAW | CS_DBLCLKS | CS_GLOBALCLASS;
      ...
      if ( AfxRegisterClass( &wc ) == 0 )
      {
         zstrcpy( szErrorClass, SSClassNames[ 0 ].TBComboBox );
         break;
      }
      ...
      if ( GetClassInfo( 0, "Edit", &wc ) )
      {
         ...
         if ( AfxRegisterClass( &wc ) == 0 )
         {
            zstrcpy( szErrorClass, SSClassNames[ 0 ].SSEditComboBox );
            break;
         }
      }
      ...
      if ( GetClassInfo( 0, SSClassNames[ 0 ].TBComboBox, &wc ) )
      {
         ...
         if ( AfxRegisterClass( &wc ) == 0 )
         {
            zstrcpy( szErrorClass, SSClassNames[ 0 ].SSComboBox );
            break;
         }
      }
      ...
      if ( AfxRegisterClass( &wc ) == 0 )
      {
         zstrcpy( szErrorClass, VA_DATE_CLASS_NAME );
         break;
      }
#endif
      ...
      if ( AfxRegisterClass( &wc ) == 0 )
      {
         zstrcpy( szErrorClass, VA_TIME_CLASS_NAME );
         break;
      }
#endif
      ...
      if ( AfxRegisterClass( &wc ) == 0 )
      {
         zstrcpy( szErrorClass, VA_INTEGER_CLASS_NAME );
         break;
      }
#endif
      ...
      if ( AfxRegisterClass( &wc ) == 0 )
      {
         zstrcpy( szErrorClass, VA_FLOAT_CLASS_NAME );
         break;
      }
#endif
      ...
      if ( AfxRegisterClass( &wc ) == 0 )
      {
         zstrcpy( szErrorClass, VA_PIC_CLASS_NAME );
         break;
      }
#endif
...
//    wc.style         = CS_DBLCLKS | CS_VREDRAW | CS_HREDRAW | CS_GLOBALCLASS;
      ...
      if ( AfxRegisterClass( &wc ) == 0 )
      {
         zstrcpy( szErrorClass, VA_CALENDAR_CLASS_NAME );
         break;
      }
#endif
#endif
      ...
      {
         zstrcpy( szErrorClass, VA_VIEWPICT_CLASS_NAME );
         break;
      }
      ...
      {
         zstrcpy( szErrorClass, VA_SPINBTN_CLASS_NAME );
         break;
      }
#endif
...
// SS_CLRTBLITEM   ForeClrTblItem;
   ...
   static WORD  zFAR Bits[ ]  = {0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55};
   static WORD  zFAR Bits2[ ] = {0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA};
...
HPSTR
SS_HugeBufferAlloc( HPSTR Buffer, zPLONG BufferLth, void zFAR *Value,
