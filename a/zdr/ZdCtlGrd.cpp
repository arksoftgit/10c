...
// if ( zstrcmp( *m_pzsTag, "lbAttribute" ) == 0 )
   ...
   TranslateValue( szMap, TRUE, (zSHORT) lCol );
   csText = szMap;
               ...
               zSHORT   bLock )
{
   ...
   if ( GetWindowAndCtrl( &pZSubtask, &pzma, vSubtask, cpcCtrlTag ) == 0 )
   {
      ...
      TraceLineS( "drvr - Invalid control type for GridLockColumn ",
                  cpcCtrlTag );
   }
                   ...
                   zPLONG   plActiveCol )
{
   ...
   *plActiveRow = *plActiveCol = 0;
   if ( GetWindowAndCtrl( &pZSubtask, &pzma, vSubtask, cpcCtrlTag ) == 0 )
   {
      ...
      TraceLineS( "drvr - Invalid control type for GridGetActiveCell ",
                  cpcCtrlTag );
   }
                 ...
                 zLONG    lColNbr )
{
   ...
   *pchReturnData = 0;
   if ( GetWindowAndCtrl( &pZSubtask, &pzma, vSubtask, cpcCtrlTag ) == 0 )
   {
      ...
      TraceLineS( "drvr - Invalid control type for GridGetCellData ",
                  cpcCtrlTag );
   }
