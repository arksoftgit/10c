                ...
                zBOOL    bRepository )
{
   ...
   switch ( nType )
   {
      ...
      case  zREFER_LOD_META:
         nRC = cfTZZOLODO_PostCheckout( vZeidonCM, vMOI_View,
                                        vTaskLPLR, bRepository );
         break;

      case  zSOURCE_DIALOG_META:
      case  zREFER_DIALOG_META:
         nRC = cfTZWDLGSO_PostCheckout( vZeidonCM, vMOI_View,
                                        vTaskLPLR, bRepository );
         break;

      case  zSOURCE_ERD_META:
      case  zREFER_ERD_META:
         nRC = cfTZEREMDO_PostCheckout( vZeidonCM, vMOI_View,
                                        vTaskLPLR, bRepository );
         break;

      case  zSOURCE_DTE_META:
      case  zREFER_DTE_META:
         nRC = cfTZTENVRO_PostCheckout( vZeidonCM, vMOI_View,
                                        vTaskLPLR, bRepository );
         break;

      case  zSOURCE_SA_META:
      case  zREFER_SA_META:
         nRC = cfTZERSASO_PostCheckout( vZeidonCM, vMOI_View,
                                        vTaskLPLR, bRepository );
         break;

      case  zSOURCE_UIS_META:
      case  zREFER_UIS_META:
         nRC = cfTZADCSDO_PostCheckout( vZeidonCM, vMOI_View,
                                        vTaskLPLR, bRepository );
         break;

      case  zSOURCE_VOR_META:
      case  zREFER_VOR_META:
         nRC = cfTZWDVORO_PostCheckout( vZeidonCM, vMOI_View,
                                        vTaskLPLR, bRepository );
         break;

      case  zSOURCE_PENV_META:
      case  zREFER_PENV_META:
         nRC = cfTZPESRCO_PostCheckout( vZeidonCM, vMOI_View,
                                        vTaskLPLR, bRepository );
         break;

      case  zSOURCE_REPORT_META:
      case  zREFER_REPORT_META:
         nRC = cfTZRPSRCO_PostCheckout( vZeidonCM, vMOI_View,
                                        vTaskLPLR, bRepository );
         break;
                ...
                zBOOL    bCheckin )
{
   ...
   switch ( nType )
   {
      case  zSOURCE_LOD_META:
      case  zREFER_LOD_META:
         nRC = cfTZZOLODO_PostActivate( vSubtask, szSyncDate, vZeidonCM,
                                        vMOI_View, vTaskLPLR,
                                        PhaseCtl, bCheckin );
         break;
      ...
      case  zSOURCE_DIALOG_META:
      case  zREFER_DIALOG_META:
         nRC = cfTZWDLGSO_PostActivate( vSubtask, szSyncDate, vZeidonCM,
                                        vMOI_View, vTaskLPLR,
                                        PhaseCtl, bCheckin );
         break;
      ...
      case  zSOURCE_ERD_META:
      case  zREFER_ERD_META:
         nRC = cfTZEREMDO_PostActivate( vSubtask, szSyncDate, vZeidonCM,
                                        vMOI_View, vTaskLPLR,
                                        PhaseCtl, bCheckin );
         break;
      ...
      case  zSOURCE_DTE_META:
      case  zREFER_DTE_META:
         nRC = cfTZTENVRO_PostActivate( vSubtask, szSyncDate, vZeidonCM,
                                        vMOI_View, vTaskLPLR,
                                        PhaseCtl, bCheckin );
         break;
      ...
      case  zSOURCE_SA_META:
      case  zREFER_SA_META:
         nRC = cfTZERSASO_PostActivate( vSubtask, szSyncDate, vZeidonCM,
                                        vMOI_View, vTaskLPLR,
                                        PhaseCtl, bCheckin );
         break;
      ...
      case  zSOURCE_UIS_META:
      case  zREFER_UIS_META:
         nRC = cfTZADCSDO_PostActivate( vSubtask, szSyncDate, vZeidonCM,
                                        vMOI_View, vTaskLPLR,
                                        PhaseCtl, bCheckin );
         break;
      ...
      case  zSOURCE_VOR_META:
      case  zREFER_VOR_META:
         nRC = cfTZWDVORO_PostActivate( vSubtask, szSyncDate, vZeidonCM,
                                        vMOI_View, vTaskLPLR,
                                        PhaseCtl, bCheckin );
         break;
      ...
      case  zSOURCE_PENV_META:
      case  zREFER_PENV_META:
         nRC = cfTZPESRCO_PostActivate( vSubtask, szSyncDate, vZeidonCM,
                                        vMOI_View, vTaskLPLR,
                                        PhaseCtl, bCheckin );
         break;
      ...
      case  zSOURCE_REPORT_META:
      case  zREFER_REPORT_META:
         nRC = cfTZRPSRCO_PostActivate( vSubtask, szSyncDate, vZeidonCM,
                                        vMOI_View, vTaskLPLR,
                                        PhaseCtl, bCheckin );
         break;
...
/* Bypass Phase 2 if this is an activation of a SOURCE Type Meta */
   ...
   GetStringFromAttribute( szWork, vTZCMLPLO,
                           "W_MetaDef", "LastSyncDate" );
                         ...
                         zBOOL    bRepository )
{
   ...
   if ( bRepository )
   {
      // For Every RelType_1 found in the object instance, find the
      // RelLink to the Other Entity and include it under the RelType_1
      // Entity
...
//                                                   "EntpER_Model" ) >= zCURSOR_SET )
               if ( SetCursorFirstEntityByAttr( vTZEREMDO, "ER_RelLink_2", "ZKey",
                                                ...
                                                "EntpER_Model" ) >= zCURSOR_SET )
               {
                  if ( SetCursorNextEntity( vTZEREMDO, "ER_RelLink_2", 0 ) !=
                                                            zCURSOR_SET )
                  {
         ...
         }  while( SetCursorNextEntity( vTZEREMDO, "ER_RelType_1",
                                        "EntpER_Model" ) >= zCURSOR_SET );
      }
   }
...
// the original and to use the Text Domain if such a Domain could not be found.
         ...
         nRC = SetCursorNextEntity( vTZEREMDO, "Domain", "EntpER_Model" ) )
   {
      ...
      nRC = ActivateMetaOI_ByZKey( vSubtask, &vTZDMSRCO, 0, zREFER_DOMAIN_META,
                                   zSINGLE, lZKey, 0 );
      if ( nRC >= 0 )
      {
         SetNameForView( vTZEREMDO, "DKS_TZEREMDO", vSubtask, zLEVEL_TASK );
         SetNameForView( vTZDMSRCO, "DKS_TZDMSRCO", vSubtask, zLEVEL_TASK );
         RelinkInstanceToInstance( vTZEREMDO, "Domain",
                                   vTZDMSRCO, "Domain" );
         DropMetaOI( vSubtask, vTZDMSRCO );
      }
      else
      {
         GetStringFromAttribute( szDomainName, vTZEREMDO, "Domain", "Name" );
         nRC = ActivateMetaOI_ByName( vSubtask, &vTZDMSRCO, 0, zREFER_DOMAIN_META,
         ...
         if ( nRC < 0 )
         {
            ...
            GetStringFromAttribute( szTempName,
                                    vTZEREMDO, "ER_Entity", "Name" );
            TraceLineS( "Can't relink Domain. Entity: ", szTempName );
            GetStringFromAttribute( szTempName,
                                    vTZEREMDO, "ER_Attribute", "Name" );
            TraceLineS( "Can't relink Domain. Attribute: ", szTempName );
            nRC = SetCursorFirstEntityByString( vDomainLPLR, "W_MetaDef", "Name",
                                                "TextForMissingZKey", 0 );
            if ( nRC >= 0 )
               ActivateMetaOI_ByName( vSubtask, &vTZDMSRCO, 0, zREFER_DOMAIN_META,
                                      zSINGLE, "TextForMissingZKey", 0 );
         }
         ...
         if ( nRC >= 0 )
         {
            ...
            IncludeSubobjectFromSubobject( vTZEREMDO, "Domain",
                                           vTZDMSRCO, "Domain", zPOS_AFTER );
            DropMetaOI( vSubtask, vTZDMSRCO );
         }
         else
         {
            zstrcpy( szMsg, "Deleting Attribute because of missing Domain: " );
         ...
         do
         {
               ...
               if ( SetCursorNextEntity( vSA2, "ER_RelLink_2", 0 ) >= zCURSOR_SET &&
                  SetCursorFirstEntityByEntityCsr( vTZERSASO, "ER_Entity",
                                                   vTZERSASO, "ER_Entity_2", "SubjectArea" ) >= zCURSOR_SET &&
                  SetCursorFirstEntityByEntityCsr( vSA2, "ER_Entity",
                                                   vSA2, "ER_Entity_2", "SubjectArea" ) >= zCURSOR_SET )
               {
                                                   ...
                                                   vTZERSASO, "ER_RelLink_2", "ZKey", 0 ) < zCURSOR_SET )
                  {
                     ...
                     IncludeSubobjectFromSubobject( vTZERSASO, "ER_RelLink",
                                                    vTZERSASO, "ER_RelLink_2",
                                                    zPOS_LAST );
                     IncludeSubobjectFromSubobject( vTZERSASO, "ER_RelLink_Other",
                                                    vSA2,      "ER_RelLink_2",
                                                    zPOS_FIRST );
                     IncludeSubobjectFromSubobject( vSA2, "ER_RelLink",
                                                    vSA2, "ER_RelLink_2",
                                                    zPOS_LAST );
                     IncludeSubobjectFromSubobject( vSA2,      "ER_RelLink_Other",
                                                    vTZERSASO, "ER_RelLink_2",
                                                    zPOS_FIRST );
                  }
               }
         }  while ( SetCursorNextEntity( vTZERSASO, "ER_RelType",
                         ...
                         zBOOL    bCheckin )
{
                                             ...
                                             zREFER_ERD_META, nRelNbr )) > 0 )
   {
      if ( vMeta )
      {
         ...
         // ER_Model to the TE
         RelinkAllSubobjectsForOI( vTZTENVRO, "ER_Attribute",
                                   vMeta, "ER_Attribute" );
         RelinkAllSubobjectsForOI( vTZTENVRO, "ER_RelLink",
                                   vMeta, "ER_RelLink" );
         RelinkAllSubobjectsForOI( vTZTENVRO, "ER_Entity",
                                   vMeta, "ER_Entity" );
         RelinkAllSubobjectsForOI( vTZTENVRO, "ER_RelType",
                                   vMeta, "ER_RelType" );
         RelinkAllSubobjectsForOI( vTZTENVRO, "ER_EntIdentifier",
                                   vMeta, "ER_EntIdentifier" );
      }
   }
   ...
   // For each REFER LOD active in memory, relink the TE to the LOD
                                                ...
                                                nRelNbr )) > 0 )
      {
         if ( vMeta )
         {
            ...
            // LOD to the TE
            RelinkAllSubobjectsForOI( vMeta, "TE_DB_Environ",
                                      vTZTENVRO, "TE_DB_Environ" );
         }
      }
                         ...
                         zBOOL    bCheckin )
{
   ...
   SetCursorFirstEntityByInteger( vTempLPLR, "W_MetaType", "Type",
                                  zREFER_LOD_META, 0 );
   nRC = SetCursorFirstEntityByAttr( vTempLPLR, "W_MetaDef", "CPLR_ZKey",
                                     vTZWDVORO, "LOD",       "ZKey", 0 );
   if ( nRC < zCURSOR_SET )
   {
      // The LOD in the VOR was not found in the LPLR by ZKey, so re-include.
      GetStringFromAttribute( szLOD_Name, vTZWDVORO, "LOD", "Name" );
   ...
   // For each REFER Dialog active in memory, relink the PE to the Dialog
                                                ...
                                                nRelNbr )) > 0 )
      {
         if ( vMeta )
         {
            ...
            // Dialog to the PE
            RelinkAllSubobjectsForOI( vMeta, "ControlDef",
                                      vTZPESRCO, "ControlDef" );
         // RelinkAllSubobjectsForOI( vMeta, "CtrlColorDef",
         //                           vTZPESRCO, "CtrlColorDef" );
         // RelinkAllSubobjectsForOI( vMeta, "CtrlColor",
         //                           vTZPESRCO, "Color" );
         // RelinkAllSubobjectsForOI( vMeta, "CtrlFontDef",
         //                           vTZPESRCO, "CtrlFontDef" );
         // RelinkAllSubobjectsForOI( vMeta, "CtrlFont",
         //                           vTZPESRCO, "Font" );
            RelinkAllSubobjectsForOI( vMeta, "WndStyle",
                                      vTZPESRCO, "WindowStyle" );
         // RelinkAllSubobjectsForOI( vMeta, "WndColorDef",
         //                           vTZPESRCO, "WndColorDef" );
         // RelinkAllSubobjectsForOI( vMeta, "WndColor",
         //                           vTZPESRCO, "Color" );
         // RelinkAllSubobjectsForOI( vMeta, "WndFontDef",
         //                           vTZPESRCO, "WndFontDef" );
         // RelinkAllSubobjectsForOI( vMeta, "WndFont",
         //                           vTZPESRCO, "Font" );
         }
      }
   ...
   // For each SOURCE Dialog active in memory, relink the PE to the Dialog
                                                ...
                                                nRelNbr )) > 0 )
      {
         if ( vMeta )
         {
            ...
            RelinkAllSubobjectsForOI( vMeta, "WndStyle",
                                      vTZPESRCO, "WindowStyle" );
            RelinkAllSubobjectsForOI( vMeta, "DfltWndStyle",
                                      vTZPESRCO, "WindowStyle" );
         }
      }
                         ...
                         zBOOL    bCheckin )
{
                                             ...
                                             zREFER_LOD_META, nRelNbr )) > 0 )
   {
      if ( vMeta )
      {
         // We have retrieved a view to an active LOD, link up the
         // UI Spec to the LOD
         RelinkAllSubobjectsForOI( vTZADCSDO, "LOD_Entity",
                                   vMeta, "LOD_Entity" );
         RelinkAllSubobjectsForOI( vTZADCSDO, "M_LOD_Attribute",
                                   vMeta, "LOD_Attribute" );
         RelinkAllSubobjectsForOI( vTZADCSDO, "L_LOD_Attribute",
                                   vMeta, "LOD_Attribute" );
      }
   }
                                             ...
                                             nRelNbr ) ) > 0 )
   {
      if ( vMeta )
      {
         ...
         // UI Spec to the VOR
         RelinkAllSubobjectsForOI( vTZADCSDO, "SubObjViewObjRef",
                                   vMeta, "ViewObjRef" );
         RelinkAllSubobjectsForOI( vTZADCSDO, "UIS_ViewObjRef",
                                   vMeta, "ViewObjRef" );
         RelinkAllSubobjectsForOI( vTZADCSDO, "ListVOR",
                                   vMeta, "ViewObjRef" );
      }
   }
                                             ...
                                             nRelNbr )) > 0 )
   {
      if ( vMeta )
      {
         ...
         RelinkAllSubobjectsForOI( vTZADCSDO, "WndStyle",
                                   vMeta, "WindowStyle" );
         RelinkAllSubobjectsForOI( vTZADCSDO, "DfltWndStyle",
                                   vMeta, "WindowStyle" );
      }
   }
...
/* Bypass Phase 2 if this is an activation of a SOURCE Type Meta */
   ...
   {
      GetIntegerFromAttribute( &lZKey, vWkTZADCSDO,
                              "UIS_ViewObjRef", "ZKey" );
      if ( ActivateMetaOI_ByZKey( vSubtask, &vTZWDVORO, vCM_List,
                                  zREFER_VOR_META,
      ...
      {
         zstrcpy( szERR_Msg, "Unable to activate Registered View ( file " );
         zltoxa( lZKey, &szERR_Msg[ zstrlen( szERR_Msg ) ] );
         GetAddrForAttribute( &szName, vTZWDVORO, "ViewObjRef", "Name" );
         zstrcat( szERR_Msg, "' for UI Specification '" );
                       ...
                       zSHORT   nRelNbr )
{
   ...
   if ( nRelNbr == 0 )
   {
      if ( nType <= zSOURCE_MAX_META )
      {
         ...
         if ( nCursor == zCURSOR_SET )
         {
            ...
            {
               GetIntegerFromAttribute( &lTaskID, vActiveMetas, "W_MetaDef",
                                        "TaskID" );
               ...
               {  // get the active view name for the meta in memory
                  ...
                  GetViewByName( vMeta, szViewName, vCM_Subtask,
                                 zLEVEL_SUBTASK );
                  return( ++nRelNbr );
               }
      ...
      else
      {
         ...
         if ( nCursor == zCURSOR_SET )
         {
            ...
            while ( nCursor == zCURSOR_SET )
            {
               ...
               if ( GetViewByName( vMeta, szViewName, vCM_Subtask,
                                   zLEVEL_SUBTASK ) >= 0 )
               {
                  return( ++nRelNbr );
               }
   ...
   else
   {
      ...
      if ( nType <= zSOURCE_MAX_META )
      {
         while ( nCursor == zCURSOR_SET )
         {
            GetIntegerFromAttribute( &lTaskID, vActiveMetas,
                                     "W_MetaDef", "TaskID" );
            if ( lTaskID ) // any non-zero task id is valid (Win9x has negative IDs)
            {  // get the active view name for the meta in memory
               GetStringFromAttribute( szViewName, vActiveMetas,
...
/* PETTIT Bypass of sync date code */
   ...
   nRC = 0;
   if ( SetCursorFirstEntityByInteger( vWkTZCMLPLO, "W_MetaType",
                                       "Type", nDependentType,
                                       0 ) == zCURSOR_SET )
   {
      if ( SetCursorFirstEntity( vWkTZCMLPLO,
                                 "W_MetaDef", 0 ) == zCURSOR_SET )
      {
         do
         {
            GetStringFromAttribute( szDepSyncDate, vWkTZCMLPLO,
                                    "W_MetaDef", "LastSyncDate" );
            ...
            //             (zLONG) vSubtask->hTask );
               fnActivateMetaOI( vSubtask, &vMeta,
                                 vWkTZCMLPLO, nDependentType, 0 );
            ...
            //             (zLONG) vSubtask->hTask );
               ...
               if ( zstrcmp( szDepSyncDate, szReturnSyncDate ) > 0 )
                  zstrcpy( szReturnSyncDate, szDepSyncDate );

               nRC++;
               if ( vMeta )
                  DropView( vMeta );
            }
         }  while ( SetCursorNextEntity( vWkTZCMLPLO,
                                         "W_MetaDef", 0 ) == zCURSOR_SET );
      }
   }
...
fnLinkAndSyncER_ToSA( zVIEW vSubtask, zVIEW vTZEREMDO, zVIEW vTZERSASO )
{
   ...
   RelinkAllSubobjectsForOI( vTZERSASO, "ER_Entity",
                             vTZEREMDO, "ER_Entity" );
   RelinkAllSubobjectsForOI( vTZERSASO, "ER_RelType",
                             vTZEREMDO, "ER_RelType" );
   RelinkAllSubobjectsForOI( vTZERSASO, "EntpER_Model",
                             vTZEREMDO, "EntpER_Model" );
   RelinkAllSubobjectsForOI( vTZERSASO, "ER_RelLink",
                             vTZEREMDO, "ER_RelLink" );
   RelinkAllSubobjectsForOI( vTZERSASO, "ER_RelLink_Other",
                             vTZEREMDO, "ER_RelLink_Other" );
   RelinkAllSubobjectsForOI( vTZERSASO, "OwnedER_Entity",
                             vTZEREMDO, "ER_Entity" );
   RelinkAllSubobjectsForOI( vTZERSASO, "OwnedER_RelType",
                             vTZEREMDO, "ER_RelType" );
   RelinkAllSubobjectsForOI( vTZEREMDO, "EntOwningSA",
                             vTZERSASO, "SubjectArea" );
   RelinkAllSubobjectsForOI( vTZEREMDO, "RelOwningSA",
                             vTZERSASO, "SubjectArea" );

   // Now that we have relinked to the er_model, we need to
   // syncronize the SA with the model
   if ( SetCursorFirstEntity( vTZERSASO, "SA_Entity",
                              "SubjectArea" ) >= zCURSOR_SET )
   {
      do
      {
         GetIntegerFromAttribute( &lZKey1, vTZERSASO,
                                  "ER_Entity", "ZKey" );
         if ( SetCursorFirstEntityByInteger( vTZEREMDO, "ER_Entity",
                                             "ZKey", lZKey1,
                                             0 ) != zCURSOR_SET )
         {
      ...
      }  while ( SetCursorNextEntity( vTZERSASO, "SA_Entity",
                                      "SubjectArea" ) > zCURSOR_UNCHANGED );
   }

   // Now that we have relinked to the er_model, we need to
   // syncronize the SA with the model
   if ( SetCursorFirstEntity( vTZERSASO, "SA_RelType",
                              "SubjectArea" ) >= zCURSOR_SET )
   {
      do
      {
         GetIntegerFromAttribute( &lZKey1, vTZERSASO,
                                  "ER_RelType", "ZKey" );
         if ( SetCursorFirstEntityByInteger( vTZEREMDO, "ER_RelType",
                                             "ZKey", lZKey1,
                                             0 ) != zCURSOR_SET )
         {
            if ( SetCursorFirstEntityByInteger( vTZERSASO, "ER_RelType_1",
                                                "ZKey", lZKey1,
                                                "SubjectArea" ) )
            {
               ExcludeEntity( vTZERSASO, "ER_RelLink", zREPOS_NONE );
               if ( SetCursorNextEntityByInteger( vTZERSASO, "ER_RelType_1",
                                                  "ZKey", lZKey1,
                                                  "SubjectArea" ) >= zCURSOR_SET )
               {
                  ExcludeEntity( vTZERSASO, "ER_RelLink", zREPOS_NONE );
      ...
      }  while ( SetCursorNextEntity( vTZERSASO, "SA_RelType",
                                      "SubjectArea" ) > zCURSOR_UNCHANGED );
   }

   // Now re-establish the RelLink_Other path
   if ( SetCursorFirstEntity( vTZERSASO, "ER_RelType_1",
                              "SubjectArea" ) >= zCURSOR_SET )
   {
      do
      {
         if ( CheckExistenceOfEntity( vTZERSASO,
                                      "ER_RelLink_Other" ) < zCURSOR_SET )
         {
            GetIntegerFromAttribute( &lZKey1, vTZERSASO,
                                     "ER_RelLink", "ZKey" );
            SetCursorFirstEntityByInteger( vTZEREMDO, "ER_RelLink",
                                           "ZKey", lZKey1, "EntpER_Model" );
            IncludeSubobjectFromSubobject( vTZERSASO, "ER_RelLink_Other",
                                           vTZEREMDO, "ER_RelLink_Other",
                                           zPOS_AFTER );
         }
      } while ( SetCursorNextEntity( vTZERSASO, "ER_RelType_1",
                                     "SubjectArea" ) >= zCURSOR_SET );
   }
   ...
   do
   {
      ...
      if ( SetCursorFirstEntityByInteger( vTZERSASO, "ER_RelType", "ZKey",
                                          lZKey1,
                                          "SubjectArea" ) < zCURSOR_SET )
      {
         ...
         if ( SetCursorFirstEntityByInteger( vSA2, "ER_Entity", "ZKey",
                                             lZKey1,
                                             "SubjectArea" ) >= zCURSOR_SET &&
              SetCursorFirstEntityByInteger( vSA3, "ER_Entity", "ZKey",
                                             lZKey2,
                                             "SubjectArea" ) >= zCURSOR_SET )
         {
            CreateMetaEntity( vSubtask, vTZERSASO, "SA_RelType", zPOS_LAST );
            IncludeSubobjectFromSubobject( vTZERSASO, "ER_RelType",
                                           vTZEREMDO, "ER_RelType",
                                           zPOS_BEFORE );
            ...
            IncludeSubobjectFromSubobject( vSA2, "ER_RelLink",
                                           ...
                                           zPOS_AFTER );
            IncludeSubobjectFromSubobject( vSA2, "ER_RelLink_Other",
                                           vER2, "ER_RelLink_2", zPOS_AFTER );
            SetCursorLastEntity( vSA3, "ER_RelLink", 0 );
            IncludeSubobjectFromSubobject( vSA3, "ER_RelLink",
                                           vER2, "ER_RelLink_2", zPOS_AFTER );
            IncludeSubobjectFromSubobject( vSA3, "ER_RelLink_Other",
                                           vTZEREMDO, "ER_RelLink_2", zPOS_AFTER );
         }
      }
