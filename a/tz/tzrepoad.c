...
IncrementErrorCount( zVIEW vSubtask, zPSHORT pnError )
{
   ...
   zstrcpy( szMsg, "Total errors " );
   (*pnError)++;
   nTotalErrors++;
   zltoa(( zLONG ) nTotalErrors, &szMsg[ 50 ] );
   zstrcat( szMsg, &szMsg[ 50 ] );
...
fnRecursLodEntityMarking( zVIEW vLod )
{
   ...
   do
   {
      GetStringFromAttribute( szWork, vLod, "LOD_EntityParent", "Work" );
      GetStringFromAttribute( szDerived, vLod, "LOD_EntityParent", "Derived" );
      if ( szWork[ 0 ] != 'Y' )
      {
                                                ...
                                                zCURSOR_SET )
      {
         do
         {
            GetStringFromAttribute( szWork, vLod, "LOD_AttributeRec", "Work" );
            if ( szWork[ 0 ] == 'Y' )
            {
   ...
   do
   {
         ...
         do
         {
            ...
            else
            {
                     ...
                     vDialog, "CtrlMapView", 0 ) < zCURSOR_SET )
               {
                  ...
                  IncrementErrorCount( vSubtask, pnError );
                  GetStringFromAttribute( szTag, vDialog,
                                          "CtrlMapView", "Name" );
         ...
         do
         {
            ...
            else
            {
                     ...
                     vViewObj, "CtrlMapView", 0 ) < zCURSOR_SET )
               {
                  ...
                  IncrementErrorCount( vSubtask, pnError );
                  GetStringFromAttribute( szTag, vViewObj,
                                          "CtrlMapView", "Name" );
                  if ( SetCursorFirstEntityByString( vDlgWk, "ViewObjRef",
                                                     "Name", szTag, 0 ) >= zCURSOR_SET )
                  {
      ...
      do
      {
                      ...
                      vDialog, "EventAct", 0 ) != zCURSOR_SET )
         {
            ...
            IncrementErrorCount( vSubtask, pnError );
            GetStringFromAttribute( szTag, vDialog, "EventAct", "Tag" );
   ...
   do
   {
      ...
      do
      {
                      ...
                      vDialog, "OptAct", 0 ) != zCURSOR_SET )
         {
            ...
            IncrementErrorCount( vSubtask, pnError );
            GetStringFromAttribute( szTag, vDialog, "OptAct", "Tag" );
            if ( SetCursorFirstEntityByString( vDlgWk, "Action", "Tag",
                                               szTag, 0 ) >= zCURSOR_SET )
            {
 ...
 if ( DO_DOMAIN )
 {
   ...
   if ( VALIDATE )
   {
      ...
      do
      {
         ...
         nFixes = 0;
         bFirst = 0;
         zstrcpy( szMsg, "Activating Domain " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
         ActivateMetaOI( vSubtask, &vDomain, vMetaList, zSOURCE_DOMAIN_META, 0 );
         zstrcpy( szMsg, "Validating Domain " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
         ...
         if ( nError && PROMPT )
         {
            ...
            zltoa( nError, szMsg );
            zstrcat( szMsg, " Errors were encountered, DeleteMetaOI?" );
   ...
   if ( MARK )
   {
      ...
      do
      {
         ...
         if ( COMMIT )
         {
            zstrcpy( szMsg, "Commiting Domain " );
            GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                    "W_MetaDef", "Name" );
            zstrcat( szMsg, &szMsg[ 80 ] );
            MB_SetMessage( vSubtask, 1, szMsg );
 ...
 if ( DO_ERD )
 {
   ...
   if ( MARK )
   {
           ...
           >= zCURSOR_SET )
      {
         ...
         if ( SetCursorFirstEntity( vMeta, "Z_MetaDef", 0 ) == zCURSOR_SET )
            ExcludeEntity( vMeta, "Z_MetaDef", zREPOS_NONE );
         SetIncrementalUpdateFlags( vMeta, "Domain",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vMeta, "ER_AttributeIdentifier",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vMeta, "ER_RelLinkIdentifier",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vMeta, "ER_Entity_2",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         if ( COMMIT )
         {
 ...
 if ( DO_SA )
 {
   ...
   if ( VALIDATE )
   {
      ...
      do
      {
         ...
         if ( CompareAttributeToInteger( vErd, "EntpER_Model", "ZKey",
                                         lZKey ) != 0 )
         {
         ...
         else
         {
                 ...
                 >= zCURSOR_SET )
            {
               do
               {
                  ...
                  if ( SetCursorFirstEntityByInteger( vErd, "ER_Entity",
                                                      "ZKey", lZKey,
                                                      "EntpER_Model" )
                                                              < zCURSOR_SET )
                  {
               ...
               }  while ( SetCursorNextEntity( vSa,
                        "ER_Entity", "SubjectArea" ) >= zCURSOR_SET );
            }
                 ...
                 >= zCURSOR_SET )
            {
               do
               {
                  GetIntegerFromAttribute( &lZKey, vSa,
                                           "ER_RelType", "ZKey" );
                                                              ...
                                                              < zCURSOR_SET )
                  {
                     ...
                     nFixes++;
                        ...
                        "ER_RelType", "SubjectArea" ) >= zCURSOR_SET );
            }
         }
         ...
         if ( nError && PROMPT )
         {
            ...
            zltoa( nError, szMsg );
            zstrcat( szMsg, " Errors were encountered, DeleteMetaOI?" );
            nRC = MessagePrompt( vSubtask, "RE00103",
                                 "Laucher",
                                 szMsg,
                                 zBEEP, zBUTTONS_YESNOCANCEL,
                                 zRESPONSE_NO,  0 );
   ...
   if ( MARK )
   {
      ...
      do
      {
         ...
         // Patch
         if ( SetCursorFirstEntity( vMeta, "ER_RelType", "SubjectArea" )
                                                            >= zCURSOR_SET )
         {
            do
            {
               zgSortEntityWithinParent( zASCENDING, vMeta,
                                         "ER_RelLink_2", "ZKey", 0 );

            } while ( SetCursorNextEntity( vMeta, "ER_RelType",
                                           "SubjectArea" ) >= zCURSOR_SET );
         }

         zstrcpy( szMsg, "Marking SA " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
         ...
         if ( SetCursorFirstEntity( vMeta, "Z_MetaDef", 0 ) == zCURSOR_SET )
            ExcludeEntity( vMeta, "Z_MetaDef", zREPOS_NONE );
         SetIncrementalUpdateFlags( vMeta, "ER_Entity",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vMeta, "OwnedER_Entity",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vMeta, "ER_RelType",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vMeta, "OwnedER_RelType",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vMeta, "EntpER_Model",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         if ( COMMIT )
         {
            zstrcpy( szMsg, "Commiting SA " );
            GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                    "W_MetaDef", "Name" );
            zstrcat( szMsg, &szMsg[ 80 ] );
            MB_SetMessage( vSubtask, 1, szMsg );
 ...
 if ( DO_TE )
 {
   ...
   if ( VALIDATE )
   {
      ...
      do
      {
         ...
         if ( SetCursorFirstEntity( vTe, "ER_Attribute", "TE_DB_Environ" )
               >= zCURSOR_SET )
         {
            do
            {
            ...
            }  while ( SetCursorNextEntity( vTe,
                        "ER_Attribute", "TE_DB_Environ" )
                                                      >= zCURSOR_SET );
         }

         if ( SetCursorFirstEntity( vTe, "ER_RelLink", "TE_DB_Environ" )
               >= zCURSOR_SET )
         {
            do
            {
               GetIntegerFromAttribute( &lZKey, vTe, "ER_RelLink", "ZKey" );
               if ( SetCursorFirstEntityByInteger( vErd, "ER_RelLink",
                                                   "ZKey", lZKey,
                                                   "EntpER_Model" )
                                                              < zCURSOR_SET )
               {
            ...
            }  while ( SetCursorNextEntity( vTe, "ER_RelLink",
                                            "TE_DB_Environ" ) >= zCURSOR_SET );
         }

         if ( SetCursorFirstEntity( vTe, "ER_Entity", "TE_DB_Environ" )
               >= zCURSOR_SET )
         {
            do
            {
            ...
            }  while ( SetCursorNextEntity( vTe, "ER_Entity",
                                            "TE_DB_Environ" ) >= zCURSOR_SET );
         }

         if ( SetCursorFirstEntity( vTe, "ER_RelType",
                                    "TE_DB_Environ" ) >= zCURSOR_SET )
         {
            do
            {
   ...
   if ( MARK )
   {
      ...
      do
      {
         ...
         if ( SetCursorFirstEntity( vMeta, "Z_MetaDef", 0 ) == zCURSOR_SET )
            ExcludeEntity( vMeta, "Z_MetaDef", zREPOS_NONE );
         SetIncrementalUpdateFlags( vMeta, "ER_Attribute",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vMeta, "ER_RelLink",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vMeta, "ER_Entity",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vMeta, "ER_RelType",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vMeta, "ER_EntIdentifier",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vMeta, "TE_FieldDataRelKey",
                                    zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vMeta, "TE_FieldDataRelAsFK",
                                    zSET_INCR_INCLUDED );
// DGC 12/4/96  Removed following entities from object.
#if 0
         SetIncrementalUpdateFlags( vMeta, "TE_TablRecAccessed",
                                    zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vMeta, "TE_TablRecStorage",
                                    zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vMeta, "TE_DBMS_SourceAvail",
                                    zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vMeta, "SubjectArea",
                                    zSET_INCR_INCLUDED );
#endif
         if ( COMMIT )
         {
            zstrcpy( szMsg, "Commiting TE " );
            GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                    "W_MetaDef", "Name" );
            zstrcat( szMsg, &szMsg[ 80 ] );
            MB_SetMessage( vSubtask, 1, szMsg );
 ...
 if ( DO_LOD )
 {
   ...
   if ( VALIDATE )
   {
      ...
      do
      {
         ...
         nFixes = 0;
         bFirst = 0;
         zstrcpy( szMsg, "Activating LOD " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
         ActivateMetaOI( vSubtask, &vLod, vLodList, zSOURCE_LOD_META, 0 );
         zstrcpy( szMsg, "Validating LOD " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
         ...
         // LOD Validation 1, make sure all domains in the LOD exist
         // in the domain list
         ...
         } while ( SetCursorNextEntity( vLod, "Domain",
                                        "LOD" ) >= zCURSOR_SET );
         ...
         do
         {
            ...
            // the model
            GetStringFromAttribute( szWork, vLod, "LOD_Entity", "Work" );
            lZKey = 0;
            ...
            if ( SetCursorFirstEntityByInteger( vErd, "ER_Entity", "ZKey",
                                                lZKey, 0 ) < zCURSOR_SET )
            {
               if ( szWork[ 0 ] != 'Y' )
               {
            ...
            // the model
            GetStringFromAttribute( szWork, vLod, "LOD_Entity", "Work" );
            GetStringFromAttribute( szDerived, vLod, "LOD_Entity", "Derived" );
            lZKey = 0;
            ...
            {
               if ( (szWork[ 0 ] != 'Y') && (szDerived[ 0 ] != 'Y') &&
                    (CompareAttributeToInteger( vLod, "LOD_Entity",
                                                "IndentLvl", 0 ) != 0) )
               {
                  TraceLineS("(tzrepoad) LOD Entity not found in ER Model","" );
                  DisplayEntityInstance( vLod, "LOD" );
            ...
            // exists in the model or doesn't exist in the model based
            // on its state
            ...
            do
            {
               // Retrieve the ZKey of the domain and look it up in
               // the domain meta list
               GetStringFromAttribute( szWork, vLod, "LOD_Attribute", "Work" );
               lZKey = 0;
               if ( CheckExistenceOfEntity( vLod, "ER_Attribute" ) ==
                                             zCURSOR_SET )
               {
                  GetIntegerFromAttribute( &lZKey, vLod,
                                           "ER_Attribute", "ZKey" );
               }
               else
               if ( szWork[ 0 ] != 'Y' )
...
#if 0   // DKS  undefined vSrcList ... DG ... should this be removed???
         if ( SetCursorFirstEntity( vLod, "SourceFile", "LOD" )
                                                >= zCURSOR_SET )
         {
            do
            {
            ...
            }  while ( SetCursorNextEntity( vLod,
                        "SourceFile", "LOD" ) >= zCURSOR_SET );
         }
#endif
   ...
   if ( MARK )
   {
      ...
      do
      {
         ...
         MB_SetMessage( vSubtask, 1, szMsg );
         ActivateMetaOI( vSubtask, &vLod, vLodList, zSOURCE_LOD_META, 0 );
         zstrcpy( szMsg, "Marking LOD " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
         SetIncrementalUpdateFlags( vLod, 0,
                              zSET_INCR_OWNERSHIP | zSET_INCR_CREATED );
         if ( SetCursorFirstEntity( vLod, "Z_MetaDef", 0 ) == zCURSOR_SET )
            ExcludeEntity( vLod, "Z_MetaDef", zREPOS_NONE );
         SetIncrementalUpdateFlags( vLod, "DomainRec",
                            zSET_INCR_PERSISTENT | zSET_INCR_NOT_INCLUDED );
         SetIncrementalUpdateFlags( vLod, "TE_DB_Environ",
                            zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         fnRecursLodEntityMarking( vLod );

         SetIncrementalUpdateFlags( vLod, "SourceFile",
                            zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vLod, "LOD_ConstraintOper",
                            zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );

         if ( COMMIT )
         {
            zstrcpy( szMsg, "Commiting LOD " );
            GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                    "W_MetaDef", "Name" );
            zstrcat( szMsg, &szMsg[ 80 ] );
            MB_SetMessage( vSubtask, 1, szMsg );
 ...
 if ( DO_UIS )
 {
   ...
   if ( VALIDATE )
   {
      ...
      do
      {
         ...
         if ( SetCursorFirstEntity( vUis, "DfltWndStyle", "UI_Spec" )
                                                            >= zCURSOR_SET )
         {
         ...
         if ( nError && PROMPT )
         {
            ...
            zltoa( nError, szMsg );
            zstrcat( szMsg, " Errors were encountered, DeleteMetaOI?" );
            nRC = MessagePrompt( vSubtask, "RE00106",
                                 "Laucher",
                                 szMsg,
                                 zBEEP, zBUTTONS_YESNOCANCEL,
                                 zRESPONSE_NO,  0 );
   ...
   if ( MARK )
   {
      ...
      do
      {
         ...
         SetIncrementalUpdateFlags( vUis, "LOD_Entity",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vUis, "WndStyle",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vUis, "M_LOD_Attribute",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vUis, "L_LOD_Attribute",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vUis, "SubObjViewObjRef",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vUis, "DfltWndStyle",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vUis, "UIS_ViewObjRef",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vUis, "ListVOR",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );

         if ( COMMIT )
         {
            zstrcpy( szMsg, "Commiting UIS " );
            GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                    "W_MetaDef", "Name" );
            zstrcat( szMsg, &szMsg[ 80 ] );
            MB_SetMessage( vSubtask, 1, szMsg );
...
//PETTIT
   ...
   if ( MARK )
   {
      ...
      do
      {
         zstrcpy( szMsg, "Activating Presentation Env " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
         ActivateMetaOI( vSubtask, &vMeta, vPeList, zSOURCE_PENV_META, 0 );
         zstrcpy( szMsg, "Marking Presentation Env " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
      ...
      // SetIncrementalUpdateFlags( vMeta, "CtrlFont", zSET_INCR_INCLUDED );
         if ( COMMIT )
         {
            zstrcpy( szMsg, "Commiting Presentation Env " );
            GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                    "W_MetaDef", "Name" );
            zstrcat( szMsg, &szMsg[ 80 ] );
            MB_SetMessage( vSubtask, 1, szMsg );
 ...
 if ( DO_VOR )
 {
   ...
   if ( VALIDATE )
   {
      ...
      do
      {
         ...
         nFixes = 0;
         bFirst = 0;
         zstrcpy( szMsg, "Activating VOR " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
         ActivateMetaOI( vSubtask, &vVor, vMetaList, zREFER_VOR_META, 0 );
         zstrcpy( szMsg, "Validating VOR " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcpy( szWork, &szMsg[ 80 ] );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
         TraceLineS("(tzrepoad) ", szMsg );
         ...
         if ( PROMPT )
         {
            ...
            if ( SetCursorNextEntityByString( vWork, "W_MetaDef", "Name",
                 ...
                 MessagePrompt( vSubtask, "RE00107",
                                "Laucher",
         ...
         if ( nError && PROMPT )
         {
            ...
            zltoa( nError, szMsg );
            zstrcat( szMsg, " Errors were encountered, DeleteMetaOI?" );
            nRC = MessagePrompt( vSubtask, "RE00108",
                                 "Laucher",
                                 szMsg,
                                 zBEEP, zBUTTONS_YESNOCANCEL,
                                 zRESPONSE_NO,  0 );
   ...
   if ( MARK )
   {
      ...
      do
      {
         ...
         zstrcpy( szMsg, "Marking VOR " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
         SetIncrementalUpdateFlags( vVor, 0,
                              zSET_INCR_OWNERSHIP | zSET_INCR_CREATED );
         if ( SetCursorFirstEntity( vVor, "Z_MetaDef", 0 ) == zCURSOR_SET )
            ExcludeEntity( vVor, "Z_MetaDef", zREPOS_NONE );
         SetIncrementalUpdateFlags( vVor, "LOD",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );


         if ( COMMIT )
         {
            zstrcpy( szMsg, "Commiting VOR " );
            GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                    "W_MetaDef", "Name" );
            zstrcat( szMsg, &szMsg[ 80 ] );
            MB_SetMessage( vSubtask, 1, szMsg );
 ...
 if ( DO_DIALOG )
 {
   ...
   if ( VALIDATE )
   {
      ...
      do
      {
         ...
         nFixes = 0;
         bFirst = 0;
         zstrcpy( szMsg, "Activating Dialog " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
         ...
         nFixes = 0;
         zstrcpy( szMsg, "Validating Dialog " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
                     ...
                     vDialog, "DfltWnd", 0 ) != zCURSOR_SET )
         {
            ...
            IncrementErrorCount( vSubtask, &nError );
            GetStringFromAttribute( szMsg, vDialog, "DfltWnd", "Tag" );
         ...
         if ( SetCursorFirstEntity( vDialog, "ViewObjRef", 0 ) >= zCURSOR_SET )
         {
            do
            {
                                                   ...
                                                   0 ) < zCURSOR_SET )
               {
                  ...
                  GetStringFromAttribute( szWork, vDialog,
                                          "ViewObjRef", "Name" );
...
// SRC metas no longer valid
            ...
            if ( CheckExistenceOfEntity( vDialog, "WndStyle" ) >= zCURSOR_SET )
            {
                                                   ...
                                                   lZKey, 0 ) != zCURSOR_SET )
               {
                  ...
                  IncrementErrorCount( vSubtask, &nError );
                  GetStringFromAttribute( szWork, vDialog, "WndStyle", "Tag" );
         ...
         if ( nError && PROMPT )
         {
            ...
            zltoa( nError, szMsg );
            zstrcat( szMsg, " Errors were encountered, DeleteMetaOI?" );
            nRC = MessagePrompt( vSubtask, "RE00109",
                                 "Laucher",
                                 szMsg,
                                 zBEEP, zBUTTONS_YESNOCANCEL,
                                 zRESPONSE_NO,  0 );
   ...
   if ( MARK )
   {
      ...
      do
      {
         ...
         MB_SetMessage( vSubtask, 1, szMsg );
         ActivateMetaOI( vSubtask, &vDialog, vMetaList, zSOURCE_DIALOG_META, 0 );
         zstrcpy( szMsg, "Marking Dialog " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
         SetIncrementalUpdateFlags( vDialog, 0,
                              zSET_INCR_OWNERSHIP | zSET_INCR_CREATED );
         if ( SetCursorFirstEntity( vDialog, "Z_MetaDef", 0 ) == zCURSOR_SET )
            ExcludeEntity( vDialog, "Z_MetaDef", zREPOS_NONE );

         SetIncrementalUpdateFlags( vDialog, "DfltWnd",
                              zSET_INCR_INCLUDED );

         SetIncrementalUpdateFlags( vDialog, "CtrlMapLOD_Attribute",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vDialog, "CtrlMapLOD_Entity",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vDialog, "CtrlMapContext",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vDialog, "CtrlMapView",
                              zSET_INCR_INCLUDED );

         SetIncrementalUpdateFlags( vDialog, "EventAct",
                              zSET_INCR_INCLUDED );

      // SetIncrementalUpdateFlags( vDialog, "CtrlColor",
      //                      zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
      // SetIncrementalUpdateFlags( vDialog, "CtrlColorDef",
      //                      zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
      // SetIncrementalUpdateFlags( vDialog, "CtrlFont",
      //                      zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
      // SetIncrementalUpdateFlags( vDialog, "CtrlFontDef",
      //                      zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );

         SetIncrementalUpdateFlags( vDialog, "ControlDef",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );

         SetIncrementalUpdateFlags( vDialog, "WndAct",
                              zSET_INCR_INCLUDED );

         SetIncrementalUpdateFlags( vDialog, "ActMapLOD_Entity",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vDialog, "ActMapView",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vDialog, "ActOper",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );

         SetIncrementalUpdateFlags( vDialog, "OptAct",
                              zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vDialog, "OptMapLOD_Attribute",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vDialog, "OptMapContext",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vDialog, "OptMapView",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );

         SetIncrementalUpdateFlags( vDialog, "DfltMenu",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );

         SetIncrementalUpdateFlags( vDialog, "WndCaptionMapLOD_Attribute",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vDialog, "WndCaptionMapContext",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vDialog, "WndCaptionMapView",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );

      // SetIncrementalUpdateFlags( vDialog, "WndColor",
      //                      zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
      // SetIncrementalUpdateFlags( vDialog, "WndColorDef",
      //                      zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );

      // SetIncrementalUpdateFlags( vDialog, "WndFont",
      //                      zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
      // SetIncrementalUpdateFlags( vDialog, "WndFont",
      //                      zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );

         SetIncrementalUpdateFlags( vDialog, "WndStyle",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );

         SetIncrementalUpdateFlags( vDialog, "HotAct",
                              zSET_INCR_INCLUDED );

         SetIncrementalUpdateFlags( vDialog, "ViewObjRef",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );

         SetIncrementalUpdateFlags( vDialog, "SourceFile",
                              zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );


         if ( COMMIT )
         {
            zstrcpy( szMsg, "Commiting dialog " );
            GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                    "W_MetaDef", "Name" );
            zstrcat( szMsg, &szMsg[ 80 ] );
            MB_SetMessage( vSubtask, 1, szMsg );
...
//   zSOURCE_HDR_META
   ...
   if ( MARK )
   {
      ...
      do
      {
         ...
         if ( COMMIT )
         {
            zstrcpy( szMsg, "Commiting header " );
            GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                    "W_MetaDef", "Name" );
            zstrcat( szMsg, &szMsg[ 80 ] );
            MB_SetMessage( vSubtask, 1, szMsg );
...
//   zSOURCE_SRC_META    11
   ...
   if ( VALIDATE )
   {
      ...
      do
      {
         ...
         nFixes = 0;
         bFirst = 0;
         zstrcpy( szMsg, "Activating Source " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
         ActivateMetaOI( vSubtask, &vSrc, vMetaList, zSOURCE_SRC_META, 0 );
         zstrcpy( szMsg, "Validating Source " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
         ...
         if ( SetCursorFirstEntity( vSrc, "Dialog",
                                    "SourceFile" ) >= zCURSOR_SET )
         {
            while ( SetCursorFirstEntity( vSrc, "LOD", "SourceFile" )
                                                         >= zCURSOR_SET )
            {
               ...
               nFixes++;
               if ( SetCursorFirstEntityByInteger( vLodList,
                        "W_MetaDef", "CPLR_ZKey", lZKey2, 0 ) >= zCURSOR_SET )
               {
                  ActivateMetaOI( vSubtask, &vLod, vLodList, zSOURCE_LOD_META, 0 );
                  if ( SetCursorFirstEntityByInteger( vLod,
            ...
            while ( SetCursorFirstEntity( vSrc, "Domain", "SourceFile" )
                                                         >= zCURSOR_SET )
            {
               ...
               nFixes++;
               if ( SetCursorFirstEntityByInteger( vDomainList,
                        "W_MetaDef", "CPLR_ZKey", lZKey2, 0 ) >= zCURSOR_SET )
               {
                  ActivateMetaOI( vSubtask, &vDomain, vDomainList, zSOURCE_DOMAIN_META, 0 );
                  if ( SetCursorFirstEntityByInteger( vDomain,
                           "SourceFile", "ZKey", lZKey2, 0 ) >= zCURSOR_SET )
                  {
            ...
            while ( SetCursorNextEntity( vSrc, "Dialog", "SourceFile" )
                                                         >= zCURSOR_SET )
            {
               ...
               nFixes++;
               if ( SetCursorFirstEntityByInteger( vDialogList,
                        "W_MetaDef", "CPLR_ZKey", lZKey2, 0 ) >= zCURSOR_SET )
               {
                  ActivateMetaOI( vSubtask, &vDialog, vDialogList, zSOURCE_DIALOG_META, 0 );
                  if ( SetCursorFirstEntityByInteger( vDialog,
                           "SourceFile", "ZKey", lZKey2, 0 ) >= zCURSOR_SET )
                  {
         ...
         if ( SetCursorFirstEntity( vSrc, "LOD", "SourceFile" )
                                                >= zCURSOR_SET )
         {
            while ( SetCursorFirstEntity( vSrc, "Domain", "SourceFile" )
                                                         >= zCURSOR_SET )
            ...
            while ( SetCursorNextEntity( vSrc, "LOD", "SourceFile" )
                                                         >= zCURSOR_SET )
            {
         ...
         if ( SetCursorFirstEntity( vSrc, "HeaderFile", "SourceFile" ) >= zCURSOR_SET )
         {
            do
            {
               ...
               if ( SetCursorFirstEntityByInteger( vHeaderList,
                        "W_MetaDef", "CPLR_ZKey", lZKey2, 0 ) < zCURSOR_SET )
               {
            ...
            } while ( SetCursorNextEntity( vSrc, "HeaderFile",
                                      "SourceFile" ) >= zCURSOR_SET );
         }
         ...
         if ( nError && PROMPT )
         {
            ...
            zltoa( nError, szMsg );
            zstrcat( szMsg, " Errors were encountered, DeleteMetaOI?" );
            nRC = MessagePrompt( vSubtask, "RE00110",
                                 "Laucher",
                                 szMsg,
                                 zBEEP, zBUTTONS_YESNOCANCEL,
                                 zRESPONSE_NO,  0 );
   ...
   if ( MARK )
   {
      ...
      do
      {
         zstrcpy( szMsg, "Activating SourceFile " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
         ActivateMetaOI( vSubtask, &vSrc, vMetaList, zSOURCE_SRC_META, 0 );
         zstrcpy( szMsg, "Marking SourceFile " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
         ...
         if ( COMMIT )
         {
            zstrcpy( szMsg, "Commiting SourceFile " );
            GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                    "W_MetaDef", "Name" );
            zstrcat( szMsg, &szMsg[ 80 ] );
            MB_SetMessage( vSubtask, 1, szMsg );
...
//   zSOURCE_GO_META    4
   ...
   if ( VALIDATE )
   {
      ...
      do
      {
         ...
         nFixes = 0;
         bFirst = 0;
         zstrcpy( szMsg, "Activating Oper " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
         ActivateMetaOI( vSubtask, &vOper, vMetaList, zSOURCE_GO_META, 0 );
         zstrcpy( szMsg, "Validating Oper " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
...
#if 0   // DKS  undefined vSrcList ... DG ... should this be removed???
         if ( SetCursorFirstEntity( vOper, "SourceFile",
         ...
         if ( SetCursorFirstEntity( vOper, "HeaderFile", "Operation" )
                                                >= zCURSOR_SET )
         {
            do
            {
            ...
            }  while ( SetCursorNextEntity( vOper,
                        "HeaderFile", "Operation" ) >= zCURSOR_SET );
         }
         else
         {
         ...
         if ( nError && PROMPT )
         {
            ...
            zltoa( nError, szMsg );
            zstrcat( szMsg, " Errors were encountered, DeleteMetaOI?" );
            nRC = MessagePrompt( vSubtask, "RE00111",
                                 "Laucher",
                                 szMsg,
                                 zBEEP, zBUTTONS_YESNOCANCEL,
                                 zRESPONSE_NO,  0 );
   ...
   if ( MARK )
   {
      ...
      do
      {
         ...
         MB_SetMessage( vSubtask, 1, szMsg );
         ActivateMetaOI( vSubtask, &vOper, vMetaList, zSOURCE_GO_META, 0 );
         zstrcpy( szMsg, "Marking Oper " );
         GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                 "W_MetaDef", "Name" );
         zstrcat( szMsg, &szMsg[ 80 ] );
         MB_SetMessage( vSubtask, 1, szMsg );
         SetIncrementalUpdateFlags( vOper, 0,
                              zSET_INCR_OWNERSHIP | zSET_INCR_CREATED );
         if ( SetCursorFirstEntity( vOper, "Z_MetaDef", 0 ) == zCURSOR_SET )
            ExcludeEntity( vOper, "Z_MetaDef", zREPOS_NONE );

         SetIncrementalUpdateFlags( vOper, "SourceFile",
                                zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         SetIncrementalUpdateFlags( vOper, "HeaderFile",
                                zSET_INCR_PERSISTENT | zSET_INCR_INCLUDED );
         if ( COMMIT )
         {
            zstrcpy( szMsg, "Commiting Oper " );
            GetStringFromAttribute( &szMsg[ 80 ], vMetaList,
                                    "W_MetaDef", "Name" );
            zstrcat( szMsg, &szMsg[ 80 ] );
            MB_SetMessage( vSubtask, 1, szMsg );
