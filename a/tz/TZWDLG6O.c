                           ...
                           zVIEW     vSubtask )
{
   ...
   if ( ZeidonStringCompare( szDOCTYPE, 1, 0, "", 1, 0, 11 ) == 0 || ZeidonStringCompare( szDOCTYPE, 1, 0, "4.01", 1, 0, 11 ) == 0 )
   {
      //:szWriteBuffer = "<!DOCTYPE HTML PUBLIC ^-//W3C//DTD HTML 4.01 Transitional//EN^ ^http://www.w3.org/TR/html4/loose.dtd^>"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "<!DOCTYPE HTML PUBLIC ^-//W3C//DTD HTML 4.01 Transitional//EN^ ^http://www.w3.org/TR/html4/loose.dtd^>", 1, 0, 10001 );
      //:ELSE
   }
   else
   {
      //:IF szDOCTYPE = "5"
      if ( ZeidonStringCompare( szDOCTYPE, 1, 0, "5", 1, 0, 11 ) == 0 )
      {
   ...
   while ( RESULT > zCURSOR_UNCHANGED )
   {
      ...
      GetVariableFromAttribute( szTempString_0, 0, 'S', 33, vDialog, "ViewObjRef", "Name", "", 0 );
   ...
   if ( nRC >= 0 || CompareAttributeToString( vDialog, "Window", "WEB_RegisterZeidonWindow", "Y" ) == 0 )
   {
      ...
      //:szWriteBuffer = "   task = objectEngine.createTask( ^" + vLPLR.LPLR.Name + "^, true );"
      GetVariableFromAttribute( szTempString_1, 0, 'S', 33, vLPLR, "LPLR", "Name", "", 0 );
               ...
               if ( lTempInteger_5 == 0 )
               {
                  ...
                  if ( RESULT >= zCURSOR_SET )
                  {
                     ...
                     if ( CompareAttributeToInteger( vDialogTemp, "Action", "Type", zWAB_ExitDialogTask ) != 0 )
                     {
                        ...
                        GetVariableFromAttribute( szTempString_2, 0, 'S', 33, vDialogTemp, "Action", "Tag", "", 0 );
                        ZeidonStringCopy( szAction, 1, 0, "sm", 1, 0, 35 );
                        ZeidonStringConcat( szAction, 1, 0, szTempString_2, 1, 0, 35 );
   ...
   while ( nRC >= zCURSOR_SET )
   {
      ...
      GetVariableFromAttribute( szTempString_12, 0, 'S', 33, vDialogTemp, "Control", "Tag", "", 0 );
   ...
   if ( CompareAttributeToString( vDialog, "Window", "DfltButton", "" ) != 0 )
   {
      ...
      GetStringFromAttribute( szTempString_13, vDialog, "Window", "DfltButton" );
   ...
   if ( lTempInteger_24 == 0 )
   {
      ...
      while ( RESULT > zCURSOR_UNCHANGED )
      {
         ...
         GetVariableFromAttribute( szTempString_15, 0, 'S', 255, vDialogRoot, "ComboBoxEntry", "Name", "", 0 );
      ...
      else
      {
         ...
         else
         {
            ...
            else
            {
               ...
               //: (vDialog.ActWndEvent.Type != 1 AND vDialog.ActWndEvent.Type != 2))
               if ( lActionType != zWAB_StayOnWindowWebRefresh && ( lTempInteger_28 != 0 || ( CompareAttributeToInteger( vDialog, "ActWndEvent", "Type", 1 ) != 0 && CompareAttributeToInteger( vDialog, "ActWndEvent", "Type", 2 ) != 0 ) ) )
               {
               ...
               else
               {
                  ...
                  if ( lActionType == zWAB_StartModalWebPopup || lActionType == zWAB_StartModelessWebPopup )
                  {
                     ...
                     if ( CompareAttributeToString( vDialogRoot, "Dialog", "Tag", szDlgTag ) == 0 )
                     {
                        ...
                        GetStringFromAttribute( szTempString_17, vDialog, "Action", "WindowName" );
                        RESULT = SetCursorFirstEntityByString( vDialogTemp2, "Window", "Tag", szTempString_17, "" );

                        //:IF RESULT >= zCURSOR_SET
                        if ( RESULT >= zCURSOR_SET )
                        {
                           //:zIntegerToString( szWidth, 10, vDialogTemp2.Window.SZDLG_X / 34000 )
                           GetIntegerFromAttribute( &lTempInteger_29, vDialogTemp2, "Window", "SZDLG_X" );
                           zIntegerToString( szWidth, 10, lTempInteger_29 / 34000 );
                           //:zIntegerToString( szHeight, 10, vDialogTemp2.Window.SZDLG_Y / 34000 )
                           GetIntegerFromAttribute( &lTempInteger_30, vDialogTemp2, "Window", "SZDLG_Y" );
                           zIntegerToString( szHeight, 10, lTempInteger_30 / 34000 );
                           //:ELSE
                        }
                        else
                        {
                     ...
                     else
                     {
                        ...
                        else
                        {
                           ...
                           ZeidonStringCopy( szMsg, 1, 0, "Error in Window, ", 1, 0, 257 );
                           ZeidonStringConcat( szMsg, 1, 0, szTempString_17, 1, 0, 257 );
                           ZeidonStringConcat( szMsg, 1, 0, ": A 'Set Subwindow' for a Popup exists to a window that doesn't exist.", 1, 0, 257 );
   ...
   //:IF vDialog.ReusableSideWindow EXISTS
   lTempInteger_33 = CheckExistenceOfEntity( vDialog, "ReusableSideWindow" );
   if ( lTempInteger_33 == 0 )
   {
      ...
      if ( CompareAttributeToAttribute( vDialog, "ReusableSideDialog", "ZKey", vDialog, "Dialog", "ZKey" ) == 0 )
      {
         ...
         CreateViewFromView( &vDialogTemp, vDialog );
         //:SET CURSOR FIRST vDialogTemp.Window WHERE vDialogTemp.Window.ZKey = vDialog.ReusableSideWindow.ZKey
         GetIntegerFromAttribute( &lTempInteger_34, vDialog, "ReusableSideWindow", "ZKey" );
         RESULT = SetCursorFirstEntityByInteger( vDialogTemp, "Window", "ZKey", lTempInteger_34, "" );
         //:IF RESULT >= zCURSOR_SET
         if ( RESULT >= zCURSOR_SET )
         {
            //://Because the menu actions can be created on separate windows from the control
      ...
      {
         //:ActivateMetaOI_ByName( vSubtask, vDialogTemp, 0, zREFER_DIALOG_META, zSINGLE, vDialog.ReusableSideDialog.Tag, 0 )
         GetStringFromAttribute( szTempString_18, vDialog, "ReusableSideDialog", "Tag" );
         ActivateMetaOI_ByName( vSubtask, &vDialogTemp, 0, zREFER_DIALOG_META, zSINGLE, szTempString_18, 0 );
         //:// plListHandle = ActivateMetaOI_KeepList( vSubtask, vDialogTemp, 0, zREFER_DIALOG_META, zSINGLE, vDialog.ReusableSideDialog.Tag, 0, 0,
         //://                                         0, plListHandle )
         //:SET CURSOR FIRST vDialogTemp.Window WHERE vDialogTemp.Window.ZKey = vDialog.ReusableSideWindow.ZKey
   ...
   lReusableDialogZKey = 0;
   //:IF vDialog.ReusableMainWindow EXISTS
   lTempInteger_36 = CheckExistenceOfEntity( vDialog, "ReusableMainWindow" );
   ...
   {
      //:IF vDialog.DefaultReusableMainWindow EXISTS
      lTempInteger_37 = CheckExistenceOfEntity( vDialog, "DefaultReusableMainWindow" );
   ...
   lReusableDialogZKey = 0;
   //:IF vDialog.ReusableActionWindow EXISTS
   lTempInteger_38 = CheckExistenceOfEntity( vDialog, "ReusableActionWindow" );
   ...
   {
      //:IF vDialog.DefaultReusableActionWindow EXISTS
      lTempInteger_39 = CheckExistenceOfEntity( vDialog, "DefaultReusableActionWindow" );
   ...
   if ( CompareAttributeToString( vDialog, "Dialog", "WEB_PageBackgroundInclude", "" ) != 0 && ZeidonStringCompare( szWindowIsPopup, 1, 0, "", 1, 0, 2 ) == 0 && CompareAttributeToString( vDialogRoot, "Window", "WEB_NoBannerFlag", "" ) == 0 )
   {
      ...
      GetVariableFromAttribute( szTempString_19, 0, 'S', 255, vDialog, "Dialog", "WEB_PageBackgroundInclude", "", 0 );
      ZeidonStringCopy( szWriteBuffer, 1, 0, "<%@ include file=^", 1, 0, 10001 );
   ...
   if ( lTempInteger_42 == 0 && ZeidonStringCompare( szShowSideMenu, 1, 0, "Y", 1, 0, 2 ) == 0 )
   {
      ...
      if ( lTempInteger_43 == 0 && CompareAttributeToAttribute( vDialog, "ReusableSideWindow", "ZKey", vDialog, "Window", "ZKey" ) != 0 )
      {
         //:vDfltMenu = vDialog
         vDfltMenu = vDialog;
         //:ELSE
      ...
      if ( CompareAttributeToAttribute( vDialog, "ReusableSideDialog", "ZKey", vDialog, "Dialog", "ZKey" ) == 0 )
      {
         ...
         CreateViewFromView( &vDialogTemp, vDialog );
         //:SET CURSOR FIRST vDialogTemp.Window WHERE vDialogTemp.Window.ZKey = vDialog.ReusableSideWindow.ZKey
         GetIntegerFromAttribute( &lTempInteger_44, vDialog, "ReusableSideWindow", "ZKey" );
         RESULT = SetCursorFirstEntityByInteger( vDialogTemp, "Window", "ZKey", lTempInteger_44, "" );
         //:IF RESULT >= zCURSOR_SET
         if ( RESULT >= zCURSOR_SET )
         {
      ...
      {
         //:ActivateMetaOI_ByName( vSubtask, vDialogTemp, 0, zREFER_DIALOG_META,  zSINGLE, vDialog.ReusableSideDialog.Tag, 0 )
         GetStringFromAttribute( szTempString_20, vDialog, "ReusableSideDialog", "Tag" );
         ActivateMetaOI_ByName( vSubtask, &vDialogTemp, 0, zREFER_DIALOG_META, zSINGLE, szTempString_20, 0 );
         //:// plListHandle = ActivateMetaOI_KeepList( vSubtask, vDialogTemp, 0, zREFER_DIALOG_META, zSINGLE, vDialog.ReusableSideDialog.Tag, 0, 0,
         //://                                         0, plListHandle )
         //:SET CURSOR FIRST vDialogTemp.Window WHERE vDialogTemp.Window.ZKey = vDialog.ReusableSideWindow.ZKey
   ...
   else
   {
      ...
      lTempInteger_46 = CheckExistenceOfEntity( vDialogRoot, "DfltMenu" );
      //:   (vDialog.ReusableMainDialog DOES NOT EXIST OR  // don't put out side menu if side == top
      lTempInteger_47 = CheckExistenceOfEntity( vDialog, "ReusableMainDialog" );
      //:    lReusableDialogZKey != vDialog.ReusableMainDialog.ZKey OR
      //:    lReusableWindowZKey != vDialog.ReusableMainWindow.ZKey)
      if ( lTempInteger_46 == 0 && ZeidonStringCompare( szShowSideMenu, 1, 0, "Y", 1, 0, 2 ) == 0 && ( lTempInteger_47 != 0 || CompareAttributeToInteger( vDialog, "ReusableMainDialog", "ZKey", lReusableDialogZKey ) != 0 ||
   ...
   if ( RESULT >= zCURSOR_SET )
   {
      ...
      GetIntegerFromAttribute( &lTempInteger_48, vDialog, "Window", "SZDLG_X" );
      lSize = zLOUSHORT( lTempInteger_48 );
   ...
   GetIntegerFromAttribute( &lTempInteger_49, vDialog, "Window", "SZDLG_Y" );
   ...
   while ( nRC >= zCURSOR_SET )
   {
      ...
      GetIntegerFromAttribute( &lTempInteger_50, vDialogTemp, "Control", "PSDLG_X" );
      lSizeX = lTempInteger_50 * dDLUnits;
      //:lSizeY = vDialogTemp.Control.PSDLG_Y * dDLUnits
      GetIntegerFromAttribute( &lTempInteger_51, vDialogTemp, "Control", "PSDLG_Y" );
      lSizeY = lTempInteger_51 * dDLUnits;
      ...
      while ( RESULT > zCURSOR_UNCHANGED )
      {
         ...
         if ( CompareAttributeToString( vDialogTemp, "ControlDef", "Tag", "PushBtn" ) == 0 )
         {
            ...
            lTempInteger_52 = CheckExistenceOfEntity( vDialogTemp, "CtrlMapER_Attribute" );
            if ( lTempInteger_52 == 0 )
            {
               ...
               GetVariableFromAttribute( szTempString_24, 0, 'S', 33, vDialogTemp, "CtrlMapView", "Name", "", 0 );
               ZeidonStringCopy( szWriteBuffer, 1, 0, "   ", 1, 0, 10001 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_24, 1, 0, 10001 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, " = ", 1, 0, 10001 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, "task.getViewByName( ^", 1, 0, 10001 );
               GetVariableFromAttribute( szTempString_25, 0, 'S', 33, vDialogTemp, "CtrlMapView", "Name", "", 0 );
               ...
               GetVariableFromAttribute( szTempString_26, 0, 'S', 33, vDialogTemp, "CtrlMapView", "Name", "", 0 );
               ZeidonStringCopy( szWriteBuffer, 1, 0, "   if ( VmlOperation.isValid( ", 1, 0, 10001 );
               ...
               GetVariableFromAttribute( szTempString_28, 0, 'S', 33, vDialogTemp, "CtrlMapRelatedEntity", "Name", "", 0 );
               ...
               ZeidonStringConcat( szWriteBuffer, 1, 0, ".cursor.getStringFromAttribute( ^", 1, 0, 10001 );
               GetVariableFromAttribute( szTempString_30, 0, 'S', 33, vDialogTemp, "CtrlMapRelatedEntity", "Name", "", 0 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_30, 1, 0, 10001 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, "^, ^", 1, 0, 10001 );
               GetVariableFromAttribute( szTempString_31, 0, 'S', 33, vDialogTemp, "CtrlMapER_Attribute", "Name", "", 0 );
               ...
               if ( lTrace == 1 )
               {
                  ...
                  GetVariableFromAttribute( szTempString_32, 0, 'S', 33, vDialogTemp, "Control", "Tag", "", 0 );
      ...
      while ( RESULT > zCURSOR_UNCHANGED )
      {
         ...
         if ( CompareAttributeToString( vDialogTemp, "ControlDef", "Tag", "EditBox" ) == 0 )
         {
            ...
            GetIntegerFromAttribute( &lTempInteger_53, vDialogTemp, "Control", "SZDLG_X" );
            zIntegerToString( szWidth, 10, lTempInteger_53 / (ZDecimal) 3.5 );
         ...
         if ( CompareAttributeToString( vDialogTemp, "ControlDef", "Tag", "PushBtn" ) == 0 )
         {
            ...
            //:IF vDialogTemp.EventAct EXISTS
            lTempInteger_54 = CheckExistenceOfEntity( vDialogTemp, "EventAct" );
            ...
            if ( ZeidonStringCompare( szClass, 1, 0, "", 1, 0, 257 ) == 0 )
            {
               ...
               ZeidonStringConcat( szWriteBuffer, 1, 0, szStyle, 1, 0, 10001 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, " >", 1, 0, 10001 );
               GetVariableFromAttribute( szTempString_33, 0, 'S', 255, vDialogTemp, "Control", "Text", "", 0 );
            ...
            else
            {
               ...
               ZeidonStringConcat( szWriteBuffer, 1, 0, szStyle, 1, 0, 10001 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, " >", 1, 0, 10001 );
               GetVariableFromAttribute( szTempString_34, 0, 'S', 255, vDialogTemp, "Control", "Text", "", 0 );
   ...
   if ( ZeidonStringCompare( szNoPositioning, 1, 0, "Y", 1, 0, 2 ) == 0 && ZeidonStringCompare( szWindowIsPopup, 1, 0, "", 1, 0, 2 ) == 0 && ZeidonStringCompare( szWindowIsForDashboard, 1, 0, "", 1, 0, 2 ) == 0 )
   {
      ...
      else
      {
         ...
         GetVariableFromAttribute( szTempString_35, 0, 'S', 255, vDialogRoot, "Dialog", "WEB_FooterInclude", "", 0 );
         ZeidonStringCopy( szWriteBuffer, 1, 0, "<%@ include file=^", 1, 0, 10001 );
