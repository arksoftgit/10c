...
ActivateOPERSIGK( zVIEW vSubtask )
{
   ...
   zstrcat( szXGO_FileName, TZOPSIGK_FILE );
...
CreateNewParameter( zVIEW vSubtask )
{
   ...
   nRC = CreateTemporalMetaEntity( vSubtask, vOperSig, "Parameter", zPOS_AFTER );
   return( 0 );
}
...
CreateNewOperation( zVIEW vSubtask )
{
   ...
   nRC = CreateTemporalMetaEntity( vSubtask, vOperSig, "Operation", zPOS_AFTER );
...
CreateNewHeader( zVIEW vSubtask )
{
   ...
   nRC = GetViewByName( &vOperSig, "TZOPSIGK", vSubtask, zLEVEL_TASK );
   nRC = CreateTemporalMetaEntity( vSubtask, vOperSig, "HeaderFile", zPOS_AFTER );
   nRC = CreateMetaEntity( vSubtask, vOperSig, "DefinedItem", zPOS_AFTER );
...
CreateNewSource( zVIEW vSubtask )
{
   ...
   nRC = GetViewByName( &vOperSig, "TZOPSIGK", vSubtask, zLEVEL_TASK );
   nRC = CreateTemporalMetaEntity( vSubtask, vOperSig, "SourceFileOfOperation", zPOS_AFTER );
   nRC = CreateMetaEntity( vSubtask, vOperSig, "ExecComposite", zPOS_AFTER );

   return( 0 );
}

////////////////////////////////////////////////////////////////
// We must use CM operation to create DefinedItem entities
// because of ZKey.
////////////////////////////////////////////////////////////////
zOPER_EXPORT zSHORT OPERATION
CreateNewDefinedItem( zVIEW vSubtask )
{
   ...
   nRC = GetViewByName( &vOperSig, "TZOPSIGK", vSubtask, zLEVEL_TASK );
   nRC = CreateTemporalMetaEntity( vSubtask, vOperSig, "DefinedItem", zPOS_AFTER );
...
CopySelectedOperation( zVIEW vSubtask )
{
   ...
   GetStringFromAttribute( szFile, vOperSig, "HeaderFile_Oper", "Name" );
   ...
   szFile[ 0 ] = 0;
   GetStringFromAttribute( szFile, vOperSig, "SourceFile", "Name" );
...
SelectOperation( zVIEW vSubtask )
{
   ...
   GetStringFromAttribute( szOperation, vOperSig2, "Operation", "Name" );
   ...
   // Include the Header File
   GetStringFromAttribute( szFile, vOperSig2, "HeaderFile_Oper", "Name" );
   ...
   // Include the Source File.
   szFile[ 0 ] = 0;
   GetStringFromAttribute( szFile, vOperSig2, "SourceFile", "Name" );
