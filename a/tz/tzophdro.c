                          ...
                          zSHORT           nMsg )
{
   ...
   GetStringFromAttribute( szDir, vTaskLPLR, "LPLR", "PgmSrcDir" );
   if ( szDir[ 0 ] == 0 )
      GetStringFromAttribute( szDir, vTaskLPLR, "LPLR", "MetaSrcDir" );
                      ...
                      zSHORT       nMsg )
{
   ...
   if ( nRC == 1 )
      GetStringFromAttribute( szHDR_Name, vHDR_Ref, "HeaderFile", "Name" );
   else
      zstrcpy( szHDR_Name, "" );
