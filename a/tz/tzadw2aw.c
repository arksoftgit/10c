...
//                           vUSSubEnt, "UIS_Entity", "AutodesignCaseType" );
   ...
   GetStringFromAttribute( szEntityName, vUSSubEnt, "LOD_Entity", "Name" );
   zstrcpy( szSelectOperationName, "SelectSubObj" );
   zstrcat( szSelectOperationName, szEntityName );
                                  ...
                                  "Y" ) == 0 )
   {
      ...
      zstrcpy( szListQualName, "ListQual" );
      zstrcat( szListQualName, szEntityName );
      szListQualName[ 32 ] = 0;
      ...
      GetStringFromAttribute( szEntityName,
                              vUSSubEnt, "LOD_Entity", "Name" );
      zstrcpy( szListQualName, "ListAllSubObj" );
      zstrcat( szListQualName, szEntityName );
      szListQualName[ 32 ] = 0;
                                ...
                                zPCHAR szCase )
{
   ...
   {
      zstrcpy( szMsg, "Invalid Case 2 specification for entity: " );
      GetStringFromAttribute( szEntityName, vUSSubEnt, "LOD_Entity", "Name" );
   ...
   GetStringFromAttribute( szEntityName, vUSSubEnt, "LOD_Entity", "Name" );
   zstrcpy( szListOperationName, "ListAllSubObj" );
   zstrcat( szListOperationName, szEntityName );
   szListOperationName[ 32 ] = 0;

   // Get Button text.
   GetStringFromAttribute( szButtonText,
                           vDefaults, "InitValues", "SelectOnParent" );
                              ...
                              zPCHAR szTypeFlag )
{
   ...
   if ( CompareAttributeToString( vUSSubEnt, "WndDesign", "ListCreateAction",
                                  "Y" ) == 0 )
   {
      lButtonNbr++;
      GetStringFromAttribute( szButtonText,
   ...
   if ( CompareAttributeToString( vUSSubEnt, "WndDesign", "UsageStyle",
                                  "U" ) == 0 )
   {
      lButtonNbr++;
      GetStringFromAttribute( szButtonText,
                                  ...
                                  "D" ) == 0 )
   {
      lButtonNbr++;
      GetStringFromAttribute( szButtonText,
                              vDefaults, "InitValues", "DetailDisplay" );
   ...
   if ( CompareAttributeToString( vUSSubEnt, "WndDesign", "ListDeleteAction",
                                  "Y" ) == 0 )
   {
      lButtonNbr++;
      GetStringFromAttribute( szButtonText,
                               ...
                               zPCHAR szCase )
{
   ...
   nRC = oTZWDLGSO_AutoDesignGroupboxL( vSubtask,
                                        vUSSubEnt,
                                        vNewDialog,
                                        vDefaults,
                                        "B",
                               ...
                               zPCHAR szCase )
{
   ...
   {
      zstrcpy( szMsg, "External Object for Selection List not specified for entity: " );
      GetStringFromAttribute( szEntityName, vUSSubEnt, "LOD_Entity", "Name" );
      zstrcat( szMsg, szEntityName );
      zstrcat( szMsg, "." );
   ...
   lButtonNbr++;
   GetStringFromAttribute( szButtonText,
                           vDefaults, "InitValues", "CloseOnInclude" );
                                  ...
                                  "Y" ) == 0 )
   {
      ...
      SetCursorFirstEntityByString( vNewDialog, "ViewObjRef", "Name",
                                    szLOD_Name, 0 );
      CreateViewFromViewForTask( &vTemp, vUSSubEnt, 0 );
      ResetViewFromSubobject( vTemp );
      GetStringFromAttribute( szEntityName, vTemp, "LOD_Entity", "Name" );
      SetCursorFirstEntityByString( vObject, "LOD_Entity", "Name",
                                    szEntityName, 0 );
      CreateMetaEntity( vSubtask, vNewDialog, "ActMap", zPOS_AFTER );
      SetAttributeFromInteger( vNewDialog, "Action", "SB_SubAction",
                               zSubActionCreateTemporalEntity );
      IncludeSubobjectFromSubobject( vNewDialog, "ActMapLOD_Entity",
                                     vObject,    "LOD_Entity", zPOS_AFTER );
...
//   SetAttributeFromInteger( vNewDialog, "Window", "ControlTagCounter", 0 );
   ...
   // since they may exist if the entity was once defined as a different
   // Case type.
                                ...
                                zPCHAR szCase )
{
   ...
   {
      zstrcpy( szMsg, "No List attributes selected for entity: " );
      GetStringFromAttribute( szEntityName, vUSSubEnt, "LOD_Entity", "Name" );
      zstrcat( szMsg, szEntityName );
      zstrcat( szMsg, "." );
      ...
      // on the parent window.
      oTZWDLGSO_AutoDesignGroupboxL( vSubtask,
                                     vUSSubEnt,
                                    vNewDialog,
                                    vDefaults,
                                    "B",
        ...
        szCase[ 0 ] == '4' )
   {
      ...
      GetStringFromAttribute( szWindowTag,
                              vNewDialogRoot, "Window", "Tag" );
      CreateMetaEntity( vSubtask, vNewDialogRoot, "Window", zPOS_AFTER );
      ...
      oTZADCSDO_AutoDesignCase4UPD( vSubtask,
                                    vUserSpec,
                                    vUPD_UserSpec,
                                    vUSSubEnt,
                                    vNewDialogRoot,
      ...
      // Set auto disable Action for null entity.
      SetAttributeFromInteger( vNewDialogRoot, "Action",
                               "SB_ActionDisabling", 8 );
                              ...
                              zPCHAR szActivateOperation )
{
   ...
   GetStringFromAttribute( szPrompt,
                           vUSSubEnt, "WndDesign", "ListQualWndPrompt" );
   ...
   lButtonNbr++;
   GetStringFromAttribute( szButtonText,
                           vUSSubEnt, "WndDesign", "ListQualWndButtonText" );
   oTZADCSDO_CreateButtonActOper( vSubtask, vUSSubEnt, vNewDialog, vNewDialogRoot,
