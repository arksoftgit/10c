                ...
                zPBOOL  bFileExists )
{
   ...
   GetStringFromAttribute( szFileName, vTaskLPLR, szlLPLR, szlPgmSrcDir );
   ...
   if ( SysOpenFile( vTaskLPLR, szFileName, COREFILE_EXIST ) == -1 )
   {
      ...
      *bFileExists = FALSE;
      ...
      {
         hFile = SysOpenFile( vTaskLPLR, szFileName, COREFILE_CREATE );
      ...
      do
      {
         ...
         if ( !bFinished && oEditor->GetCurrentToken() == cmTokenTypeKeyword )
         {
            ...
            if ( nViewType == 1 )
            {
               ...
               GetStringFromAttribute( (LPSTR)(LPCSTR)strObjectName, vVor, "LOD", "Name" );
               DropMetaOI( vSubtask, vVor );
            }
            ...
            if ( nRC != zCURSOR_SET )
            {
               ...
               SetAttributeFromString( vEdWrk,
                                       szlView, szlObjectName, strObjectName );
               SetAttributeFromString( vEdWrk,
                                       szlView, szlVariableName, strVarName );
            }
            else
...
OpIns_InsertOperation( zVIEW vCurrentSubtask )
{
   ...
   GetStringFromAttribute( szType, vEdWrk, szlOper, szlType );
...
SaveAndParse( zVIEW vSubtask, zCPCHAR cpcGenLang )
{
   ...
   if ( vEdWrk == 0 )
   {
      ...
      MessagePrompt( vEdWrk, "ED0001", szlZeidonEditor, sz, 1,
                        0, 0, zICON_EXCLAMATION );
      return( 0 );
   }
                                  ...
                                  szlVML_File ) != 0 )
   {
      ...
      MessagePrompt( vEdWrk, "ED0002", szlZeidonEditor,
   ...
   *psz = 0;
   ...
   else
   {
      ...
      zstrcpy( sz, "Parse completed successfully." );
      MessagePrompt( vEdWrk, "ED0003", szlZeidonEditor,
                     sz, 0, 0, 0, zICON_INFORMATION );
