                       ...
                       zVIEW     vSubtask )
{
   ...
   GetStringFromAttribute( szTempString_0, vWkRecur, "HD_ChildNode", "Name" );
   ...
   { 
      ...
      GetStringFromAttribute( szTempString_0, vWkHigh, "NewEntity", "FieldName" );
...
o_ImportWorkOIToZeidon( zVIEW     vSubtask )
{
   ...
   GetStringFromAttribute( szTempString_1, vWkRecur, "NewEntity", "FieldName" );
...
ImportCatalogAndWSK( zVIEW     vSubtask )
{
   ...
   //:                szFilename )
   GetStringFromAttribute( szTempString_0, TZSIIMWK, "TZSIIMWK", "wkServerName" );
   GetStringFromAttribute( szTempString_1, TZSIIMWK, "CatFiles", "wkCatFiles" );
   GetStringFromAttribute( szTempString_2, TZSIIMWK, "Catalogs", "wkCatalogName" );
