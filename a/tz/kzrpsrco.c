                         ...
                         zLONG     lPageHeight )
{
   ...
   { 
      ...
      { 
         ...
         nRC = oTZRPSRCO_PrintPage( vSubtask, vSourceHierOI, vReportDef, lWork, lPageWidth, lPageHeight, szRptGroupSetTag, szRptGroupTag, -2147483648 );
                     ...
                     zLONG     lFlags )
{
   ...
   { 
      ...
      SysReadZeidonIni( -1, "[Debug]", "IgnoreReportFix011201(ExtraDtlHdr)", szINI );
      //:IF szINI = "Y"
                     ...
                     { 
                        ...
                        { 
                           ...
                           { 
                              ...
                              GetStringFromAttribute( szTempString_0, vReportDef, "GroupSet", "Tag" );
                              TraceLineS( "         GroupSet: ", szTempString_0 );
                              //:TraceLineS( "         Group   : ", vReportDef.Group.Tag )
                              GetStringFromAttribute( szTempString_1, vReportDef, "Group", "Tag" );
                              TraceLineS( "         Group   : ", szTempString_1 );
                              //:TraceLineS( "         Control : ", vReportDef.Control.Tag )
                              GetStringFromAttribute( szTempString_2, vReportDef, "Control", "Tag" );
