                            ...
                            zVIEW    vSubtask )
{
   ...
   if ( RESULT > 0 )
   {
      nZRetCode = GetStringFromAttribute( szFileName, vLPLR, "LPLR", "MetaSrcDir" );
   ...
   nZRetCode = GetStringFromAttribute( szTempString_0, vSubtask, "Dialog", "Tag" );
...
oTZWDGRWO_Save( zVIEW    vGRW )
{
   ...
   nZRetCode = GetStringFromAttribute( szTempString_0, vGRW, "Dialog", "Tag" );
   ZeidonStringConcat( szFileName, 1, 0, szTempString_0, 1, 0, zMAX_FILESPEC_LTH + 1 );
   ZeidonStringConcat( szFileName, 1, 0, ".dgr", 1, 0, zMAX_FILESPEC_LTH + 1 );
            ...
            if ( CompareAttributeToString( vGRW, "ER_Entity", "Type", "D" ) == 0 )
            {
               ...
               while ( RESULT >= zCURSOR_SET && nFound == 0 )
               {
                       ...
                       CompareAttributeToString( vSubtask, "Action", "DialogName", "" ) == 0 )
                  {
                     ...
                     {
                        nZRetCode = GetStringFromAttribute( szName, vSubtask, "Action", "WindowName" );
                     }
                  }
                  else
                  {
                     if ( CompareAttributeToString( vSubtask, "Action", "WindowName", "" ) == 0 )
                     {
                        nZRetCode = GetStringFromAttribute( szName, vSubtask, "Action", "DialogName" );
                     ...
                     else
                     {
                        ...
                        nZRetCode = GetStringFromAttribute( szTempString_0, vSubtask, "Action", "WindowName" );
                          ...
                          zVIEW    vSubtask )
{
   ...
   nZRetCode = GetStringFromAttribute( szTempString_1, vSubtask, "Dialog", "Tag" );
   ...
   nZRetCode = GetStringFromAttribute( szTempString_2, vSubtask, "Window", "Tag" );
   ...
   {
      nZRetCode = GetStringFromAttribute( szTempString_4, vSubtask, "Window", "Tag" );
                          ...
                          zVIEW    vSubtask )
{
   ...
   nZRetCode = GetStringFromAttribute( szTempString_1, vSubtask, "Window", "Tag" );
   ZeidonStringCopy( szTempString_0, 1, 0, "Action -- ", 1, 0, 254 );
   ZeidonStringConcat( szTempString_0, 1, 0, szTempString_1, 1, 0, 254 );
   ZeidonStringConcat( szTempString_0, 1, 0, ":", 1, 0, 254 );
   nZRetCode = GetStringFromAttribute( szTempString_2, vSubtask, "Action", "Tag" );
   ZeidonStringConcat( szTempString_0, 1, 0, szTempString_2, 1, 0, 254 );
   nZRetCode = SetAttributeFromString( vGRW, "ER_Entity", "Desc", szTempString_0 );
   if ( CompareAttributeToAttribute( vSubtask, "DfltWnd", "ZKey", vSubtask, "Window", "ZKey" ) == 0 )
   {
   ...
   else
   {
      ...
      else
      {
         ...
         else
         {
            ...
            nZRetCode = GetStringFromAttribute( szTempString_5, vSubtask, "Action", "WindowName" );
      ...
      if ( RESULT < zCURSOR_SET )
      {
         ...
         if ( CompareAttributeToAttribute( vSubtask, "DfltWnd", "ZKey", vSubtask, "Window", "ZKey" ) == 0 )
         {
            nZRetCode = GetStringFromAttribute( szTempString_8, vSubtask, "Window", "Tag" );
   ...
   nEvents = 0;
   nZRetCode = GetStringFromAttribute( szName, vSubtask, "Window", "Tag" );
   RESULT = SetCursorFirstEntityByString( vGRW_Win, "ER_Entity", "Name", szName, "" );
   ...
   if ( nEvents == 0 )
   {
      nZRetCode = GetStringFromAttribute( szTempString_9, vSubtask, "Window", "Tag" );
      ZeidonStringConcat( szTempString_9, 1, 0, ":", 1, 0, 32 );
      nZRetCode = GetStringFromAttribute( szTempString_10, vSubtask, "Action", "Tag" );
                           ...
                           zSHORT   nCtrlType )
{
   ...
   switch( nCtrlType )
   {
      case 1  :
         ...
         nZRetCode = GetStringFromAttribute( szFromName, vSubtask, "ActWndEvent", "EventName" );
         break;
      case 2  :
         nZRetCode = GetStringFromAttribute( szTempString_0, vSubtask, "ActCtrl", "Tag" );
         ...
         {
            nZRetCode = GetStringFromAttribute( szFromName, vSubtask2, "ControlDef", "Tag" );
         }
         else
         {
         ...
         break;
      case 3  :
         nZRetCode = GetStringFromAttribute( szTempString_1, vSubtask, "ActOpt", "Text" );
         ...
         break;
      case 4  :
         nZRetCode = GetStringFromAttribute( szTempString_2, vSubtask, "ActHot", "Tag" );
                          ...
                          zSHORT   nEvents )
{
   ...
   while ( RESULT > zCURSOR_UNCHANGED )
   {
      if ( CompareAttributeToString( vGRW_Act, "ER_RelType", "Type", "E" ) == 0 )
      {
         ...
         nZRetCode = GetStringFromAttribute( szTempString_0, vGRW_Win, "ER_RelType", "Fact" );
         ZeidonStringConcat( szTempString_0, 1, 0, " | ", 1, 0, 254 );
         nZRetCode = GetStringFromAttribute( szTempString_1, vGRW_Tmp, "ER_RelLink_2", "Name" );
         ZeidonStringConcat( szTempString_0, 1, 0, szTempString_1, 1, 0, 254 );
