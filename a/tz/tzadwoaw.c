...
// TraceLineS("IN", "CreateNewWindowInfo" );
   ...
   {
      GetStringFromAttribute( szOrigName, vNewDialog, "Window", "Tag" );
...
// TraceLineS("IN", "CreateMenuActions" );
   ...
   GetStringFromAttribute( cAutoVersion, vUserSpec,
                            "WndDesign", "AutoVersion" );
   GetStringFromAttribute( cCancel, vUserSpec,
                            "WndDesign", "UpdateCancelAction" );
   GetStringFromAttribute( cDelete, vUserSpec,
                            "WndDesign", "UpdateDeleteAction" );
   GetStringFromAttribute( cSave, vUserSpec,
                            "WndDesign", "UpdateSaveAction" );
   GetStringFromAttribute( cNext, vUserSpec,
                            "WndDesign", "UpdateNextAction" );
   GetStringFromAttribute( cPrev, vUserSpec,
                            "WndDesign", "UpdatePrevAction" );
                                  ...
                                  "Update", "Y" ) != 0 )
   {
      ...
      GetStringFromAttribute( szEntityName, vUserSpec,
                              "LOD_Entity", "Name" );
      zstrcpy( szWorkString, "The runtime permission for entity " );
      zstrcat( szWorkString, szEntityName );
      zstrcat( szWorkString, " does not allow an update.  " );
      zstrcat( szWorkString, "Still add the Save window action?  " );
   ...
   if ( cDelete[ 0 ] == 'Y' )
   {
      ...
      if ( !bInclude && CompareAttributeToString( vUserSpec, "LOD_Entity",
                                                  "Delete", "Y" ) != 0 )
      {
         GetStringFromAttribute( szEntityName, vUserSpec,
                                 "LOD_Entity", "Name" );
         zstrcpy( szWorkString, "The runtime permission for entity " );
         zstrcat( szWorkString, szEntityName );
         zstrcat( szWorkString, " does not allow a delete.  " );
         zstrcat( szWorkString, "Still add the Delete window action?  " );
                                                 ...
                                                 "Exclude", "Y" ) != 0 )
      {
         ...
         zstrcpy( szWorkString, "The runtime permission for entity " );
         zstrcat( szWorkString, szEntityName );
         zstrcat( szWorkString, " does not allow an exclude.  " );
         zstrcat( szWorkString, "Still add the Delete window action?  " );
                                  ...
                                  "Update", "Y" ) != 0 )
   {
      ...
      zstrcat( szWorkString, szEntityName );
      zstrcat( szWorkString, " does not allow an update.  " );
      zstrcat( szWorkString, "Still add the Next and Prev window actions?  " );
        ...
        cNext[ 0 ] == 'Y' || cPrev[ 0 ] == 'Y' )
   {
      ...
      if ( cDelete[ 0 ] == 'Y' )
      {
         ...
         {
            SetAttributeFromString( vNewDialog2, "Option",
                                     "Text", "&Delete" );
            SetAttributeFromString( vNewDialog2, "Option",
                                     "Tag", "Delete" );
         }
         ...
         CreateMetaEntity( vSubtask, vNewDialog, "Action", zPOS_AFTER );
         SetAttributeFromAttribute( vNewDialog, "Action", "Tag",
                                     vNewDialog2, "Option", "Text" );
         ...
         // this cancel button is pushed.
         if ( CompareAttributeToString ( vAutoDesWk, "AutoDesignWork",
                                "DeleteRoutineFlagForRootEntity", "D" ) == 0 )
         {
            ofnTZWDLGSO_CreateTheOperation( vSubtask, vNewDialog,
                                            "DeleteObjectEntity", "",
                                            vNewDialog, "ActOper" );
         ...
         else
         {
            if ( !bInclude )
               SetAttributeFromInteger( vNewDialog, "Action",
                                        "SB_SubAction", 4 ); /* Delete */
            else
               SetAttributeFromInteger( vNewDialog, "Action",
                                        "SB_SubAction", 8 ); /* Exclude */
            CreateMetaEntity( vSubtask, vNewDialog, "ActMap", zPOS_AFTER );
            IncludeSubobjectFromSubobject( vNewDialog, "ActMapLOD_Entity",
                                           vUserSpec, "LOD_Entity",
                                           zPOS_AFTER );
      ...
      if ( cNext[ 0 ] == 'Y' )
      {
                               ...
                               zstrcmp( "UI_Spec", szWorkString ) == 0 )
         {
            GetStringFromAttribute( szEntityName, vUserSpec,
                                    "LOD_Entity", "Name" );
            zstrcpy( szWorkString, "Because " );
            zstrcat( szWorkString, szEntityName );
            zstrcat( szWorkString, " is the root entity. The window "
                     "action Next will not work properly.  Still add the"
                     " option?" );
         ...
         if ( lRC == zRESPONSE_YES )
         {
            ...
            {
               SetAttributeFromAttribute( vNewDialog2, "Option", "Text",
                                           vUserSpec, "WndDesign", "UpdateNextText" );
      ...
      if ( cPrev[ 0 ] == 'Y' )
      {
                               ...
                               zstrcmp( "UI_Spec", szWorkString ) == 0 )
         {
            ...
            zstrcat( szWorkString, szEntityName );
            zstrcat( szWorkString, " is the root entity. The window "
                     "action Prev will not work properly.  Still add the"
                     " option?" );
         ...
         if ( lRC == zRESPONSE_YES )
         {
            ...
            {
               SetAttributeFromAttribute( vNewDialog2, "Option", "Text",
                                          vUserSpec, "WndDesign", "UpdatePrevText" );
            ...
            if ( CompareAttributeToString ( vAutoDesWk, "AutoDesignWork",
                                  "PrevRoutineFlagForRootEntity", "P" ) == 0 )
            {
               ofnTZWDLGSO_CreateTheOperation( vSubtask, vNewDialog,
                                               "ProcessPrevSelectedItem", "",
                                               vNewDialog, "ActOper" );
                         ...
                         int    *nNbrButtons )
{
   ...
   *nNbrButtons = *nNbrButtons + 1;
   ...
   if ( lTempInteger_0 == 0 )
   {
      zstrcat( szButtonText, szDefaultText );
   }
                                 ...
                                 zVIEW vAutoDesWk )
{
   zVIEW    vTempView;
   zVIEW    vTempStyle;
   static long lMaxLength;
   static long lNbrButtons;
   zSHORT   nRC;
   zSHORT   bInclude;
   int      lCC;
   int      lCL;
...
// lLine = 46;
   ...
   GetStringFromAttribute( cAutoVersion, vUserSpec,
                            "WndDesign", "AutoVersion" );
   GetStringFromAttribute( cCancel, vUserSpec, "WndDesign", "UpdateCancelAction" );
   GetStringFromAttribute( cDelete, vUserSpec, "WndDesign", "UpdateDeleteAction" );
   GetStringFromAttribute( cSave, vUserSpec, "WndDesign", "UpdateSaveAction" );
   GetStringFromAttribute( cNext, vUserSpec, "WndDesign", "UpdateNextAction" );
   GetStringFromAttribute( cPrev, vUserSpec, "WndDesign", "UpdatePrevAction" );
        ...
        cNext[ 0 ] == 'Y' || cPrev[ 0 ] == 'Y' )
   {
      ...
      if ( cCancel[ 0 ] == 'Y' )
      {
         if ( cSave[ 0 ] != 'Y' && cDelete[ 0 ] != 'Y' )
         {
            ...
            GetStringFromAttribute( szWorkString, vUserSpec,
                                    "WndDesign", "UpdateCancelText" );
         ofnTZWDLGSO_BuildButton( vSubtask, vUserSpec,
                                  vNewDialog, szWorkString,
                                  "Cancel", &lMaxLength, &lNbrButtons );
      ...
      {
         GetStringFromAttribute( szWorkString, vUserSpec,
                                  "WndDesign", "UpdateDeleteText" );
         ofnTZWDLGSO_BuildButton( vSubtask, vUserSpec, vNewDialog, szWorkString,
                                  "&Delete", &lMaxLength, &lNbrButtons );
      ...
      if ( cPrev[ 0 ] == 'Y' )
      {
         ...
         if ( nRC == zRESPONSE_YES )
         {
            GetStringFromAttribute( szWorkString, vUserSpec, "WndDesign",
                                    "UpdatePrevText" );
            ofnTZWDLGSO_BuildButton( vSubtask, vUserSpec,
                                     vNewDialog, szWorkString,
                                     "&Prev", &lMaxLength, &lNbrButtons );
      ...
      lLine = 6;
      RESULT = SetCursorFirstEntityByInteger( vNewDialog, "ControlDef",
                                              "ZKey", 1020, "Window" );
      while ( RESULT > zCURSOR_UNCHANGED )
      {
         ...
         lLine = lLine + 15;
         RESULT = SetCursorNextEntityByInteger( vNewDialog, "ControlDef",
                                                "ZKey", 1020, "Window" );
      }
   }
...
AddSpacesToString( zPCHAR szWorkString )
{
   ...
   szWorkString2[ k ] = 0;
   zstrcpy( szWorkString, szWorkString2 );
   return( 0 );
}
...
// TraceLineS("IN", "BasicWindowPainting" );
   ...
   {
      zstrcpy( szER_AttributeName, "M_ER_Attribute" );
      zstrcpy( szDomainName, "M_Domain" );
   }
   else
   {
      zstrcpy( szER_AttributeName, "MT_ER_Attribute" );
      zstrcpy( szDomainName, "MT_Domain" );
   }
   ...
   lScreenWidth = 321;
   CreateViewFromViewForTask( &vNewDialog2, vNewDialog, 0 );
   GetStringFromAttribute( cUsage, vUserSpec, "WndDesign", "UsageStyle" );
...
// ResetView( vUserSpecRoot );  does too much
   ...
   GetIntegerFromAttribute( &lCI,
                            vDefaults, "InitValues", "EditboxVerticalSpacing" );
   if ( lCI == 0 )
      lCI = 3;
   ...
   while ( RESULT > zCURSOR_UNCHANGED )
   {
      if ( CompareAttributeToString( vNewDialog, "Control",
                                     "Tag", "RadioGrp" ) != 0 &&
           CompareAttributeToString( vNewDialog, "Control",
                                     "Tag", "GroupBox" ) != 0 &&
           CompareAttributeToString( vNewDialog, "Control",
                                     "Tag", "ListBox" ) != 0 )
      {
         GetIntegerFromAttribute( &i, vNewDialog, "Control", "PSDLG_X" );
         GetIntegerFromAttribute( &lTempInteger_1, vNewDialog,
                                   "Control", "SZDLG_X" );
         i = i + lTempInteger_1;
         lTmpNumber = i - lCC;
...
// RESULT = SetCursorFirstEntity( vUserSpec, szLOD_AttributeName, "" );
   ...
   while ( RESULT >= zCURSOR_SET )
   {
      ...
      zstrcpy( szWorkString, "Text" );
      zstrcat( szWorkString, szWork );
      ...
      if ( CompareAttributeToString( vUserSpec, szER_AttributeName,
                                     "PromptPaintLit", "" ) == 0 )
      {
         GetStringFromAttribute( szWorkString, vUserSpec, szER_AttributeName,
                                 "Name" );
      ...
      j = ofnTZWDLGSO_GetSizeForAttr( vSubtask, vUserSpec,
                                      szDomainName, szER_AttributeName );
   ...
   // zstrcat( szWorkString, szWork );
      ...
      {
         zstrcpy( szFirstDataFieldName, szWorkString );
         SetAttributeFromString( vUserSpec, "UIS_Entity", "FirstDataFieldName",
                                 szFirstDataFieldName );
      }
      ...
      if ( cUsage[ 0 ] == 'U' )
         SetCursorFirstEntityByString( vCtrlDef, "ControlDef", "Tag",
                                       "EditBox", "" );
      else
         SetCursorFirstEntityByString( vCtrlDef, "ControlDef", "Tag",
                                       "Text", "" );
      ...
      if ( cUsage[ 0 ] == 'U' )
      {
         ...
         if ( CompareAttributeToString( vUserSpec, szLOD_AttributeName,
                                          "ParticipatesInKey", "G" ) == 0 ||
               CompareAttributeToString( vUserSpec, szLOD_AttributeName,
                                          "Derived", "Y" ) == 0 )
         {
         ...
         if ( CompareAttributeToString( vUserSpec, szDomainName,
                                        "DomainType", "T" ) == 0 )
         {
            SetCursorFirstEntityByString( vCtrlDef, "ControlDef",
                                          "Tag", "ComboBox", "" );
            ...
            SetAttributeFromInteger( vTZPNCTWO, "ComboBox",
                                       "Subtype", 0 );
            ...
            // regular control because it has to have room to
            // drop down.
            SetAttributeFromInteger( vNewDialog, "Control",
                                     "SZDLG_Y", lCL * 5 );
            // A combobox's width should be a little wider to account
            // for the up and down arrows.
            AddToAttributeFromInteger( vNewDialog, "Control",
                                       "SZDLG_X", lCC * 3 );
      ...
      if ( CheckExistenceOfEntity( vUserSpec, "UIS_ViewObjRef" ) == 0 )
      {
         IncludeSubobjectFromSubobject( vNewDialog, "CtrlMapView",
                                        vUserSpec, "UIS_ViewObjRef",
                                        zPOS_AFTER );
      }
      else
      {
         IncludeSubobjectFromSubobject( vNewDialog, "CtrlMapView",
                                        vUserSpecRoot, "UIS_ViewObjRef",
                                        zPOS_AFTER );
      }

      IncludeSubobjectFromSubobject( vNewDialog, "CtrlMapLOD_Attribute",
                                     vUserSpec, szLOD_AttributeName,
                                     zPOS_AFTER );

      // Exit the loop and set the return code if we've reached the max
      // size of the group.
   ...
   while ( RESULT > zCURSOR_UNCHANGED )
   {
      ...
      {
         GetStringFromAttribute( szUsage, vNewDialog2, "ControlDef", "Tag" );
         GetStringFromAttribute( szWorkString, vNewDialog2,
                                  "Control", "Text" );
         nRC = zstrcmp( szUsage, "Text" );
         // An output field is a text field without the text.
         // if ( zstrcmp( szUsage, "Text" ) != 0 )
         if ( nRC != 0 || (nRC == 0 &&
              CheckExistenceOfEntity( vNewDialog2, "CtrlMap" ) == 0) )
         {
            GetIntegerFromAttribute( &j, vNewDialog2,
                                      "Control", "PSDLG_X" );
            GetIntegerFromAttribute( &k, vNewDialog2,
                                      "Control", "SZDLG_X" );
            if ( j < lMaxFieldDLG_X )
            {
               j = lMaxFieldDLG_X - j;
               ...
               */
               if ( j > 0 )
               {
                  SetAttributeFromInteger( vNewDialog2, "Control",
   ...
   if ( CompareAttributeToString( vUserSpec, "WndDesign",
                                  "Cascade", "Y" ) == 0 )
   {
      GetIntegerFromAttribute( &lLevel, vUserSpec,
                               "LOD_Entity", "IndentLvl" );
...
// TraceLineS("IN CreateTheOperation for:", szOperName );
   ...
   nRC = SetCursorFirstEntityByString( vOper, "Operation",
                                       "Name", szOperName, "" );
   if ( nRC < zCURSOR_SET )
   {
      ...
      SetAttributeFromString( vOper, "Parameter",
                              "ShortDesc", "vNewDialog" );
   ...
   {
      zstrcpy( szWorkString, "Attempt to add operation '" );
      zstrcat( szWorkString, szOperName );
      zstrcat( szWorkString, "' to an Action "
               "that has associated operation '" );
      GetAddrForAttribute( &szName, vInclude, szIncludeEntityName, "Name" );
      zstrcat( szWorkString, szName );
      zstrcat( szWorkString, "'." );
                       ...
                       zVIEW   vDefaults )
{
   ...
   // height + 5.
   GetStringFromAttribute( szDIL_Flag,
                           vDefaults, "InitValues", "DIL_MessageFlag" );
   if ( szDIL_Flag[ 0 ] == 'Y' )
   {
      // Determine PosY.
      lMaxY = 0;
