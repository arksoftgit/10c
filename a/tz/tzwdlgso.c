                       ...
                       zVIEW     vSubtask )
{
   ...
   { 
      ...
      GetStringFromAttribute( szTempString_1, vNewW, "LOD", "Name" );
      ...
      { 
         ...
         GetStringFromAttribute( szTempString_1, vOrigW, "ActMapLOD_Entity", "Name" );
                        ...
                        zVIEW     vSubtask )
{
   ...
   { 
      ...
      { 
         ...
         GetStringFromAttribute( szTempString_1, vOrigWC, "EventAct", "Tag" );
                        ...
                        zVIEW     vSubtask )
{
   ...
   { 
      ...
      GetStringFromAttribute( szTempString_1, vOrigWC, "CtrlMapLOD_Entity", "Name" );
      RESULT = SetCursorFirstEntityByString( vLOD, "LOD_Entity", "Name", szTempString_1, "" );
      //:IF RESULT >= 0
      if ( RESULT >= 0 )
      { 
   ...
   { 
      ...
      GetStringFromAttribute( szTempString_2, vOrigWC, "CtrlMapRelatedEntity", "Name" );
                       ...
                       zVIEW     vSubtask )
{
   ...
   { 
      ...
      GetStringFromAttribute( szTempString_1, vOrigWO, "OptMapRelatedEntity", "Name" );
      RESULT = SetCursorFirstEntityByString( vLOD, "LOD_Entity", "Name", szTempString_1, "" );
      //:IF RESULT >= 0
      if ( RESULT >= 0 )
      { 
