   ...
   { 
      ...
      { 
         ...
         { 
            ...
            //:                         szEntityName,
            //:                         szAttributeName )
            GetStringFromAttribute( MaxString, vQueryObject, szEntityName, szAttributeName );
            //:LOOP WHILE nRC >= zCURSOR_SET
            while ( nRC >= zCURSOR_SET )
            { 
               //:nRC = SetCursorNextEntity( vQueryObject,
               ...
               { 
                  ...
                  //:                         szEntityName,
                  //:                         szAttributeName )
                  GetStringFromAttribute( AttributeValueString, vQueryObject, szEntityName, szAttributeName );
      ...
      { 
         ...
         { 
            ...
            { 
               ...
               //:                     szEntityName,
               //:                     szAttributeName )
               GetStringFromAttribute( MinString, vQueryObject, szEntityName, szAttributeName );
               //:LOOP WHILE nRC >= zCURSOR_SET
               while ( nRC >= zCURSOR_SET )
               { 
                  //:nRC = SetCursorNextEntity( vQueryObject,
