...
// zLONG    lTempInteger_2;
   ...
   nZRetCode = GetStringFromAttribute( szLOD_Name, vTZZOLOD1, "LOD", "Name" );
   ...
   if ( lTempInteger_0 == 0 )
   {
      ...
      if ( RESULT <  zCURSOR_SET )
      {
         ...
         nZRetCode = GetStringFromAttribute( szTempString_0, vTZZOLOD1, "LOD_EntityParent", "Name" );
         ...
         nRC = MessagePrompt( vTZZOLOD1, "ZO00201",
                             "Operations",
                             szMsg,
   ...
   while ( RESULT > zCURSOR_UNCHANGED )
   {
      ...
      if ( CompareAttributeToString( vTZZOLOD1, "LOD_AttributeRec", "Work", "Y" ) != 0 )
      {
         ...
         if ( RESULT <  zCURSOR_SET )
         {
            ...
            nZRetCode = GetStringFromAttribute( szTempString_1, vTZZOLOD1, "ER_AttributeRec", "Name" );
            ...
            nRC = MessagePrompt( vTZZOLOD1, "ZO00203",
                                 "Operations",
                                 szMsg,
                                 zBEEP, zBUTTONS_YESNO,
                                 zRESPONSE_YES,  0 );
   ...
   while ( RESULT > zCURSOR_UNCHANGED )
   {
      ...
      if ( lTempInteger_0 == 0 )
      {
         ...
         if ( RESULT < zCURSOR_SET )
         {
            ...
            ZeidonStringConcat( szMsg, 1, 0, "Bypass LOD Entity[ NO ] \n", 1, 0, 300 );
            ZeidonStringConcat( szMsg, 1, 0, "Cancel LOD Refresh[ CANCEL ] ", 1, 0, 300 );
            nRC = MessagePrompt( vTZZOLOD1, "ZO00204",
                                 "Operations",
                                 szMsg,
                                 zBEEP, zBUTTONS_YESNO,
                                 zRESPONSE_YES,  0 );
            if ( nRC == zRESPONSE_YES )
            {
               ...
               ZeidonStringConcat( szMsg, 1, 0, "Make LOD Entity Work[ NO ] ", 1, 0, 300 );
               nRC = MessagePrompt( vTZZOLOD1, "ZO00205",
                                    "Operations",
                                    szMsg,
                                    zBEEP, zBUTTONS_YESNO,
                                    zRESPONSE_YES,  0 );
      ...
      if ( lTempInteger_2 == 0 )
      {
         ...
         if ( RESULT < zCURSOR_SET )
         {
            ...
            nZRetCode = GetStringFromAttribute( szTempString_0, vTZZOLOD2, "LOD_EntityParent", "Name" );
            ZeidonStringConcat( szMsg, 1, 0, szTempString_0, 1, 0, 300 );
            ZeidonStringConcat( szMsg, 1, 0, " \n", 1, 0, 300 );
            ZeidonStringConcat( szMsg, 1, 0, "Relationship:  ", 1, 0, 300 );
            nZRetCode = GetStringFromAttribute( szTempString_1, vTZZOLOD1, "ER_RelLinkRec", "Name" );
            ZeidonStringConcat( szMsg, 1, 0, szTempString_1, 1, 0, 300 );
            ZeidonStringConcat( szMsg, 1, 0, " \n", 1, 0, 300 );
            ZeidonStringConcat( szMsg, 1, 0, "Child Entity:  ", 1, 0, 300 );
            nZRetCode = GetStringFromAttribute( szTempString_2, vTZZOLOD1, "LOD_EntityParent", "Name" );
            ZeidonStringConcat( szMsg, 1, 0, szTempString_2, 1, 0, 300 );
            ZeidonStringConcat( szMsg, 1, 0, " \n\n", 1, 0, 300 );
            ZeidonStringConcat( szMsg, 1, 0, "Make LOD Entity Derived[ YES ] \n", 1, 0, 300 );
            ZeidonStringConcat( szMsg, 1, 0, "Bypass LOD Entity[ NO ] \n", 1, 0, 300 );
            ZeidonStringConcat( szMsg, 1, 0, "Cancel LOD Refresh[ CANCEL ] ", 1, 0, 300 );
            nRC = MessagePrompt( vTZZOLOD1, "ZO00206",
                                 "Operations",
                                 szMsg,
                                 zBEEP, zBUTTONS_YESNOCANCEL,
                                 zRESPONSE_YES,  0 );
...
oTZZOLODO_SaveAllLODs( zVIEW vSubtask, zPCHAR szType )
{
         ...
         nRC = SetCursorNextEntity( vTZZOLODO_LIST, "W_MetaDef", "" ) )
   {
      ...
      if ( nRC < 1 )
      {
         zstrcpy( szMsg, "(oTZZOLODO_SaveAllLODs) Unable to Access XOD.  XOD build error." );
         zstrcat( szMsg, szLOD_Name );
...
//  Position on LOD for LOD Entity Add
   ...
   {
      nRC = SetCursorNextEntityHierarchical( &lLevel, szEntityName, vTZZOLOD1 );
   ...
   {
      nRC = SetAttributeFromAttribute( vTZZOLOD1, "LOD_EntityChild", "Name",
                                        vTZEREMDO, "ER_Entity_Other", "Name" );
      nRC = SetAttributeFromAttribute( vTZZOLOD1, "LOD_EntityChild", "Desc",
...
//    else
//    {
//       nRC = SetAttributeFromString( vTZZOLOD1, "LOD_EntityChild", "Name",
//                                      "New" );
//    }
   }
...
//  Set the IndentLvl and IndentName
   nRC = GetStringFromAttribute( szEntityName,
                                  vTZZOLODO, "LOD_EntityChild", "Name" );
   lIndentLvl = (lLevel - 1) * 3;
   nRC = SetAttributeFromInteger( vTZZOLOD1, "LOD_EntityChild", "IndentLvl",
                                  lIndentLvl );
   lCount = 0;
   while ( lIndentLvl > lCount )
   {
      zstrcpy( &szEntityNameIndent[ lCount ], " " );
      lCount++;
   }
   zstrcpy( &szEntityNameIndent[ lIndentLvl ], szEntityName );
   nRC = SetAttributeFromString( vTZZOLOD1, "LOD_EntityChild", "IndentName",
                                 szEntityNameIndent );
...
//  Build ER_Entity for Relationship or ER Entity Add Type
   if ( zstrcmp( szWorkType, "E" ) == 0 )
      nRC = IncludeSubobjectFromSubobject( vTZZOLOD1, "ER_EntityRec",
                                            vTZEREMDO, "ER_Entity",
                                            zPOS_AFTER );
...
//  Build ER_Entity for Relationship Add Type
   ...
   {
      nRC = IncludeSubobjectFromSubobject( vTZZOLOD1, "ER_EntityRec",
                                            vTZEREMDO, "ER_Entity_Other",
                                            zPOS_AFTER );
      nRC = IncludeSubobjectFromSubobject( vTZZOLOD1, "ER_RelLinkRec",
...
//  Build Attributes for Relationship or ER Entity Add Type
      ...
      ( zstrcmp( szWorkType, "E" ) == 0 ))
   {
      if ( zstrcmp( szWorkType, "R" ) == 0 )
      {
         nRC = GetIntegerFromAttribute( &lZKey, vTZEREMDO, "ER_Entity_Other", "ZKey" );
      }
      else
      {
         nRC = GetIntegerFromAttribute( &lZKey, vTZEREMDO, "ER_Entity", "ZKey" );
      }

      CreateViewFromViewForTask( &vTZEREMDO2, vTZEREMDO, 0 );
      nRC = SetCursorFirstEntityByInteger( vTZEREMDO2, "ER_Entity",
                                           "ZKey", lZKey,
                                           "" );
                             ...
                             zPCHAR  szLOD_Name)
{
         ...
         nRC = SetCursorNextEntity( vLOD, "LOD_EntityParent", "" ) )
   {
           ...
           CompareAttributeToString( vERD, "ER_Entity", "Purpose", "W" ) != 0 )
      {
         ...
         GetStringFromAttribute( szParentLOD_Name, vLOD, "LOD_EntityParent", "Name" );
               ...
               nRC = SetCursorNextEntity( vERD, "ER_RelLink", "" ) )
         {
...

            {
               ...
               {
                   zstrcpy( szMsg, "A creatable LOD Entity is missing a child (includable or creatable) ");
                   zstrcat( szMsg, " for a related ERD Entity with min cardinality > 0.\n\n" );
                   zstrcat( szMsg, "LOD: \t \t \t" );

                   zstrcat( szMsg, szLOD_Name );
                   zstrcat( szMsg, "\n \nCreateable LOD Entity: \t" );
                   zstrcat( szMsg, szParentLOD_Name );
                   zstrcat( szMsg, "\nrelationship with card > 0: \t" );
                   GetStringFromAttribute( szRelLinkName, vERD, "ER_RelLink", "Name" );
                   zstrcat( szMsg, szRelLinkName );
                   GetStringFromAttribute( szChildLOD_Name, vERD, "ER_Entity_Other", "Name" );
                   zstrcat( szMsg, "\nMissing related ERD Entity: \t" );
                   zstrcat( szMsg, szChildLOD_Name );
...
//   zCHAR  szTempName[ 33 ];
         ...
         nRC = SetCursorNextEntity( vLOD, "LOD_EntityParent", "" ) )
   {
           ...
           CompareAttributeToString( vERD, "ER_Entity", "Purpose", "W" ) != 0 )
      {
         ...
         GetStringFromAttribute( szEntityName, vLOD, "LOD_EntityParent", "Name" );
              ...
              *** Deleted following code 19.01.1998 because it isn't really
                  ...
                  Identifier.
                        ...
                        else
                        {
                           ...
                           zstrcpy( szMsg, "The following attribute has a SeqPriority value but is " );
                           zstrcat( szMsg, "not an identifier nor a part of an entity with multiple " );
                           zstrcat( szMsg, "occurrences under its parent.  The SeqPriority value is ignored.\n" );
                           zstrcat( szMsg, "\n\nEntity: \t" );
                           GetStringFromAttribute( szTempName,
                                                   vLOD, "LOD_EntityParent", "Name" );
                           zstrcat( szMsg, szTempName );
                           zstrcat( szMsg, "\n\nAttribute: \t" );
                           GetStringFromAttribute( szTempName,
                                                   vLOD, "ER_AttributeRec", "Name" );
                           zstrcat( szMsg, szTempName );
         ...
         zstrcpy( szAttribList, "" );
         nMissingNr = 0;

         // Create a formatted String with the SeuqencePriorities and the AttributeNames:
         for (i=1; i <= lMaxPriority; i++ )
         {
            zltoa( i, szAktPriority );
            zstrcat( szAttribList, szAktPriority );
            zstrcat( szAttribList, " \t" );

            if ( pchAttribList[ i ] != 0 )
               zstrcat( szAttribList, pchAttribList[ i ] );
            else
            {
               zstrcat( szAttribList, "*** missing ***" );
               nMissingNr = i;
            }
            zstrcat( szAttribList, " \n" );
         }
         ...
         if ( nMissingNr != 0 &&
              ( CompareAttributeToInteger( vLOD, "LOD_EntityParent", "IndentLvl",
                ...
                CompareAttributeToString( vLOD, "ER_RelLinkRec", "CardMax",
                                          "1" ) != 0 ) )
         {
            zstrcpy( szMsg, "The SequencePriority chain is broken. " );
            ...
            zltoa( nMissingNr, szAktPriority );
            zstrcat( szMsg, szAktPriority );
                             ...
                             zSHORT  nState )
{
   ...
   switch( nEvent )
   {
      ...
      case zECE_ACCEPT:
         ...
         {
            GetStringFromAttribute( szOperName, vIn, "Operation", "Name" );
                          ...
                          zSHORT GetOrSetFlag )
{
   ...
   GetStringFromAttribute( szType, LODView, "SourceFileForDARec", "Extension" );
   if ( szType[ 0 ] == 'V' )
   {
      szTempName1[ 0 ] = 'o';
      CreateViewFromViewForTask( &vTemp, LODView, 0 );
      ResetView( vTemp );
      GetStringFromAttribute( szTempName1 + 1, vTemp, "LOD", "Name" );
      DropView( vTemp );
      zstrcat( szTempName1, "_" );
      GetStringFromAttribute( szTempName2, LODView,
                              "LOD_AttrDerivationOperRec", "Name" );
      zstrcat( szTempName1, szTempName2 );
   }
   else
   {
      GetStringFromAttribute( szTempName1, LODView,
                              "LOD_AttrDerivationOperRec", "Name" );
   }

   StoreValueInRecord( LODView, EntityStructure, AttributeStructure,
                       szTempName1, 0 );
                         ...
                         zSHORT GetOrSetFlag )
{
   ...
   GetStringFromAttribute( szType, LODView,
                           "SourceFileForOCOper", "Extension" );
   if ( szType[ 0 ] == 'V' )
   {
      szTempName1[ 0 ] = 'o';
      CreateViewFromViewForTask( &vTemp, LODView, 0 );
                          ...
                          zSHORT GetOrSetFlag )
{
   ...
   GetStringFromAttribute( szType,
                           LODView,
                           "SourceFileForECOperRec",
                           "Extension" );
   if ( szType[ 0 ] == 'V' )
   {
      szTempName1[ 0 ] = 'o';
      ...
      DropView( vTemp );
      zstrcat( szTempName1, "_" );
      GetStringFromAttribute( szTempName2,
                              LODView,
                              "LOD_EntityConstraintOperRec",
                              "Name" );
      zstrcat( szTempName1, szTempName2 );
   }
   else
      GetStringFromAttribute( szTempName1,
                              LODView,
                              "LOD_EntityConstraintOperRec",
                              "Name" );


   StoreValueInRecord( LODView, EntityStructure,
                       AttributeStructure, szTempName1, 0 );
...
ofnTZZOLODO_DeleteOldPOD_Entities( zVIEW vTZZOLODO, zVIEW vTZTENVRO )
{
   ...
   for ( nRC = SetCursorFirstEntity( vTZZOLODO, "POD_Entity", "" );
         ...
         nRC = SetCursorNextEntity( vTZZOLODO, "POD_Entity", "" ) )
   {
      GetIntegerFromAttribute( &ulZKey, vTZZOLODO, "TE_DBMS_SourceForEntity",
                               "ZKey" );
      if ( SetCursorFirstEntityByInteger( vTZTENVRO, "TE_DBMS_Source",
                                          "ZKey", ulZKey, "" ) < zCURSOR_SET )
      {
         DeleteEntity( vTZZOLODO, "POD_Entity", zREPOS_NONE );
      }
   }
                     ...
                     zPCHAR         pchContextName )
{
   ...
   *pchContextName = 0;
   ...
   if ( *pchExpr == '.' )
   {
      zstrcpy( pchEntityName, pchToken );
   ...
   if ( *pchEntityName == 0 )
      zstrcpy( pchEntityName, pchDefaultEntityName );
...
// zPCHAR pchName;
   ...
   GetStringFromAttribute( szSourceDirectory,
                           vTaskLPLR,
                           "LPLR",
                           "PgmSrcDir" );

   // Create a unique temp VML name using the task ID.
   zsprintf( szVML, "zDE%lx",
             SysGetTaskFromView( GetDefaultViewForActiveTask( ) ) );
          // SysGetTaskFromView( vTZZOLODO ) );
   zsprintf( szFileName, "%s\\%s.VML", szSourceDirectory, szVML );
   zsprintf( szErrFileName, "%s\\%s.ERR", szSourceDirectory, szVML );
   ...
   switch ( *pchType )
   {
      ...
      default:
         ...
         zsprintf( szLine, "   STRING( %ld ) value", lLth );
         SysWriteLine( vTZZOLODO, f, szLine );
         break;
   }

   zstrcpy( szLine, "   value = " );
   ...
   {
      // If the zCHAR is a symbol more complex than + or - then we need to use
      // the VML.
      if ( strchr( "/*().", *pch ) > 0 )
         bUseXPG = TRUE;
   }
   ...
   for ( idx = zstrlen( szLine ); *pchExpr; )
   {
      ...
      if ( *pchExpr == '@' )
      {
         ...
         {
            case zTYPE_INTEGER:
               zsprintf( &szLine[ idx ], "zi%s( vView, ", szFuncName );
               break;

            case zTYPE_DECIMAL:
               zsprintf( &szLine[ idx ], "zd%s( vView, ", szFuncName );
               break;
         }
         ...
         if ( *pchExpr != '(' )
         {
            ...
            zsprintf( szMsg, "Error parsing derived VML for '%s.%s'. "
      ...
      if ( !isalpha( *pchExpr ) )
      {
         ...
         if ( *pch == ')' && nExpectedToken == TOKEN_CMD )
         {
            ...
            // If only 2 arguments where specified, then we need to add the
            // default scoping entity.
            if ( nArgCount == 2 )
            {
               zstrcat( szLine, ", 0 " );
               idx += zstrlen( &szLine[ idx ] );
      ...
      // The simple interpreter can't handle entity names.  If one was specified
      // then use the XPG.
      ...
      // function name.
      if ( *pch == '(' )
         zstrcpy( &szLine[ idx ], szAttribName );
      else
      if ( nExpectedToken == TOKEN_CMD )
      {
         // Add the argument to the CMD.
         zsprintf( &szLine[ idx ], " \"%s\"", szAttribName );
         nArgCount++;
      }
      else
         zsprintf( &szLine[ idx ], "vView.%s.%s", szEntityName, szAttribName );
   ...
   if ( !bUseXPG )
   {
      ...
      SetAttributeFromBlob( vTZZOLODO, "ER_Attribute",
   ...
   if ( pfnParser != 0 )
      lRC = (*pfnParser) ( vSubtask, vTZZOLODO, zPARSE_ACTION_FULL,
                           zPARSE_LIMIT_SOURCE,
                           zPARSE_SOURCE_FILE, szVML, "",
                           zREFER_LOD_META, zPARSE_DONOTWRITEXPG );

   GetViewByName( &vXPG, "XPG", vSubtask, zLEVEL_TASK );
   if ( lRC >= 0 )
   {
      SetBlobFromOI( vTZZOLODO, "ER_Attribute", "DerivedExpressionXPG",
                     vXPG, zCOMPRESSED );
      nReturn = 0;
   }
   else
