                                  ...
                                  zVIEW   X_Checker )
{
   ...
   {
      GetStringFromAttribute( szName, X_Checker, "Dialog", "Name" );
   ...
   {
      GetStringFromAttribute( szName, DialogMeta, "W_MetaDef", "Name" );
...
zwTZVSXCAD_InitializeDialog( zVIEW    vSubtask )
{
   ...
   nRC = GetStringFromAttribute( szExecDir, CM_List, "LPLR", "ExecDir" );
                               ...
                               zSHORT nAskForSave )
{
        ...
        CompareAttributeToInteger( vCurrentMeta, "W_MetaType", "SortOrder", 1 ) == 0 )
   {
      ...
      if ( nRC == zRESPONSE_YES )
      {
         ...
         GetStringFromAttribute( szExecDir, vDialogMeta_Original, "LPLR", "ExecDir" );
         GetStringFromAttribute( szLPLR_Name, vDialogMeta_Original, "LPLR", "Name" );
         zstrcat( szExecDir, "\\" );
         zstrcat( szExecDir, szLPLR_Name );
         zstrcat( szExecDir, ".XLP" );
...
zwTZVSXCAD_IncludeDialog( zVIEW    vSubtask )
{
   ...
   while ( nRC >= 0)
   {
      GetStringFromAttribute( szTempString_0, vDialogList, "W_MetaDef", "Name" );
...
zwTZVSXCAD_IncludeLOD( zVIEW    vSubtask )
{
   ...
   GetStringFromAttribute( szTempString_0, LODMeta, "W_MetaDef", "Name" );
...
zwTZVSXCAD_IncludeGlobal( zVIEW    vSubtask )
{
   ...
   GetStringFromAttribute( szTempString_0, GlobalMeta, "W_MetaDef", "Name" );
...
zwTZVSXCAD_SetupDLL( zVIEW    vSubtask )
{
   ...
   GetStringFromAttribute( szDialogName, CM_List, "W_MetaDef", "Name" );
   ...
   GetStringFromAttribute( szAppName, LPLR, "LPLR", "Name" );
   GetStringFromAttribute( szDialogName, CM_List, "W_MetaDef", "Name" );
...
zwTZVSXCAD_SetDescriptionInDIL( zVIEW vSubtask )
{
   ...
   {
      GetStringFromAttribute( szDescription, vCM_ShowDialog, "W_MetaDef", "Desc" );
