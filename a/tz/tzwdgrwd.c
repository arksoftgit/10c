...
zwTZWDGRWD_PositionWD( zVIEW vSubtask )
{
   ...
   if ( nRC < 1 )
   {
      zstrcpy( sz, "Unable to Access WD Model.  Model must be opened." );
   ...
   while ( nRC >= zCURSOR_SET )
   {
      ...
      GetStringFromAttribute( sz, vGRW, "ER_Entity", "OwningArea" );
      if ( sz[ 0 ] == 0 )
      {
...
//
   ...
   //  Process all entites in Cluster
            ...
            nRC = SetCursorNextEntity( vTZERPOSO, "W_ERD_Entity", "" ) )
      {
         ...
         {
            // get position
            GetIntegerFromAttribute( &lXcell,
                                     vTZERPOSO, "W_ERD_Entity", "ER_DgmPosX" );
            GetIntegerFromAttribute( &lYcell,
                                     vTZERPOSO, "W_ERD_Entity", "ER_DgmPosY" );
         }
         else
         {
            // find free cell
            nD = nXincr = nYincr = 0;
            if ( zwfnTZWDGRWD_FreeCell( &nXchk, &nYchk,
            ...
            // set position
            SetAttributeFromInteger( vTZERPOSO, "W_ERD_Entity", "ER_DgmPosX",
                                    lXcell );
            SetAttributeFromInteger( vTZERPOSO, "W_ERD_Entity", "ER_DgmPosY",
                                    lYcell );
         }
...
//
         ...
         nRC = SetCursorNextEntity( vTZERPOSO, "W_ERD_Entity", "RootStats" ) )
   {
      ...
      SetCursorFirstEntityByInteger( vGRW, "ER_Entity",
                                    "ZKey", lZKey, "" );
      SetAttributeFromInteger( vGRW, "ER_Entity", "ER_DiagramPosX",
                             (lXcell * 30) + nStaggerX - 15 );
      SetAttributeFromInteger( vGRW, "ER_Entity", "ER_DiagramPosY",
...
zwTZWDGRWD_WD_HideShowActions( zVIEW vSubtask )
{
   ...
   for ( nRC = SetCursorFirstEntityByString( vGRW, "ER_Entity",
                                             "Purpose", "W", "" );
         nRC >= zCURSOR_SET;
         nRC = SetCursorNextEntityByString( vGRW, "ER_Entity",
                                             "Purpose", "W", "" ) )
   {
...
zCHAR  szArcType[ 2 ];
                                             ...
                                             "Type", "A", "" ) )
   {
      ...
      nRC = SetCursorFirstEntityByString( vGRW, "ER_RelType_1",
                    "Type", "G", "ER_Entity" );
      if ( nRC >= zCURSOR_SET )
      {
         ...
         {
            GetStringFromAttribute( szArcType, vGRW, "ER_RelType_1", "Type" );
            if ( szArcType[ 0 ] == 'G' )
            {
               GetIntegerFromAttribute( &lZKey, vGRW, "ER_RelType_1", "ZKey" );
               SetCursorFirstEntityByInteger( vGRW, "ER_RelType",
                                              "ZKey", lZKey, "" );
               if ( bHide )
               {
                                 ...
                                 zVIEW vGRW )
{
   ...
   //  Process WD Entities, setting any 0 positions
                                   ...
                                   0, 0, 0, 0, 0, 0 ) )
      {
         ...
         zwfnTZWDGRWD_FreePosEDM( &lXgrid, &lYgrid, lXgrid, lYgrid,
                                 MAX_CELL_Y, vSubtask );
         SetAttributeFromInteger(
                     vGRW, "ER_Entity", "ER_DiagramPosX", lXgrid );
         SetAttributeFromInteger(
                     vGRW, "ER_Entity", "ER_DiagramPosY", lYgrid );
...
// zCHAR sz[ 256 ];
   ...
   {
//    GetStringFromAttribute( &sz[ 0 ],
//                            vGRW1, "ER_Entity", "Name" ); //debug only
      nEnts++;
      GetIntegerFromAttribute( &lXgrid,
                               vGRW1, "ER_Entity", "ER_DiagramPosX" );
      if ( lXgrid != 0 )
      {
         GetIntegerFromAttribute( &lYgrid,
                                 vGRW1, "ER_Entity", "ER_DiagramPosY" );
         zwfnTZWDGRWD_MarkCellEDM( lXgrid, lYgrid );
      }
   }  // End for each ER_Entity
                               ...
                               zVIEW   vGRW )
{
         ...
         nRC = SetCursorNextEntity( vGRW1, "ER_RelLink", "" ) )
   {
      ...
      GetStringFromAttribute( &sz[50],
                              vGRW1, "ER_Entity_Other", "Name" ); //debug only
      if ( SetCursorFirstEntityByEntityCsr( vGRW2, "ER_Entity",
                                            vGRW1, "ER_Entity_Other",
                                            "" ) >= zCURSOR_SET )
      {
         nRels++;
         GetIntegerFromAttribute( &lXgrid,
                                 vGRW2, "ER_Entity", "ER_DiagramPosX" );
         GetIntegerFromAttribute( &lYgrid,
                                 vGRW2, "ER_Entity", "ER_DiagramPosY" );
         nX +=(zSHORT)lXgrid;
         nY +=(zSHORT)lYgrid;
      }
...
// {
      ...
      {  // refresh the entity and each relationship
               ...
               nRC = SetCursorNextEntity( vGRW, "ER_RelLink", "" ) )
         {
            ...
            SetCursorFirstEntityByEntityCsr( vGRW, "ER_RelType",
                                             vGRW, "ER_RelType_1", "" );
