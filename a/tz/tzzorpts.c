                         ...
                         zPCHAR szReportFileName )
{
   ...
   nZRetCode = GetStringFromAttribute ( szData, vLOD, "LOD", "Name" );
   zstrblank( szData, 15, 1 );
   ZeidonStringConcat( Line, 1, 0, szData, 1, 0, 511 );
   ZeidonStringConcat( Line, 1, 0, "ZKey: ", 1, 0, 511 );
   nZRetCode = GetStringFromAttribute ( szData, vLOD, "LOD", "ZKey" );
   zstrblank( szData, 14, 1 );
   ZeidonStringConcat( Line, 1, 0, szData, 1, 0, 511 );
   ZeidonStringConcat( Line, 1, 0, "Desc: ", 1, 0, 511 );
   nZRetCode = GetStringFromAttribute ( szTempString_0, vLOD, "LOD", "Desc" );
   ...
   nZRetCode = GetStringFromAttribute ( szData, vLOD, "LOD", "DLL_Name" );
   zstrblank( szData, 15, 1 );
   ZeidonStringConcat( Line, 1, 0, szData, 1, 0, 511 );
   ZeidonStringConcat( Line, 1, 0, "Rules: Activate=", 1, 0, 511 );
   nZRetCode = GetStringFromAttribute ( szTempString_1, vLOD, "LOD", "ActivateConstraint" );
   ZeidonStringConcat( Line, 1, 0, szTempString_1, 1, 0, 511 );
   ZeidonStringConcat( Line, 1, 0, "  ActivateEmpty=", 1, 0, 511 );
   nZRetCode = GetStringFromAttribute ( szTempString_2, vLOD, "LOD", "ActivateEmptyConstraint" );
   ZeidonStringConcat( Line, 1, 0, szTempString_2, 1, 0, 511 );
   ZeidonStringConcat( Line, 1, 0, "  Commit=", 1, 0, 511 );
   nZRetCode = GetStringFromAttribute ( szTempString_3, vLOD, "LOD", "CommitConstraint" );
   ZeidonStringConcat( Line, 1, 0, szTempString_3, 1, 0, 511 );
   ZeidonStringConcat( Line, 1, 0, "  DropOI=", 1, 0, 511 );
   nZRetCode = GetStringFromAttribute ( szTempString_4, vLOD, "LOD", "DropOIConstraint" );
   ...
   {
      nZRetCode = GetStringFromAttribute ( Line, vLOD, "LOD_Entity", "IndentName" );
      nZRetCode = SysWriteLine( vLOD_In,  lRptFile, Line );
   ...
   {
      nZRetCode = SysWriteLine( vLOD_In,  lRptFile, "" );
      nZRetCode = GetStringFromAttribute ( Line, vLOD, "LOD_Entity", "Name" );
      zstrblank( Line, 36, 1 );
      ...
      if ( lTempInteger_0 == 0 )
      {
         ...
         {
            nZRetCode = GetStringFromAttribute ( szTempString_5, vLOD, "ER_Entity", "Name" );
            ZeidonStringConcat( Line, 1, 0, szTempString_5, 1, 0, 511 );
         }
         ZeidonStringConcat( Line, 1, 0, "[", 1, 0, 511 );
         nZRetCode = GetStringFromAttribute ( szData, vLOD, "ER_Entity", "ZKey" );
         ZeidonStringConcat( Line, 1, 0, szData, 1, 0, 511 );
         ZeidonStringConcat( Line, 1, 0, "]", 1, 0, 511 );
      }
      ...
      if ( lTempInteger_1 == 0 )
      {
         ...
         nZRetCode = GetStringFromAttribute ( szData, vLOD, "ER_RelLink", "ZKey" );
         ZeidonStringConcat( Line, 1, 0, szData, 1, 0, 511 );
         ZeidonStringConcat( Line, 1, 0, "]", 1, 0, 511 );
      }
      nZRetCode = SysWriteLine( vLOD_In,  lRptFile, Line );
      ...
      nZRetCode = GetStringFromAttribute ( szData, vLOD, "LOD_Entity", "Create" );
      zstrblank( szData, 5, 1 );
      ZeidonStringConcat( Line, 1, 0, szData, 1, 0, 511 );
      nZRetCode = GetStringFromAttribute ( szData, vLOD, "LOD_Entity", "Delete" );
      zstrblank( szData, 5, 1 );
      ZeidonStringConcat( Line, 1, 0, szData, 1, 0, 511 );
      nZRetCode = GetStringFromAttribute ( szData, vLOD, "LOD_Entity", "Update" );
      zstrblank( szData, 5, 1 );
      ZeidonStringConcat( Line, 1, 0, szData, 1, 0, 511 );
      nZRetCode = GetStringFromAttribute ( szData, vLOD, "LOD_Entity", "Include" );
      zstrblank( szData, 5, 1 );
      ZeidonStringConcat( Line, 1, 0, szData, 1, 0, 511 );
      nZRetCode = GetStringFromAttribute ( szData, vLOD, "LOD_Entity", "InclSrc" );
      zstrblank( szData, 5, 1 );
      ZeidonStringConcat( Line, 1, 0, szData, 1, 0, 511 );
      nZRetCode = GetStringFromAttribute ( szData, vLOD, "LOD_Entity", "Exclude" );
      zstrblank( szData, 5, 1 );
      ZeidonStringConcat( Line, 1, 0, szData, 1, 0, 511 );
      nZRetCode = GetStringFromAttribute ( szData, vLOD, "LOD_Entity", "Hidden" );
      zstrblank( szData, 5, 1 );
      ZeidonStringConcat( Line, 1, 0, szData, 1, 0, 511 );
      nZRetCode = GetStringFromAttribute ( szData, vLOD, "LOD_Entity", "Recursive" );
      zstrblank( szData, 9, 1 );
      ZeidonStringConcat( Line, 1, 0, szData, 1, 0, 511 );
      nZRetCode = GetStringFromAttribute ( szData, vLOD, "LOD_Entity", "AutoCreate" );
      zstrblank( szData, 5, 1 );
      ZeidonStringConcat( Line, 1, 0, szData, 1, 0, 511 );
      nZRetCode = GetStringFromAttribute ( szData, vLOD, "LOD_Entity", "Derived" );
      zstrblank( szData, 7, 1 );
      ZeidonStringConcat( Line, 1, 0, szData, 1, 0, 511 );
      nZRetCode = GetStringFromAttribute ( szData, vLOD, "LOD_Entity", "SeqType" );
      zstrblank( szData, 8, 1 );
      ZeidonStringConcat( Line, 1, 0, szData, 1, 0, 511 );
      nZRetCode = GetStringFromAttribute ( szData, vLOD, "LOD_Entity", "Work" );
      zstrblank( szData, 6, 1 );
      ZeidonStringConcat( Line, 1, 0, szData, 1, 0, 511 );
      nZRetCode = GetStringFromAttribute ( szData, vLOD, "LOD_Entity", "ParentDeleteBehave" );
      ZeidonStringConcat( Line, 1, 0, szData, 1, 0, 511 );
      nZRetCode = SysWriteLine( vLOD_In,  lRptFile, Line );
      ...
      while ( RESULT > zCURSOR_UNCHANGED )
      {
         ...
         {
            nZRetCode = GetStringFromAttribute( szTempString_6, vLOD, "ER_Attribute", "Name" );
            ZeidonStringCopy( Line, 1, 0, "...", 1, 0, 511 );
            ZeidonStringConcat( Line, 1, 0, szTempString_6, 1, 0, 511 );
         }
         else
         {
            nZRetCode = GetStringFromAttribute ( szTempString_7, vLOD, "ER_Attribute", "Name" );
         ...
         {
            ZeidonStringConcat( Line, 1, 0, "[", 1, 0, 511 );
            nZRetCode = GetStringFromAttribute( szData, vLOD, "ER_Attribute", "ZKey" );
         ...
         nZRetCode = GetStringFromAttribute ( szData, vLOD, "Domain", "DerivedDataType" );
         ZeidonStringConcat( Line, 1, 0, szData, 1, 0, 511 );
         ZeidonStringConcat( Line, 1, 0, "  Lth=", 1, 0, 511 );
         nZRetCode = GetStringFromAttribute ( szData, vLOD, "ER_Attribute", "Lth" );
         zstrblank( szData, 5, 1 );
         ZeidonStringConcat( Line, 1, 0, szData, 1, 0, 511 );
         nZRetCode = GetStringFromAttribute ( szTempString_8, vLOD, "Domain", "DerivedName" );
