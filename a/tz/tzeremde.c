...
zwTZEREMDD_PositionER( zVIEW vSubtask )
{
   ...
   if ( vTZERPOSO == 0 )
   {
      zstrcpy( sz, "Unable to create TZERPOSO work OI." );
   ...
   while ( nRC >= zCURSOR_SET )
   {
      ...
      GetStringFromAttribute( sz, vTZEREMDO, "ER_Entity", "OwningArea" );
      if ( sz[ 0 ] == 0 )
      {
         ...
         nRC = SetCursorNextEntity( vTZERPOSO, "Cluster", "" ) )
   {
      GetStringFromAttribute( &sz[ 0 ],
                              vTZERPOSO, "Cluster", "Name" ); //debug only
      zgSortEntityWithinParent( zDESCENDING, vTZERPOSO, "W_ERD_Entity",
                                "NbrRelEntsInSameOA", "" );
      // Set Cell size
      ...
      if ( nPrevYmax != 0 )
         if ( zmemcmp( &cCellUsage[ nXmax + 1 - nCells ][ nPrevYmax + 1 ],
                        cCellUsage[ 0 ], nCells ) == 0 )
            nY = nPrevYmax + 1;
      ...
      for ( nX = 1; nX <= MAX_CELL_X; nX++ )
      {
         if ( nX >= MAX_CELL_X )
         {
            ...
            if ( nY >= MAX_CELL_Y )
            {
               zstrcpy( sz, "No space available for Area:\n\t'" );
         ...
         {
            if ( zmemcmp( &cCellUsage[ nXchk ][ nY ], cCellUsage[ 0 ],
                          nCells ) == 0 )
            {
         ...
         nRC = SetCursorNextEntity( vTZERPOSO, "Cluster", "" ) )
   {
      ...
      {
         for ( nRC = SetCursorFirstEntity( vTZERPOSO,
                                           "W_ERD_RelatedEntity", "" );
               nRC >= zCURSOR_SET;
               nRC = SetCursorNextEntity( vTZERPOSO,
                                          "W_ERD_RelatedEntity", "" ) )
         {
            if ( CompareAttributeToAttribute(
                  vTZERPOSO, "W_ERD_Entity", "OwningArea",
                  vTZERPOSO, "W_ERD_RelatedEntity", "OwningArea" ) == 0 )
            {
               SetAttributeFromString( vTZERPOSO, "W_ERD_RelatedEntity",
                                       "OA_MatchesParentsOA", "Y" );
            }
            ...
            SetCursorFirstEntityByEntityCsr( vTZERPOS1, "W_ERD_Entity",
                                             vTZERPOSO, "W_ERD_RelatedEntity", "" );
            for ( nRC = SetCursorFirstEntity( vTZERPOS1,
                                              "W_ERD_RelatedEntity", "" );
                  nRC >= zCURSOR_SET;
                  nRC = SetCursorNextEntity( vTZERPOS1,
                                             "W_ERD_RelatedEntity", "" ) )
            {
               if ( CompareAttributeToAttribute(
                     vTZERPOSO, "W_ERD_Entity", "OwningArea",
               ...
               {
                  AddToAttributeFromInteger( vTZERPOSO, "W_ERD_RelatedEntity",
                                         "NbrRelEntsInMyParentsOA", 1 );
               }
            } // End for each W_ERD_RelatedEntity of the related entity

         } // End for each W_ERD_RelatedEntity
         zgSortEntityWithinParent( zDESCENDING, vTZERPOSO,
                                   "W_ERD_RelatedEntity",
                                   "OA_MatchesParentsOA",
                                   "NbrRelEntsInMyParentsOA" );
         ...
         nRC = SetCursorNextEntity( vTZERPOSO, "Cluster", "" ) )
   {
      ...
      for ( nRC = SetCursorFirstEntity( vTZERPOSO, "W_ERD_Entity", "" );
            ...
            nRC = SetCursorNextEntity( vTZERPOSO, "W_ERD_Entity", "" ) )
      {
         GetStringFromAttribute( &sz[50],             //debug only
                                 vTZERPOSO, "W_ERD_Entity", "Name" );
         if ( CompareAttributeToInteger( vTZERPOSO, "W_ERD_Entity",
                                         "ER_DgmPosX", 0 ) != 0 )
         {
            // get position
            GetIntegerFromAttribute( &lXcell, vTZERPOSO,
                                     "W_ERD_Entity", "ER_DgmPosX" );
            GetIntegerFromAttribute( &lYcell, vTZERPOSO,
                                     "W_ERD_Entity", "ER_DgmPosY" );
         }
         else
         {
            // find free cell
            nD = nXincr = nYincr = 0;
            if ( zwfnTZEREMDD_FreeCell( &nXchk, &nYchk,
                                        nXcenter, nYcenter, nCells ) < 0 )
            {
               zstrcpy( sz, "No cell available for Area:\n\t'" );
               GetStringFromAttribute( &sz[ zstrlen( sz ) ],
                                       vTZERPOSO, "Cluster", "Name" );
               zstrcat( sz, "'\nEntity:\n\t'" );
               GetStringFromAttribute( &sz[ zstrlen( sz ) ],
            ...
            // set position
            SetAttributeFromInteger( vTZERPOSO, "W_ERD_Entity",
                                     "ER_DgmPosX", lXcell );
            SetAttributeFromInteger( vTZERPOSO, "W_ERD_Entity",
                                     "ER_DgmPosY", lYcell );
         }
                                          ...
                                          "W_ERD_RelatedEntity", "" ) )
         {
            ...
            // set position
            SetAttributeFromInteger( vTZERPOSO, "W_ERD_RelatedEntity",
                                     "ER_DgmPosX", lXcell );
            SetAttributeFromInteger( vTZERPOSO, "W_ERD_RelatedEntity",
                                     "ER_DgmPosY", lYcell );
...
// DisplayObjectInstance( vTZERPOSO, "RootStats", 0 );  // debug only
         ...
         nRC = SetCursorNextEntity( vTZERPOSO, "W_ERD_Entity", "RootStats" ) )
   {
      ...
      SetCursorFirstEntityByInteger( vTZEREMDO, "ER_Entity",
                                     "ZKey", lZKey, "" );
      SetAttributeFromInteger( vTZEREMDO, "ER_Entity", "ER_DiagramPosX",
                               (lXcell * 30) + nStaggerX - 15 );
      SetAttributeFromInteger( vTZEREMDO, "ER_Entity", "ER_DiagramPosY",
                               (lYcell * 20) + nStaggerY - 10 );
   }
   ...
   if ( GetViewByName( &vTZEREMDO, "TZEREMDO", vSubtask, zLEVEL_TASK ) > 0 )
   {
      ...
      if ( CheckExistenceOfEntity( vTZEREMDO, "ER_RelLink" ) >= zCURSOR_SET )
      {
         if ( nIsCheckedOut == 1 )
         {
            ...
            // Exists a Relationship to a SAP Entities, disable delete and
            // new Option
            if ( CompareAttributeToInteger( vTZEREMDO, "ER_Entity", "SAP_Entity",
                                            1 ) == 0 ||
                 CompareAttributeToInteger( vTZEREMDO, "ER_Entity_Other", "SAP_Entity",
                                            1 ) == 0 )
            {
               bDelete = FALSE;
               bNew    = FALSE;
...
zwTZEREMDD_ERD_EntityNeighbors( zVIEW vSubtask )
{
   ...
   // Set up DIL message.
   zstrcpy( sz, "Neighbors of entity (" );
   GetAddrForAttribute( &szName, vT, "ER_Entity", "Name" );
   zstrcat( sz, szName );
   zstrcat( sz, ") are selected." );
...
zwTZEREMDD_ERD_RelNeighbors( zVIEW vSubtask )
{
   ...
   // Set up DIL message.
   zstrcpy( sz, "Neighbors of relationship (" );
...
// zCHAR sz[ 256 ];
   ...
   {
//    GetStringFromAttribute( &sz[ 0 ], vTZEREMD1,
//                            "ER_Entity", "Name" ); //debug only
      nEnts++;
      GetIntegerFromAttribute( &lXgrid, vTZEREMD1,
                               "ER_Entity", "ER_DiagramPosX" );
      if ( lXgrid != 0 )
      {
         GetIntegerFromAttribute( &lYgrid, vTZEREMD1,
                                  "ER_Entity", "ER_DiagramPosY" );
         zwfnTZEREMDD_MarkCellEDM( lXgrid, lYgrid );
      }
   }  // End for each SA_Entity
                               ...
                               zVIEW   vTZEREMDO )
{
         ...
         nRC = SetCursorNextEntity( vTZEREMD1, "ER_RelLink", "" ) )
   {
      ...
      GetStringFromAttribute( &sz[ 0 ], vTZEREMD1,
                              "ER_Entity", "Name" ); //debug only
      GetStringFromAttribute( &sz[50], vTZEREMD1,
                              "ER_Entity_Other", "Name" ); //debug only
      if ( SetCursorFirstEntityByEntityCsr( vTZEREMD2, "ER_Entity",
                                            vTZEREMD1, "ER_Entity_Other",
                                            "" ) >= zCURSOR_SET )
      {
         nRels++;
         GetIntegerFromAttribute( &lXgrid, vTZEREMD2,
                                  "ER_Entity", "ER_DiagramPosX" );
         GetIntegerFromAttribute( &lYgrid, vTZEREMD2,
                                  "ER_Entity", "ER_DiagramPosY" );
         nX += (zSHORT)lXgrid;
         nY += (zSHORT)lYgrid;
      }
...
// zmemset( &cCellUsageSA[ 0 ][ 0 ], 0, MAX_CELL_X * MAX_CELL_Y );
   ...
   {
//    GetStringFromAttribute( &sz[ 0 ], vTZERSAS1,
//                            "ER_Entity", "Name" ); //debug only
      nEnts++;
      GetIntegerFromAttribute( &lXgrid, vTZERSAS1,
                               "SA_Entity", "ER_DiagramPosX" );
      if ( lXgrid != 0 )
      {
         GetIntegerFromAttribute( &lYgrid, vTZERSAS1,
                                  "SA_Entity", "ER_DiagramPosY" );
         zwfnTZEREMDD_MarkCellSA( lXgrid, lYgrid );
      }
   }  // End for each SA_Entity
                               ...
                               zVIEW   vTZERSASO )
{
         ...
         nRC = SetCursorNextEntity( vTZERSAS1, "ER_RelLink", "" ) )
   {
      GetStringFromAttribute( &sz[ 0 ], vTZERSAS1,
                              "ER_Entity", "Name" ); //debug only
      GetStringFromAttribute( &sz[50], vTZERSAS1,
                              "ER_Entity_Other", "Name" ); //debug only
      ...
      {
         nRels++;
         GetIntegerFromAttribute( &lXgrid, vTZERSAS2,
                                  "SA_Entity", "ER_DiagramPosX" );
         GetIntegerFromAttribute( &lYgrid, vTZERSAS2,
                                  "SA_Entity", "ER_DiagramPosY" );
         nX += (zSHORT)lXgrid;
         nY += (zSHORT)lYgrid;
      }
...
// {
      ...
      {  // refresh the entity and each relationship
               ...
               nRC = SetCursorNextEntity( vTZEREMDO, "ER_RelLink", "" ) )
         {
            ...
            SetCursorFirstEntityByEntityCsr( vTZEREMDO, "ER_RelType",
                             ...
                             zVIEW vTemp )
{
   ...
   GetStringFromAttribute( szMetaName,
                           vTemp, "W_MetaDef", "Name" );
   GetStringFromAttribute( szFullName,
                           vTemp, "LPLR", "MetaSrcDir" );
   zstrcat( szFullName, "\\" );
   zstrcat( szFullName, szMetaName );
   zstrcat( szFullName, ".PSA" );
   ...
   if ( hFile >= 0 )
   {
      ...
      if ( nRC < 0 )
      {
         ...
         zstrcpy( szMsg, "Error in reading Subject Area: " );
...
zwfnTZEREMDD_SetIdentifierEntity( zVIEW vXfer, zVIEW vERD )
{
   ...
   {
      GetStringFromAttribute( szFactTypeName,
                              vERD, "ER_RelLinkIdentifier", "Name" );
      GetStringFromAttribute( szOtherName,
                              vERD, "ER_Entity_Other_Identifier", "Name" );
      zstrcat( szFactTypeName, " " );
      zstrcat( szFactTypeName, szOtherName );
