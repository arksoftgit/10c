                               ...
                               zLONG    lActionType )
{
   ...
   GetStringFromAttribute( szButtonTag, vUserSpec, "LOD_Entity", "Name" );
   zstrcat( szButtonTag, szButtonText );
   ...
   if ( szActionText == 0 || szActionText[ 0 ] == 0 )
      zstrcpy( szActionName, szButtonTag );
   else
      zstrcpy( szActionName, szActionText );
                                 ...
                                 zPCHAR   szNextPrev )
{
   ...
   GetStringFromAttribute( szLOD_Name, vObject, "LOD", "Name" );
   SetCursorFirstEntityByString( vNewDialogRoot, "ViewObjRef", "Name",
                                 szLOD_Name, 0 );

   GetStringFromAttribute( szEntityName, vUserSpec, "LOD_Entity", "Name" );
   SetCursorFirstEntityByString( vObject, "LOD_Entity", "Name",
                                 szEntityName, 0 );
   ...
   if ( lSubActionType )
   {
      SetAttributeFromInteger( vNewDialogRoot, "Action", "SB_SubAction",
                               lSubActionType );
                               ...
                               zVIEW    vDefaults )
{
   ...
   SetAttributeFromInteger( vNewDialog, "Control", "PSDLG_X",
                            lPosX );
   SetAttributeFromInteger( vNewDialog, "Control", "PSDLG_Y",
                            lPosY );
                          ...
                          zVIEW    vPE )
{
   ...
   zltoa( lGroupNbr, szSuffix );
   zstrcat( szGroupName, szSuffix );
   if ( CheckExistenceOfEntity( vUSSubEnt, "LOD_Entity" ) >= zCURSOR_SET )
      GetStringFromAttribute( szGroupName, vUSSubEnt, "LOD_Entity", "Name" );
   else
      zstrcpy( szGroupName, "Group" );
                               ...
                               zPCHAR   szMarginType )
{
   ...
   if ( szMarginType[ 0 ] == 'B' )
   {
      GetIntegerFromAttribute( &lBottomMargin, vDefaults,
                               "InitValues", "GroupboxBottomMargin" );
      lRightMargin = 0;
   }
   ...
   SetAttributeFromInteger( vNewDialog, "Control", "SZDLG_X",
                            lMaxPosX + 5 + lRightMargin );
   SetAttributeFromInteger( vNewDialog, "Control", "SZDLG_Y",
                            lMaxPosY + 16 + lBottomMargin );
   SetAttributeFromInteger( vNewDialog, "Control", "PSDLG_X", 5 );
                               ...
                               zPCHAR   cListType )
{
   ...
   // overridden later.
   SetViewToSubobject( vNewDialog, "CtrlCtrl" );
   ofnTZWDLGSO_AutoDesignListbox( vSubtask, vUSSubEnt, vNewDialog, 5, 112,
                                  52, cListType );
   ...
   while ( nRC >= zCURSOR_SET &&
           CompareAttributeToString( vNewDialog, "ControlDef", "Tag",
                                     "ListBox" ) != 0 )
   {
      nRC = SetCursorNextEntity( vNewDialog, "CtrlCtrl", "" );
   }
   ...
   if ( szMarginType[ 0 ] == 'B' )
   {
      GetIntegerFromAttribute( &lBottomMargin,
                               vDefaults, "InitValues", "GroupboxBottomMargin" );
      lRightMargin = 0;
   }
   if ( szMarginType[ 0 ] == 0 )
   {
   ...
   // set later.
   SetAttributeFromInteger( vNewDialog, "Control", "SZDLG_X",
                            lWkPosX + 10 + lRightMargin );
   SetAttributeFromInteger( vNewDialog, "Control", "SZDLG_Y",
                            lWkPosY + lWkSizeY + 5 + lBottomMargin );
   oTZWDLGSO_SetGroupboxPosition( vNewDialog, vDefaults );

   // Set the RootOnlyList flag if the attributes to be listed are only
   // contained in the LOD_Entity.
   cRootOnlyFlag = 'Y';
   if ( cListType[ 0 ] == 'L' )
   {
      zstrcpy( szLOD_EntityName, "L_LOD_Entity" );
   ...
   {
      zstrcpy( szLOD_EntityName, "I_LOD_Entity" );
      // LOD_Entity must be retrieved from root of LOD for include list.
      GetStringFromAttribute( szLOD_Name, vUSSubEnt, "ListSubObjLOD", "Name" );
      ActivateMetaOI_ByName( vSubtask, &vIncludeLOD, 0, zREFER_LOD_META,
                             zSINGLE, szLOD_Name, 0 );
      GetStringFromAttribute( szEntityName,
                              vIncludeLOD, "LOD_EntityParent", "Name" );
   ...
   while ( nRC >= zCURSOR_SET )
   {
      if ( CompareAttributeToString( vUSSubEnt, szLOD_EntityName, "Name",
                                     szEntityName ) != 0 )
         cRootOnlyFlag = 'N';
                                ...
                                zPCHAR   szTabNo )
{
   ...
   zstrcpy( szGroupName, "G" );
   zstrcat( szGroupName, szTabNo );
   zstrcat( szGroupName, szTabName );
                               ...
                               zPCHAR   cListType )
{
   ...
   if ( cListType[ 0 ] == 'I' )
   {
      ...
      GetStringFromAttribute( szViewObjName,
   ...
   lLevel = 0;
   SetCursorFirstEntityByInteger( vNewDialog, "Control", "ZKey",
                                  lControlZKey, "" );
                                ...
                                zVIEW    vNewDialogRoot )
{
   ...
   while ( nRC >= zCURSOR_SET &&
           CompareAttributeToString( vNewDialog2, "ControlDef", "Tag",
                                     "ListBox" ) != 0 )
   {
...
oTZWDLGSO_ResetScopeToObject( zVIEW    vNewDialog )
{
   ...
   if ( nRC >= 0 )
   {
      ...
      SetEntityAttributesFromBlob( vListboxWk, "ListBox",
                                   vNewDialog, "CtrlCtrl", "CtrlBOI" );
      SetAttributeFromInteger( vListboxWk, "ListBox", "ScopeOI", 3 );
      SetBlobFromEntityAttributes( vNewDialog, "CtrlCtrl", "CtrlBOI",
                                   vListboxWk, "ListBox" );
      lSubtype = 24640;
...
oTZWDLGSO_GetNbrOfGroupboxes( zVIEW    vNewDialog )
{
   ...
   if ( CheckExistenceOfEntity( vNewDialog, "Control" ) >= zCURSOR_SET )
   {
      ...
      if ( CompareAttributeToString( vNewDialog2, "ControlDef", "Tag",
                                    "GroupBox" ) != 0 )
                           ...
                           zVIEW    vDefaults )
{
   ...
   while ( nRC >= zCURSOR_SET )
   {
      // MaxX
      GetIntegerFromAttribute( &lPosX,
                               vNewDialog, "CtrlCtrl", "PSDLG_X" );
      GetIntegerFromAttribute( &lSizeX,
                               vNewDialog, "CtrlCtrl", "SZDLG_X" );
      if ( lMaxX < lPosX + lSizeX )
         lMaxX = lPosX + lSizeX;

      // MaxY
      GetIntegerFromAttribute( &lPosY,
                               vNewDialog, "CtrlCtrl", "PSDLG_Y" );
      if ( lMaxY < lPosY )
         lMaxY = lPosY;
                              ...
                              zPCHAR szCaseOrig )
{
   ...
   while ( nRC > zCURSOR_UNCHANGED )
   {
      ...
      if ( szCase[ 0 ] == '1' )
      {
         ...
         oTZADCSDO_AutoDesignCase1List( vSubtask,
                                        vUserSpec,
                                        vUSSubEnt,
                                        vNewDialog,
                                        vNewDialogRoot,
      ...
      if ( szCase[ 0 ] == '4' )
         if ( CompareAttributeToString( vUSSubEnt, "ER_Entity", "Purpose",
                                     "S" ) != 0 )
         {
            ////////
            ...
            oTZADCSDO_AutoDesignCase4Group( vSubtask,
                                          vUserSpec,
                                          vUSSubEnt,
                                          vNewDialog,
                                          vNewDialogRoot,
                                 ...
                                 zLONG  lComboPosY )
{
   ...
   GetStringFromAttribute( szWorkString, vUSSubEnt, "WndDesign", "ListGroupboxText" );
   if ( szWorkString[ 0 ] == 0 )
      GetStringFromAttribute( szWorkString, vUSSubEnt, "LOD_Entity", "Name" );
   ...
   CreateMetaEntity( vSubtask, vNewDialog, "Control", zPOS_AFTER );
   zstrcpy( szControlName, "Combo" );
   GetStringFromAttribute( szEntityName,
                           vUSSubEnt, "LOD_Entity", "Name" );
   zstrcat( szControlName, szEntityName );
   szControlName[ 33 ] = 0;
   ...
   SetBlobFromEntityAttributes( vNewDialog, "Control", "CtrlBOI",
                                vPN_Work, "ComboBox" );
   DropView( vPN_Work );
   ...
   if ( CheckExistenceOfEntity( vUSSubEnt, "I_Domain" ) >= zCURSOR_SET )
      GetIntegerFromAttribute( &lTextLength,
                               vUSSubEnt, "I_Domain", "MaxStringLth" );
   else
      lTextLength = 10;
   if ( lTextLength > 50 )
      lTextLength = 50;
        ...
        CheckExistenceOfEntity( vUSSubEnt, "M_LOD_Attribute" ) >= zCURSOR_SET )
   {
      ...
      IncludeSubobjectFromSubobject( vNewDialog, "CtrlMapLOD_Attribute",
                                     vUSSubEnt,  "M_LOD_Attribute", zPOS_AFTER );
   }
        ...
        CheckExistenceOfEntity( vUSSubEnt, "I_LOD_Attribute" ) >= zCURSOR_SET )
   {
      CreateMetaEntity( vSubtask, vNewDialog, "CtrlMap", zPOS_AFTER );
      IncludeSubobjectFromSubobject( vNewDialog, "CtrlMapView",
                                     vUSSubEnt,  "ListViewObjRef", zPOS_AFTER );
      IncludeSubobjectFromSubobject( vNewDialog, "CtrlMapLOD_Attribute",
                                     vUSSubEnt,  "I_LOD_Attribute", zPOS_AFTER );

      // Add the ViewObjRef to the Dialog, if it isn't already there.
      GetIntegerFromAttribute( &lZKey, vUSSubEnt, "ListViewObjRef", "ZKey" );
      if ( SetCursorFirstEntityByInteger( vNewDialogTop, "ViewObjRef", "ZKey",
                                          lZKey, 0 )  < zCURSOR_SET )
         IncludeSubobjectFromSubobject( vNewDialogTop, "ViewObjRef",
                                        vUSSubEnt,  "ListViewObjRef", zPOS_AFTER );
   }
   ...
   if ( CheckExistenceOfEntity( vUserSpec, "I_LOD_Attribute" ) >= zCURSOR_SET )
   {
      CreateMetaEntity( vSubtask, vNewDialog, "CtrlMap", zPOS_AFTER );
      IncludeSubobjectFromSubobject( vNewDialog, "CtrlMapLOD_Entity",
                                     vUSSubEnt,  "I_LOD_Entity", zPOS_AFTER );
   }
   ...
   // I don't understand why but the Combo Box requires a fourth empty
   // CtrlMap entity.
...
SetNameForView( vNewDialog, "***NewDialog", vSubtask, zLEVEL_TASK );
   ...
   while ( nRC > zCURSOR_UNCHANGED )
   {
      GetStringFromAttribute( szEntityCase,
                              vUSSubEnt, "UIS_Entity", "AutodesignCaseType" );
   ...
   while ( nRC > zCURSOR_UNCHANGED )
   {
      ...
      if ( szEntityCase[ 0 ] == szCase[ 0 ] )
      {
         ...
         oTZADCSDO_BuildAutoInclCombobox( vSubtask,
                                          vUserSpec,
                                          vUSSubEnt,
                                          vDefaults,
                                          vNewDialog,
   ...
   GetIntegerFromAttribute( &lWkSize1,
                            vNewDialog, "Control", "SZDLG_X" );
   GetIntegerFromAttribute( &lWkSize2,
                            vDefaults, "InitValues", "GroupboxRightMargin" );
   SetAttributeFromInteger( vNewDialog, "Control", "SZDLG_X",
                            lWkSize1 + lWkSize2 );
   ...
   zstrcpy( szWorkString, "ListSub" );
   GetStringFromAttribute( szEntityName, vUSSubEntParent, "LOD_Entity", "Name" );
   zstrcat( szWorkString, szEntityName );
   szWorkString[ 33 ] = 0;
   ...
   IncludeSubobjectFromSubobject( vNewDialogTop, "WndAct",
                                  vNewDialogTop, "Action", zPOS_AFTER );
...
// zSHORT   nLth;
   ...
   GetStringFromAttribute( szListViewName, vUserSpec, "UIS_LOD", "Name" );
...
// }
   ...
   if ( CheckExistenceOfEntity( vUserSpec, "ListVOR" ) < zCURSOR_SET )
   {
      ...
      // VOR doesn't exist so create one for LOD vLOD.
      {
         ...
         IncludeSubobjectFromSubobject( vVOR, "LOD",
                                        vLOD, "LOD", zPOS_AFTER );
         IncludeSubobjectFromSubobject( vUserSpec, "ListVOR",
                                        vVOR,      "ViewObjRef", zPOS_AFTER );
   ...
   nRC = SetCursorFirstEntityByString( vNewDialog, "ViewObjRef", "Name",
                                       szListViewName, 0 );
   if ( nRC < zCURSOR_SET )
      IncludeSubobjectFromSubobject( vNewDialog, "ViewObjRef",
                                ...
                                zVIEW  vDefaults )
{
   ...
   ofnTZWDLGSO_CreateNewWindowInfo( vSubtask, vUserSpec,
   ...
   // "_List".
   GetStringFromAttribute( szWorkString, vUserSpec, "LOD_Entity", "Name" );
   zstrcat( szWorkString, "_List" );
   SetAttributeFromString( vNewDialog, "Window", "Tag",
                           szWorkString );
   ...
   // in the User Spec.
   oTZWDLGSO_CreateListViewLST( vSubtask, vUserSpec,
                                vNewDialog,
                                vObject );
   ...
   GetStringFromAttribute( szWorkString, vUserSpec, "ListLOD", "Name" );
   ...
   while ( nRC >= zCURSOR_SET )
   {
      GetStringFromAttribute( szWorkString, vUserSpec, "L_LOD_Entity", "Name" );
      nRC = SetCursorFirstEntityByString( vTempLOD, "LOD_Entity", "Name",
                                          szWorkString, 0 );
      if ( nRC < zCURSOR_SET )
      {
      ...
      GetStringFromAttribute( szWorkString, vUserSpec, "L_ER_Attribute", "Name" );
      nRC = SetCursorFirstEntityByString( vTempLOD, "ER_Attribute", "Name",
                                          szWorkString, "LOD_Entity" );
      if ( nRC < zCURSOR_SET )
      {
   ...
   // object.
   oTZWDLGSO_AutoDesignGroupboxL( vSubtask, vUserSpec,
                                  vNewDialog,
                                  vDefaults,
                                  "B",
                                  "I" );
   ...
   {
      GetStringFromAttribute( szWorkString, vUserSpec, "UIS_LOD", "Name" );
      zstrcat( szWorkString, " List" );
   ...
   GetStringFromAttribute( szSubWindowTag,
                           vUserSpec, "LOD_Entity", "Name" );
   oTZADCSDO_CreateCase1Buttons( vSubtask,
                                 vUserSpec,
                                 vUserSpec,
                                 vNewDialog,
                                 vNewDialog,
   ...
   GetIntegerFromAttribute( &lPosY,
                            vNewDialog, "Control", "PSDLG_Y" );
   GetIntegerFromAttribute( &lPosX,
                            vNewDialog, "Control", "PSDLG_X" );
   GetIntegerFromAttribute( &lGroupboxWidth,
                            vNewDialog, "Control", "SZDLG_X" );
   GetIntegerFromAttribute( &lButtonIncrementX,
                            vDefaults, "InitValues", "ButtonIncrementX" );
   ...
   GetStringFromAttribute( szButtonText,
                           vDefaults, "InitValues", "Exit" );
   ...
   SetAttributeFromInteger( vNewDialog, "Action", "Type",
   ...
   // If there is no List Qual subwindow, add Prebuild and ReturnFromSubwindow
   // events.
                                  ...
                                  "Y" ) == 0 )
   {
      ...
      GetStringFromAttribute( szButtonText,
                              vDefaults, "DfltWndDesign", "ListQualWndButtonText" );
      if ( szButtonText[ 0 ] == 0 )
         zstrcpy( szButtonText, "ListQualNew" );
      ...
      SetCursorLastEntity( vNewDialog, "Action", 0 );
      CreateMetaEntity( vSubtask, vNewDialog, "Action", zPOS_AFTER );
      SetAttributeFromString( vNewDialog, "Action", "Tag",
                              szButtonText );
      IncludeSubobjectFromSubobject( vNewDialog, "EventAct",
                                     vNewDialog, "Action", zPOS_AFTER );
      SetAttributeFromInteger( vNewDialog, "Action", "Type",
      ...
      SetAttributeFromString( vNewDialog, "Action", "WindowName",
                              "MainListQual" );
                           ...
                           zVIEW    vSourceView )
{
   ...
   SetMatchingAttributesByName( vTargetView, "Control",
                                vSourceView, "Control", zSET_NULL );
   IncludeSubobjectFromSubobject( vTargetView, "ControlDef",
                                  vSourceView, "ControlDef", zPOS_AFTER );
   CreateMetaEntity( vSubtask, vTargetView, "Event", zPOS_AFTER );
   SetMatchingAttributesByName( vTargetView, "Event",
                                vSourceView, "Event", zSET_NULL );
   IncludeSubobjectFromSubobject( vTargetView, "EventAct",
                                  vSourceView, "EventAct", zPOS_AFTER );
...
// SetAttributeFromInteger( vNewDialog, "Window", "ControlTagCounter", 0 );
   ...
   if ( szCase[ 1 ] == 'F' || szCase[ 1 ] == 'G' )
   {
      ...
      if ( nRC < zCURSOR_SET )
      {
         ...
         GetStringFromAttribute( szEntityName,
                                 vUSSubEnt, "ER_Entity", "Name" );
         zstrcpy( szMsg, "A Tab dialog is requested but no Main Tab is defined for Entity: " );
      ...
      while ( nRC >= zCURSOR_SET )
      {
         ...
         IncludeSubobjectFromSubobject( vNewDialog, "ControlDef",
                                        vPE,        "ControlDef", zPOS_AFTER );
         lTabCnt++;
         zltoa( lTabCnt, szTabCount );
         zstrcpy( szButtonText, "TabCtl" );
         zstrcat( szButtonText, szTabCount );
         SetAttributeFromString( vNewDialog, "Control", "Tag",  szButtonText );
         if ( CompareAttributeToString( vUSSubEnt, "UIS_Tab", "Title",
                                        "" ) != 0 )
            SetAttributeFromAttribute( vNewDialog, "Control", "Text",
                                       vUSSubEnt,  "UIS_Tab", "Title" );
         else
            SetAttributeFromAttribute( vNewDialog, "Control", "Text",
                                       vUSSubEnt,  "LOD_Entity", "Name" );
         SetAttributeFromInteger( vNewDialog, "Control", "SyncKey", 1 );
   ...
   // or not.
   if ( CompareAttributeToString( vUSSubEnt, "UIS_Entity", "RootIndicator",
                                  "Y" ) == 0 )
   {
      ...
      if ( CheckExistenceOfEntity( vUSSubEnt, "WndDesign" ) >= zCURSOR_SET &&
           CompareAttributeToString( vUSSubEnt, "WndDesign", "ListQualFlag",
                                     "Y" ) == 0 )
      {
      ...
      if ( CompareAttributeToString( vUSSubEnt, "WndDesign",
                                     "UpdateCreateAction", "Y" ) == 0 )
      {
         lButtonNbr++;
         GetStringFromAttribute( szButtonText,
                                 vDefaults, "InitValues", "New" );
         oTZADCSDO_CreateButtonActOper( vSubtask, vUSSubEnt, vNewDialog,
                                        vNewDialogRoot, vDefaults,
                                        szButtonText, 0,
      ...
      if ( CompareAttributeToString( vUSSubEnt, "WndDesign", "UpdateDeleteAction",
                                     "Y" ) == 0 )
      {
         lButtonNbr++;
         GetStringFromAttribute( szButtonText,
      ...
      if ( CompareAttributeToString( vUSSubEnt, "WndDesign", "UpdateNextAction",
                                     "Y" ) == 0 &&
           CompareAttributeToString( vAutoDesWk, "AutoDesignWork", "WDOD_Style",
                                     "L" ) == 0 )
      {
         lButtonNbr++;
         GetStringFromAttribute( szButtonText,
                                 vDefaults, "InitValues", "Next" );
         oTZADCSDO_CreateButtonActOper( vSubtask, vUSSubEnt, vNewDialog,
                                        vNewDialogRoot, vDefaults,
                                        szButtonText, 0,
         ...
         CreateMetaEntity( vSubtask, vNewDialogRoot, "ActMap", zPOS_AFTER );
         IncludeSubobjectFromSubobject( vNewDialogRoot, "ActMapLOD_Entity",
                                        vUSSubEnt,  "LOD_Entity", zPOS_AFTER );
         IncludeSubobjectFromSubobject( vNewDialogRoot, "ActMapView",
                                        vUSSubEnt,  "ListVOR", zPOS_AFTER );
      }
      ...
      if ( CompareAttributeToString( vUSSubEnt, "WndDesign", "UpdatePrevAction",
                                     "Y" ) == 0 &&
           CompareAttributeToString( vAutoDesWk, "AutoDesignWork", "WDOD_Style",
                                     "L" ) == 0 )
      {
   ...
   else
   {
      ...
      lButtonNbr++;
      GetStringFromAttribute( szButtonText, vDefaults, "InitValues", "OK" );
      ...
      if ( CompareAttributeToString( vUSSubEnt, "WndDesign", "UpdateCreateAction",
                                     "Y" ) == 0 )
      {
         lButtonNbr++;
         GetStringFromAttribute( szButtonText,
   ...
   // Initialize GroupNbr to count each repeating group, not including the
   // main group.

   // Set the Y position for all subordinate groups.  It is the last
   // group Y position + its size + 5.
   GetIntegerFromAttribute( &lWkPos,  vNewDialog, "Control", "PSDLG_Y" );
   GetIntegerFromAttribute( &lWkSize, vNewDialog, "Control", "SZDLG_Y" );
   ...
   while ( nRC > zCURSOR_UNCHANGED )
   {
      ...
      if ( szCase[ 0 ] == '2' )
      {
         ...
         oTZADCSDO_AutoDesignCase2Group( vSubtask,
                                         vUserSpec,
                                         vUSSubEntCall,
                                         vNewDialog,
                                         vNewDialogRoot,
      ...
      // Case 4 routine.
      if ( szCase[ 0 ] == '4' &&
           CompareAttributeToString( vUSSubEnt, "ER_Entity", "Purpose",
                                     "S" ) == 0 )
      {
         // If this is the Assoc. entity, continue the subobject loop.
         oTZADCSDO_AutoDesignAssocDep( vSubtask,
                                       vUserSpec,
                                       vUSSubEntCall,
                                       vNewDialog,
                                       vNewDialogRoot,
        ...
        szParentCase[ 1 ] == 'G' )
   {
      ...
      if ( szParentCase[ 1 ] == 'F' || szParentCase[ 1 ] == 'G' )
      {
         ...
         while ( nRC >= zCURSOR_SET )
         {
            if ( CompareAttributeToString( vSrcButtonView, "ControlDef", "Tag",
                                          "PushBtn" ) == 0 )
            {
               GetIntegerFromAttribute( &lButtolSizeY,
                                        vSrcButtonView, "Control", "SZDLG_X" );
         ...
         GetIntegerFromAttribute( &lGroupSizeY,
                                  vSrcButtonView, "Control", "SZDLG_X" );
         SetAttributeFromInteger( vSrcButtonView, "Control", "SZDLG_X",
                                  lGroupSizeY - lButtolSizeY - 5 );
      ...
      if ( szParentCase[ 1 ] == 'F' )
      {
         ...
         {
            lTabIndex++;
            zltoa( lTabIndex, szButtonSuffix );
            ...
            while ( nRC >= zCURSOR_SET )
            {
               ...
               {
                  oTZADCSDO_DuplicateButton( vSubtask, vTgtButtonView, vSrcButtonView );
                  SetAttributeFromInteger( vTgtButtonView, "Control", "PSDLG_X",
                                           lMaxSizeX + 10 );
                  // We must add a suffix to make the Button Tags unique.
                  // Make sure the Tag is max 29 chars to make room for the suffix.
                  GetStringFromAttribute( szButtonTag,
                                          vTgtButtonView, "Control", "Tag" );
                  szButtonTag[ 29 ] = 0;
                  zstrcat( szButtonTag, szButtonSuffix );
                  SetAttributeFromString( vTgtButtonView, "Control", "Tag",
                                          szButtonTag );
               }
      ...
      if ( szParentCase[ 1 ] == 'G' )
      {
         ...
         GetIntegerFromAttribute( &lButtolPosX,
                                  vNewDialog, "Control", "PSDLG_X" );
         GetIntegerFromAttribute( &lSizeX,
                                  vNewDialog, "Control", "SZDLG_X" );
         ...
         while ( nRC >= zCURSOR_SET )
         {
            if ( CompareAttributeToString( vSrcButtonView, "ControlDef", "Tag",
                                           "PushBtn" ) == 0 )
            {
               SetAttributeFromInteger( vSrcButtonView, "Control", "PSDLG_X",
                                        lButtolPosX );
            }
            nRC = SetCursorNextEntity( vSrcButtonView, "Control", "" );
         }
...
//    dks ... get tab sizes and subtract 11 from height to get tabctl sizes
      ...
      *lpTabsPerRow = lTabCnt;
      SetAttributeFromBlob( vNewDialog, "Control", "CtrlBOI",
                            szBlob, 3 * sizeof( long ) );

      // 6. For each TabCtl entity, set x and y sizes from Tab entity sizes
      //    minus 2.
      GetIntegerFromAttribute( &lSize_X,
                               vNewDialog, "Control", "SZDLG_X" );
      GetIntegerFromAttribute( &lSize_Y,
                               vNewDialog, "Control", "SZDLG_Y" );
      lSize_X = lSize_X - 2;
      lSize_Y = lSize_Y - 2;
      nRC = SetCursorFirstEntity( vNewDialog, "CtrlCtrl", "" );
   ...
   ofnTZWDLGSO_CalculateWindowSize( vNewDialog, &lSize_Y, &lSize_X );
   GetIntegerFromAttribute( &lMaxWindowWidth,
                            vDefaults, "InitValues", "WindowWidth" );
   ...
   if ( lSize_X > lMaxWindowWidth )
   {
      ...
      while ( nRC >= zCURSOR_SET )
      {
         if ( CompareAttributeToInteger( vNewDialog, "Control", "PSDLG_X",
                                         10 ) > 0 )
            break;
         nRC = SetCursorNextEntity( vNewDialog, "Control", 0 );
      }
                                ...
                                zVIEW vAutoDesWk )
{
   ...
   nRC = oTZADCSDO_AutoDesignCase1( vSubtask,
                                    vUserSpec,
                                    vUSSubEnt,
                                    vNewDialog,
                                    vDefaults );
...
// TraceLineS("IN", "LoadStyleInfo" );
   ...
   GetViewByName( &vAutoDesWk, "TZADWWKO", vSubtask, zLEVEL_TASK );
   nZRetCode = GetStringFromAttribute( szStyleName, vPainterObj, "Palette", "UIS_Name" );
   if ( szStyleName[ 0 ] == 0 )
   {
   ...
   {
      zstrcpy( szWorkString, "The user spec definition - " );
      zstrcat( szWorkString, szStyleName );
      zstrcat( szWorkString, " does not exist!" );
   ...
   if ( nRC == -1 )
   {
      zstrcpy( szWorkString, "Check-out failed on dialog spec - " );
      zstrcat( szWorkString, szStyleName );
   ...
   GetStringFromAttribute( szStyleName, vUserSpec, "UIS_LOD", "Name" );
   nRC = RetrieveViewForMetaList( vSubtask, &vFileObj, zREFER_LOD_META );
   nRC = SetCursorFirstEntityByString( vFileObj, "W_MetaDef",
                                       "Name", szStyleName, "" );
   if ( nRC <= zCURSOR_UNCHANGED )
   {
      zstrcpy( szWorkString, "The object definition - " );
      zstrcat( szWorkString, szStyleName );
      zstrcat( szWorkString, " does not exist!" );
   ...
   if ( nRC == -1 )
   {
      zstrcpy( szWorkString, "Check-out failed on Object - " );
      zstrcat( szWorkString, szStyleName );
   ...
   GetStringFromAttribute( szWindowName, vAutoDesWk,
   ...
   if ( CompareAttributeToString( vAutoDesWk, "AutoDesignWork",
                                  "AutoDesignWDOD", "Y" ) == 0 )
   {
      SetCursorNextEntityHierarchical( &Level, szEntityName, vUserSpec );
      DropHierarchicalCursor( vUserSpec );
      return( 0 );
   }
   nZRetCode = SetCursorNextEntityHierarchical( &Level, szEntityName, vUserSpec );
   bKeepLooping = 1;
   ...
   if ( bKeepLooping == 1 )
   {
      zstrcpy( szWorkString, "There is no entity in the user spec with the name " );
      zstrcat( szWorkString, szWindowName );
      zstrcat( szWorkString, ".  Enter an existing name." );
...
// TraceLineS("IN", "AddStyleEssentials W1" );
   ...
   ResetView( vUserSpec );
   DefineHierarchicalCursor( vUserSpec, "UI_Spec" );
   nZRetCode = SetCursorNextEntityHierarchical( &Level, szEntityName,
                                                 vUserSpec );
...
ofnTZWDLGSO_CreateMaintAttribs( zVIEW vSubtask, zVIEW vUserSpec )
{
   ...
   while ( nRC != 1 )
   {
      ...
      if ( nRC != zCURSOR_NULL )
      {
         GetIntegerFromAttribute( &lZKey, vTempStyle,
                                  "L_LOD_Attribute", "ZKey" );
         nRC = SetCursorFirstEntityByInteger( vObjectObj, "LOD_Attribute",
                                              "ZKey", lZKey, "LOD" );
...
ofnTZWDLGSO_CreateListAttribs( zVIEW vSubtask, zVIEW vUserSpec )
{
   ...
   while ( nRC > zCURSOR_UNCHANGED )
   {
      if ( CompareAttributeToString( vObjectObj, "LOD_Attribute",
                                 ...
                                 zPCHAR szAttribType )
{
   ...
   while ( nRC > zCURSOR_UNCHANGED )
   {
      ...
      IncludeSubobjectFromSubobject( vTempObj, szAttribType,
                                     vObjectObj, "LOD_Attribute",
                                     zPOS_AFTER );
                                 ...
                                 zPCHAR  szEntityName )
{
   ...
   nZRetCode = RetrieveViewForMetaList( vSubtask, &vFileObj, zREFER_VOR_META );
   nZRetCode = SetCursorFirstEntityByString( vFileObj, "W_MetaDef",
                                             "Name", szObjectName, "" );
   if ( nZRetCode <= zCURSOR_UNCHANGED )
   {
      zstrcpy( szWorkString, "There is no VOR with the name " );
      zstrcat( szWorkString, szObjectName );
   ...
   nZRetCode = ActivateMetaOI( vSubtask, &vVOR, vFileObj, zREFER_VOR_META,
                               zSINGLE | zLEVEL_APPLICATION );
   GetIntegerFromAttribute( &lZKey, vVOR, "LOD", "ZKey" );

   nZRetCode = RetrieveViewForMetaList( vSubtask, &vFileObj, zREFER_LOD_META );
   nZRetCode = SetCursorFirstEntityByInteger( vFileObj, "W_MetaDef",
                                              "CPLR_ZKey", lZKey, "" );
   if ( nZRetCode <= zCURSOR_UNCHANGED )
   {
      zstrcpy( szWorkString, "The object definition - " );
   ...
   nZRetCode = ActivateMetaOI( vSubtask, &vObjectObj, vFileObj, zREFER_LOD_META,
                               zSINGLE | zLEVEL_APPLICATION );
   if ( nZRetCode == -1 )
   {
      zstrcpy( szWorkString, "Check-out failed on object definition - " );
      zstrcat( szWorkString, szObjectName );
   ...
   nZRetCode = SetCursorFirstEntityByString( vObjectObj, "LOD_Entity",
                                             "Name", szEntityName, "" );
   if ( nZRetCode <= zCURSOR_UNCHANGED )
   {
      zstrcpy( szWorkString, "The entity name - " );
      zstrcat( szWorkString, szEntityName );
      zstrcat( szWorkString, " does not exist!" );
...
//   while ( nRC > zCURSOR_UNCHANGED )
   if ( nRC >= zCURSOR_SET )
   {
      ...
      nRC = SetCursorFirstEntityByInteger( vNewDialog, "ViewObjRef",
                                           "ZKey", lZKey, "" );
