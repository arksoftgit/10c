...
//:TRANSFORMATION OPERATION
//:AnalyzeZKeys( VIEW vERD BASED ON LOD TZEREMDO )

//:   VIEW          vERD2 BASED ON LOD TZEREMDO
zOPER_EXPORT zSHORT OPERATION
oTZEREMDO_AnalyzeZKeys( zVIEW     vERD )
{
   zVIEW     vERD2 = 0; 
   //:STRING( 200 ) szMsg
   zCHAR     szMsg[ 201 ] = { 0 }; 
   ...
   //:// Analyze Duplicates for ER_Relink.
   //:FOR EACH vERD.ER_RelLink WITHIN vERD.EntpER_Model
   RESULT = SetCursorFirstEntity( vERD, "ER_RelLink", "EntpER_Model" );
   while ( RESULT > zCURSOR_UNCHANGED )
   { 
      //:CreateViewFromViewForTask( vERD2, vERD, 0 )
      CreateViewFromViewForTask( &vERD2, vERD, 0 );
      //:SET CURSOR NEXT vERD2.ER_RelLink WITHIN vERD.EntpER_Model WHERE
      //:     vERD2.ER_RelLink.ZKey = vERD.ER_RelLink.ZKey
      GetIntegerFromAttribute( &lTempInteger_0, vERD, "ER_RelLink", "ZKey" );
      RESULT = SetCursorNextEntityByInteger( vERD2, "ER_RelLink", "ZKey", lTempInteger_0, "EntpER_Model" );
      //:IF RESULT >= zCURSOR_SET
      if ( RESULT >= zCURSOR_SET )
      { 
         //:szMsg = "Duplicate ZKey for Entity: " + vERD.ER_Entity.Name + NEW_LINE +
         //:        "RelLink: " + vERD.ER_RelLink.Name +
         //:        " " + vERD.ER_Entity_Other.Name
         GetVariableFromAttribute( szTempString_0, 0, 'S', 33, vERD, "ER_Entity", "Name", "", 0 );
         ZeidonStringCopy( szMsg, 1, 0, "Duplicate ZKey for Entity: ", 1, 0, 201 );
         ZeidonStringConcat( szMsg, 1, 0, szTempString_0, 1, 0, 201 );
         ZeidonStringConcat( szMsg, 1, 0, NEW_LINE, 1, 0, 201 );
         ZeidonStringConcat( szMsg, 1, 0, "RelLink: ", 1, 0, 201 );
         GetVariableFromAttribute( szTempString_1, 0, 'S', 33, vERD, "ER_RelLink", "Name", "", 0 );
         ZeidonStringConcat( szMsg, 1, 0, szTempString_1, 1, 0, 201 );
         ZeidonStringConcat( szMsg, 1, 0, " ", 1, 0, 201 );
         GetVariableFromAttribute( szTempString_2, 0, 'S', 33, vERD, "ER_Entity_Other", "Name", "", 0 );
         ZeidonStringConcat( szMsg, 1, 0, szTempString_2, 1, 0, 201 );
         //:MessageSend( vERD, "ER00404", "ERD Migrate",
         //:             szMsg, zMSGQ_OBJECT_CONSTRAINT_ERROR, 0 )
         MessageSend( vERD, "ER00404", "ERD Migrate", szMsg, zMSGQ_OBJECT_CONSTRAINT_ERROR, 0 );
      } 

      //:END
      //:DropView( vERD2 )
      DropView( vERD2 );
      RESULT = SetCursorNextEntity( vERD, "ER_RelLink", "EntpER_Model" );
   } 

   //:END

   //:// Analyze Duplicates for ER_RelinkIdentifier.
   //:FOR EACH vERD.ER_RelLinkIdentifier WITHIN vERD.EntpER_Model
   RESULT = SetCursorFirstEntity( vERD, "ER_RelLinkIdentifier", "EntpER_Model" );
   while ( RESULT > zCURSOR_UNCHANGED )
   { 
      //:CreateViewFromViewForTask( vERD2, vERD, 0 )
      CreateViewFromViewForTask( &vERD2, vERD, 0 );
      //:SET CURSOR NEXT vERD2.ER_RelLinkIdentifier WITHIN vERD.EntpER_Model WHERE
      //:     vERD2.ER_RelLinkIdentifier.ZKey = vERD.ER_RelLinkIdentifier.ZKey
      GetIntegerFromAttribute( &lTempInteger_1, vERD, "ER_RelLinkIdentifier", "ZKey" );
      RESULT = SetCursorNextEntityByInteger( vERD2, "ER_RelLinkIdentifier", "ZKey", lTempInteger_1, "EntpER_Model" );
      //:IF RESULT >= zCURSOR_SET
      if ( RESULT >= zCURSOR_SET )
      { 
         //:szMsg = "Duplicate ZKey for Entity: " + vERD.ER_Entity.Name + NEW_LINE +
         //:        "Identifier RelLink: " + vERD.ER_RelLinkIdentifier.Name +
         //:        " " + vERD.ER_Entity_Other_Identifier.Name
         GetVariableFromAttribute( szTempString_3, 0, 'S', 33, vERD, "ER_Entity", "Name", "", 0 );
         ZeidonStringCopy( szMsg, 1, 0, "Duplicate ZKey for Entity: ", 1, 0, 201 );
         ZeidonStringConcat( szMsg, 1, 0, szTempString_3, 1, 0, 201 );
         ZeidonStringConcat( szMsg, 1, 0, NEW_LINE, 1, 0, 201 );
         ZeidonStringConcat( szMsg, 1, 0, "Identifier RelLink: ", 1, 0, 201 );
         GetVariableFromAttribute( szTempString_4, 0, 'S', 33, vERD, "ER_RelLinkIdentifier", "Name", "", 0 );
         ZeidonStringConcat( szMsg, 1, 0, szTempString_4, 1, 0, 201 );
         ZeidonStringConcat( szMsg, 1, 0, " ", 1, 0, 201 );
         GetVariableFromAttribute( szTempString_5, 0, 'S', 33, vERD, "ER_Entity_Other_Identifier", "Name", "", 0 );
      ...
      //:DropView( vERD2 )
      DropView( vERD2 );
      RESULT = SetCursorNextEntity( vERD, "ER_RelLinkIdentifier", "EntpER_Model" );
   } 
      ...
      { 
         ...
         { 
            ...
            { 
               ...
               GetStringFromAttribute( szTempString_3, TargetERD, "DisplayCompareResult", "SourceAttributeName" );
               ...
               { 
                  ...
                  { 
                     ...
                     //:                   DomainName, vSubtask )
                     GetStringFromAttribute( szTempString_3, CurrentLPLR, "LPLR", "wFullyQualifiedFileName" );
   ...
   { 
      ...
      { 
         ...
         { 
            ...
            GetStringFromAttribute( szTempString_4, SourceERD, "ER_Entity_2", "Name" );
            ...
            GetStringFromAttribute( szTempString_5, SourceERD2, "ER_Entity_2", "Name" );
   ...
   { 
      ...
      { 
         ...
         { 
            ...
            //:SET CURSOR FIRST SourceERD.ER_Entity WHERE SourceERD.ER_Entity.Name = TargetERD.DisplayCompareResult.SourceEntityName
            GetStringFromAttribute( szTempString_6, TargetERD, "DisplayCompareResult", "SourceEntityName" );
            ...
            { 
               ...
               { 
                  ...
                  { 
                     ...
                     GetStringFromAttribute( szTempString_6, SourceERD, "ER_AttributeIdentifier", "Name" );
