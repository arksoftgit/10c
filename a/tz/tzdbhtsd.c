...
Include_LinkSubobject( zVIEW     vSubtask )
{
   ...
   GetStringFromAttribute( szTempString_0, TZDBHTSO, "Entity", "Name" );
   GetStringFromAttribute( szTempString_1, TZDBHTSO2, "Entity", "Name" );
   ...
   { 
      ...
      { 
         ...
         { 
            ...
            GetStringFromAttribute( szTempString_0, TZDBHTSO, "View", "Name" );
...
zSetDBH_TraceLevel( zVIEW     vSubtask )
{
   ...
   GetIntegerFromAttribute( (zLONG *) &TraceLevel, TZDBHTSO, "Root", "TraceLevel" );
   //:SetTaskDBHandlerTraceLevel( vSubtask,
   //:                            TraceLevel )
...
zExecuteOperation( zVIEW     vSubtask )
{
   ...
   { 
      ...
      GetStringFromAttribute( szTempString_0, TZDBHTSO, "LOD", "Name" );
      GetStringFromAttribute( szTempString_1, TZDBHTSO, "File", "Name" );
   ...
   { 
      ...
      //:                              KZDBHQUA,
      //:                              nFlags )            /* Control Value */
      GetStringFromAttribute( szTempString_2, TZDBHTSO, "LOD", "Name" );
   ...
   { 
      ...
      //:                                   vDialog,
      //:                                   zMULTIPLE )
      GetStringFromAttribute( szTempString_3, TZDBHTSO, "LOD", "Name" );
   ...
   { 
      ...
      //:                              TZDBHTSO.File.Name,  /* File Name */
      //:                              nFlags )             /* Control Value */
      GetStringFromAttribute( szTempString_4, TZDBHTSO, "LOD", "Name" );
      GetStringFromAttribute( szTempString_5, TZDBHTSO, "File", "Name" );
   ...
   { 
      ...
      //:                                   vDialog,
      //:                                   zSINGLE )
      GetStringFromAttribute( szTempString_6, TZDBHTSO, "LOD", "Name" );
   ...
   { 
      ...
      //:                       TZDBHTSO.File.Name,  /* File Name */
      //:                       nFlags )
      GetStringFromAttribute( szTempString_7, TZDBHTSO, "File", "Name" );
   ...
   { 
      ...
      //:                         TZDBHTSO.File.Name,  /* File Name */
      //:                         nFlags )
      GetStringFromAttribute( szTempString_8, TZDBHTSO, "File", "Name" );
...
TZDBHTSD_SetOptionsFromResultLst( zVIEW     vSubtask )
{
   ...
   { 
      ...
      GetStringFromAttribute( szTempString_0, TZDBHTSO, "ExecutionResult", "ViewName" );
      o_fnAddListValue( TZDBHTSO, "View", szTempString_0 );
      //:fnAddListValue( TZDBHTSO, "LOD",
      //:                TZDBHTSO.ExecutionResult.LOD  )
      GetStringFromAttribute( szTempString_1, TZDBHTSO, "ExecutionResult", "LOD" );
      o_fnAddListValue( TZDBHTSO, "LOD", szTempString_1 );
      //:fnAddListValue( TZDBHTSO, "File",
      //:                TZDBHTSO.ExecutionResult.FileName  )
      GetStringFromAttribute( szTempString_2, TZDBHTSO, "ExecutionResult", "FileName" );
   ...
   { 
      //:fnAddListValue( TZDBHTSO, "View",
      //:                TZDBHTSO.ExecutionResult.ViewName  )
      GetStringFromAttribute( szTempString_3, TZDBHTSO, "ExecutionResult", "ViewName" );
      o_fnAddListValue( TZDBHTSO, "View", szTempString_3 );
      //:fnAddListValue( TZDBHTSO, "LOD",
      //:                TZDBHTSO.ExecutionResult.LOD  )
      GetStringFromAttribute( szTempString_4, TZDBHTSO, "ExecutionResult", "LOD" );
      o_fnAddListValue( TZDBHTSO, "LOD", szTempString_4 );
      //:fnAddListValue( TZDBHTSO, "Qual",
      //:                TZDBHTSO.ExecutionResult.QualView )
      GetStringFromAttribute( szTempString_5, TZDBHTSO, "ExecutionResult", "QualView" );
   ...
   { 
      //:fnAddListValue( TZDBHTSO, "View",
      //:                TZDBHTSO.ExecutionResult.ViewName  )
      GetStringFromAttribute( szTempString_6, TZDBHTSO, "ExecutionResult", "ViewName" );
      o_fnAddListValue( TZDBHTSO, "View", szTempString_6 );
      //:fnAddListValue( TZDBHTSO, "LOD",
      //:                TZDBHTSO.ExecutionResult.LOD  )
      GetStringFromAttribute( szTempString_7, TZDBHTSO, "ExecutionResult", "LOD" );
   ...
   { 
      //:fnAddListValue( TZDBHTSO, "LOD",
      //:                TZDBHTSO.ExecutionResult.LOD  )
      GetStringFromAttribute( szTempString_8, TZDBHTSO, "ExecutionResult", "LOD" );
   ...
   { 
      //:fnAddListValue( TZDBHTSO, "View",
      //:                TZDBHTSO.ExecutionResult.ViewName  )
      GetStringFromAttribute( szTempString_9, TZDBHTSO, "ExecutionResult", "ViewName" );
   ...
   { 
      //:fnAddListValue( TZDBHTSO, "View",
      //:                TZDBHTSO.ExecutionResult.ViewName  )
      GetStringFromAttribute( szTempString_10, TZDBHTSO, "ExecutionResult", "ViewName" );
      o_fnAddListValue( TZDBHTSO, "View", szTempString_10 );
      //:fnAddListValue( TZDBHTSO, "File",
      //:                TZDBHTSO.ExecutionResult.FileName )
      GetStringFromAttribute( szTempString_11, TZDBHTSO, "ExecutionResult", "FileName" );
   ...
   { 
      //:fnAddListValue( TZDBHTSO, "View",
      //:                TZDBHTSO.ExecutionResult.ViewName  )
      GetStringFromAttribute( szTempString_12, TZDBHTSO, "ExecutionResult", "ViewName" );
   ...
   { 
      //:fnAddListValue( TZDBHTSO, "View",
      //:                TZDBHTSO.ExecutionResult.ViewName  )
      GetStringFromAttribute( szTempString_13, TZDBHTSO, "ExecutionResult", "ViewName" );
