                            ...
                            zPCHAR szOutName )
{
   ...
   GetStringFromAttribute( szNewName, vSaveAs, "ActionAfterSaveAS", "SironName" );
                              ...
                              zPCHAR szSourceFileName )
{
   ...
   GetStringFromAttribute( szNewName, vView, szEntity, szAttribute );
   UfCompressName( szNewName, szFileName, 8, "", "", "", "", 0 );

   if (szExtension == "REP")
      GetStringFromAttribute( szSourceFileName, vTaskLPLR, "LPLR", "PgmSrcDir" );
   else
      GetStringFromAttribute( szSourceFileName, vTaskLPLR, "LPLR", "ExecDir" );
                                  ...
                                  zVIEW    vSaveAs )
{
   ...
   else
   {
      ...
      if ( nFilesExists == 1 )
      {
         zstrcpy( szMsg, "RDT Source Files '" );
         zstrcat( szMsg, szSironFile );
...
TZRPUPSD_SaveAsReport( zVIEW vSubtask )
{
   ...
   GetStringFromAttribute( szPathNameREP, vSourceLPLR, "LPLR", "PgmSrcDir" );
   GetStringFromAttribute( szPathNameXSQ, vSourceLPLR, "LPLR", "ExecDir" );
