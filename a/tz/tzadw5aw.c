...
// TraceLineS("IN", "CreateQualifierWnd W5" );
   ...
   if ( nRC >= zCURSOR_SET )
      GetStringFromAttribute( szLiteral, vLOD,
                              "ER_Attribute", "Name" );
   zstrcat( szLiteral, " " );
   GetStringFromAttribute( szTempString_0, vUSSubEnt,
                            "UIS_Include", "SubObjectOperators" );
   zstrcat( szLiteral, szTempString_0 );

   CreateMetaEntity( vSubtask, vNewDialog, "Window", zPOS_AFTER );

   zstrcpy( szTempString_1, "QUAL" );
   GetStringFromAttribute( szTempString_2, vUSSubEnt, "LOD_Entity", "Name" );
   zstrcat( szTempString_1, szTempString_2 );
   szTempString_1[ 32 ] = 0;
   ...
   zstrcpy( szTempString_1, "ListQualSubObj" );
   GetStringFromAttribute( szTempString_3, vUSSubEnt, "LOD_Entity", "Name" );
   zstrcat( szTempString_1, szTempString_3 );
   szTempString_1[ 32 ] = 0;
...
// TraceLineS("IN", "CreateEntryWindow W5" );
   ...
   if ( CheckExistenceOfEntity( vUSSubEnt, "L_LOD_Attribute" ) == 0 )
   {
      ...
      GetStringFromAttribute( szLiteral, vUSSubEnt,
   ...
   zstrcpy( szTempString_0, "KEY" );
   GetStringFromAttribute( szTempString_1, vUSSubEnt, "LOD_Entity", "Name" );
   zstrcat( szTempString_0, szTempString_1 );
   szTempString_0[ 32 ] = 0;
   ...
   SetAttributeFromInteger( vNewDialog, "Action", "Type", 72 ); /* RETURN */
   zstrcpy( szTempString_0, "LoadObjForList" );
   GetStringFromAttribute( szTempString_2, vUSSubEnt, "LOD_Entity", "Name" );
   zstrcat( szTempString_0, szTempString_2 );
   szTempString_0[ 32 ] = 0;
...
// TraceLineS( "IN", " AutoPaintPartitionWithFields" );
   ...
   if ( lAttribLth == 0 )
   {
      ...
      GetStringFromAttribute( szDataType, vUserSpec,
                              X_Domain, "DataType" );
      switch ( szDataType[ 0 ] )
      {
        case 'L':
