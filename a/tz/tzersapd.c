                                 ...
                                 zVIEW  vTZERSAPO )
{
   ...
   // Read ServerList
   pfnGetServerList = (pfnSapGetServerList) SysGetProc( hLibrary,
                                                        "ZSAP_GetSirenvServerList" );
   if ( pfnGetServerList == 0 )
      return( fnTZERSAPD_SAP_LoadErrorMsg( vSubtask,
                                           "ZSAP_GetSirenvServerList" ));

   lCountServer = (*pfnGetServerList) ( &hServerList );

   // Read Server from List
   pfnGetServer = (pfnSapGetServer) SysGetProc( hLibrary,
                                                "ZSAP_GetSirenvServerName" );
   if ( pfnGetServer == 0 )
   {
...
zwTZERSAPD_SaveInZeidonIni( zVIEW vTZERSAPO )
{
   ...
   if ( CompareAttributeToString( vTZERSAPO, "SapEnvironment",
                                  "SaveInZeidonIni", "Y" ) == 0 )
   {
      GetStringFromAttribute( szValue, vTZERSAPO, "SapEnvironment", "Client" );
      SysUpdateZeidonIni( "[SAP]", "DefaultClient", szValue );

      GetStringFromAttribute( szValue, vTZERSAPO, "SapEnvironment", "User" );
      SysUpdateZeidonIni( "[SAP]", "DefaultUser", szValue );

      GetStringFromAttributeByContext( szValue, vTZERSAPO, "SapEnvironment",
                                       "Password", "Password", 8 );
...
zwTZERSAPD_ExitImport( zVIEW vSubtask )
{
   ...
   if ( hLibrary != 0 )
   {
      if ( CompareAttributeToInteger( vTZERSAPO, "SapEnvironment",
                                      "Connection", 1 ) == 0 )
      {
         // SAP Logoff
                        ...
                        zSHORT szTabNumber )
{
                                  ...
                                  szAttributeName, "" ) == 0 )
   {
      if ( zstrcmp( szAttributeName, "SearchString" ) == 0 )
         zstrcpy( szWorkMessage, "Search String for Table" );
      else
         zstrcpy( szWorkMessage, szAttributeName );

      if ( zstrcmp( szAttributeName, "Password" ) == 0 )
         zstrcat( szWorkMessage, " is required." );
      else
         zstrcat( szWorkMessage, " Name is required." );
                        ...
                        zVIEW  vTZERSAPO )
{
   ...
   if ( fnTZERSAPD_CheckValues( vSubtask, vTZERSAPO, "SirEnvServer",
                                "Server", "cbServer", 1 ) < 0 )
   {
      return( -1 );
   }
   ...
   if ( CompareAttributeToString( vTZERSAPO, "SapEnvironment", "ImportFlags",
                                  zBuild_RS_TE ) != 0 )
   {
      GetCtrlText( vSubtask, "cbSearchString", szSearchString, 257 );
      SetAttributeFromString( vTZERSAPO, "SapEnvironment", "SearchString",
                              szSearchString );
      if ( fnTZERSAPD_CheckValues( vSubtask, vTZERSAPO, "SapEnvironment",
                                   "SearchString", "cbSearchString", 1 ) < 0 )
      {
         return( -1 );
      }
   }
                          ...
                          zVIEW  vTZERSAPO )
{
   ...
   GetIntegerFromAttribute( &lTranspCount, vTZERSAPO, "SearchString",
                            "CountTables" );

   if ( lTranspCount != -1 )
   {
      zltoa( lTranspCount, szCountTables );
      zstrcpy( szControlText, " " );
      zstrcat( szControlText, szCountTables );
      zstrcat( szControlText, " Table(s) found" );
   }
   else
   {
      zstrcpy( szControlText, " Press Search Button" );
   }
...
zwTZERSAPD_SetSearchString( zVIEW vSubtask )
{
   ...
   GetCtrlText( vSubtask, "cbSearchString", szSearchString, 257 );
   SetAttributeFromString( vTZERSAPO, "SearchString", "SearchString",
                           szSearchString );
...
zwTZERSAPD_SetEntityCursor( zVIEW vSubtask )
{
   ...
   {
      SetCursorFirstEntityByString( vTZERSAPO, "SearchString", "SearchString",
                                    szSearchString, "" );
   }
   else
   {
      SetCursorFirstEntityByInteger( vTZERSAPO, "SearchString", "CountTables",
                                     -1, "" );
   }
...
zwTZERSAPD_CreateNewSearchItem( zVIEW vTZERSAPO )
{
   ...
   if ( SetCursorFirstEntityByInteger( vTZERSAPO_Copy, "SearchString",
                                       "CountTables", -1, "" ) < zCURSOR_SET )
   {
      CreateEntity( vTZERSAPO_Copy, "SearchString", zPOS_AFTER );
      SetAttributeFromInteger( vTZERSAPO_Copy, "SearchString",
                               "CountTables", -1 );
   }
                                  ...
                                  zVIEW  vTZERSAPO )
{
   ...
   if ( CompareAttributeToInteger( vTZERSAPO, "SearchString",
                                   "CountTables", -1 ) == 0 )
   {
      SetAttributeFromAttribute( vTZERSAPO, "SearchString", "OriginalSearchString",
                                 vTZERSAPO, "SearchString", "SearchString" );
   }
   else
   {
      // search string is updated, create a new search string with this data
      // and reset old search string data
      GetStringFromAttribute( szOrgSearchString, vTZERSAPO, "SearchString",
                              "OriginalSearchString" );
      GetStringFromAttribute( szSearchString, vTZERSAPO, "SearchString",
                              "SearchString" );
      if ( zstrcmp( szSearchString, szOrgSearchString ) != 0 )
      {
         ...
         if ( SetCursorFirstEntityByString( vTZERSAPO_Copy, "SearchString",
                                            "SearchString", szSearchString,
                                            "" ) < zCURSOR_SET &&
              SetCursorNextEntityByString( vTZERSAPO_Copy, "SearchString",
                                           "SearchString", szSearchString,
                                           "" ) < zCURSOR_SET )
         {
            ...
            SetAttributeFromString( vTZERSAPO, "SearchString", "SearchString",
                                    szSearchString );
            SetAttributeFromString( vTZERSAPO, "SearchString", "OriginalSearchString",
                                    szSearchString );
            SetAttributeFromInteger( vTZERSAPO, "SearchString", "CountTables", -1 );
         ...
         {
            SetCursorFirstEntityByString( vTZERSAPO, "SearchString",
                                          "SearchString", szSearchString, "" );
         }
      }
   }
                                  ...
                                  zVIEW  vTZERSAPO )
{
                                      ...
                                      "" ) >= zCURSOR_SET )
   {
      ...
      if ( SetCursorNextEntityByString( vTZERSAPO_Copy, "SearchString",
                                        "SearchString", szSearchString,
                                        "" ) >= zCURSOR_SET )
      {
         if ( CompareAttributeToAttribute( vTZERSAPO_Copy, "SearchString",
                                           "SearchString",
                                           vTZERSAPO_Copy, "SearchString",
                                           "OriginalSearchString" ) == 0 )
         {
            SetAttributeFromString( vTZERSAPO_Copy, "SearchString",
                                    "SearchString", "" );
            SetAttributeFromString( vTZERSAPO_Copy, "SearchString",
                                    "OriginalSearchString", "" );
            SetAttributeFromInteger( vTZERSAPO_Copy, "SearchString",
         ...
         {
            SetAttributeFromAttribute( vTZERSAPO_Copy, "SearchString",
                                       "SearchString",
                                       vTZERSAPO_Copy, "SearchString",
                                       "OriginalSearchString" );
         }
...
static zSHORT
fnTZERSAPD_SAP_ReadErrorMsg( zVIEW lpTaskView, zPCHAR szMessage )
{
   zPCHAR            pszMsg     = NULL;
   zPCHAR            pszSAP_Msg = NULL;
   pfnGetLastError   pGetLastError;

   pGetLastError = (pfnGetLastError) SysGetProc( hLibrary,
                                                 "ZSAP_GetLastError" );
   if ( pGetLastError == 0 )
   ...
   pszMsg = szMessage;
   zstrcat( pszMsg, ":\n\n" );
   zstrcat( pszMsg, pszSAP_Msg );

   SysMessageBox( lpTaskView, "SAP Import", pszMsg, 1 );
...
fnTZERSAPD_SAP_LoadErrorMsg( zVIEW lpTaskView, zPCHAR szOperation )
{
   ...
   zstrcpy( szMsg, "Can't find operation '" );
   zstrcat( szMsg, szOperation );
   zstrcat( szMsg, "' in library KZSAPACC." );
                        ...
                        zPCHAR  szConnection )
{
   ...
   if ( zstrcmp( szConnection, "ZSAP_Logon" ) == 0 )
   {
      ...
      GetStringFromAttributeByContext( szPassword, vTZERSAPO, "SapEnvironment",
                                       "Password", "Password", 8 );
      GetStringFromAttribute( szServer, vTZERSAPO, "SirEnvServer", "Server" );
   ...
   else
   {
      ...
      GetStringFromAttribute( szClient, vTZERSAPO, "Logon", "Client_Org" );
      GetStringFromAttribute( szUser, vTZERSAPO, "Logon", "User_Org" );
      GetStringFromAttributeByContext( szPassword, vTZERSAPO, "Logon",
                                       "Password_Org", "Password", 8 );
      GetStringFromAttribute( szServer, vTZERSAPO, "Logon", "Server_Org" );
                              ...
                              zCHAR   cLanguage )
{
   ...
   for ( k = 0; k < lCountTables; k++ )
   {
      ...
      {
         zstrcpy( szMsg, "Load Table: " );
         zstrcat( szMsg, szTableName );
                            ...
                            zPCHAR  szSearchString )
{
   ...
   for ( i = j; i<= lLen; i++ )
   {
      if ( szSearchString[ i ] != ' ' && szSearchString[ i ] != ',' &&
           szSearchString[ i ] != ';')
      {
   ...
   zstrcpy( szSearchString, szSearchStr );
   return( 0 );
...
fnTZERSAPD_IsChangeLogonParam( zVIEW  vTZERSAPO )
{
   ...
   if ( CompareAttributeToAttribute( vTZERSAPO, "SapEnvironment", "Client",
                                     vTZERSAPO, "Logon", "Client_Org" )
                                     != 0 ||
        CompareAttributeToAttribute( vTZERSAPO, "SapEnvironment", "User",
                                     vTZERSAPO, "Logon", "User_Org" )
                                     != 0 ||
        CompareAttributeToAttribute( vTZERSAPO, "SapEnvironment", "Password",
                                     vTZERSAPO, "Logon", "Password_Org" )
                                     != 0 ||
        CompareAttributeToAttribute( vTZERSAPO, "SirEnvServer", "Server",
                                     vTZERSAPO, "Logon", "Server_Org" )
                                     != 0 )
   {
      return( TRUE );
   }
...
zwTZERSAPD_SearchSapTable( zVIEW vSubtask )
{
   ...
   GetStringFromAttribute( szSearchString, vTZERSAPO, "SearchString", "SearchString" );
   ...
   GetStringFromAttribute( szLanguage, vTZERSAPO, "SapEnvironment", "LanguageType" );
   cLanguage = szLanguage[ 0 ];
   nRC = fnTZERSAPD_SAP_LoadTableData( vSubtask, vTZERSAPO, szSearchString,
                                       cLanguage );
   if ( nRC < 0 )
      return( nRC );
...
// ende
   ...
   for ( nRC = SetCursorFirstEntityByInteger( vERD_Copy, "ER_Entity",
                                              "ER_DiagramPosX", -1, "" );
         nRC >= zCURSOR_SET;
         nRC = SetCursorNextEntityByInteger( vERD_Copy, "ER_Entity",
                                             "ER_DiagramPosX", -1, "" ) )
   {
      if ( CompareAttributeToInteger( vERD_Copy, "ER_Entity",
                                      "ER_DiagramPosY", -1 ) == 0 )
      {
         SetAttributeFromInteger( vERD_Copy, "ER_Entity",
                                 "ER_DiagramPosX", lPosX );
         SetAttributeFromInteger( vERD_Copy, "ER_Entity",
                                 "ER_DiagramPosY", lPosY );
         lPosX = lPosX + 20;
         if ( lPosX > lLastPosX )
         {
            lPosX = 1;
                              ...
                              zLONG   lIndex )
{
   ...
   zstrcpy( szMsg, "Import Table: " );
   zstrcat( szMsg, szTableName );
   zstrcat( szMsg, ",   Column: " );
   zstrcat( szMsg, szAttr );
   MB_SetMessage( vSubtask, 0, szMsg );

   lShowIndex = 1 + lIndex;
   zltoa( lShowIndex, szShowIndex );
   zstrcpy( szMsg1, szShowIndex );
   zstrcat( szMsg1, " / " );
   zstrcat( szMsg1, szCountAttr );
                          ...
                          zLONG  lDecimals )
{
   ...
   if ( cIntType == SAP_SHORT || cIntType == SAP_BIN || cIntType == SAP_INT )
      zstrcpy( szDomainName, "Integer" );
   else
   if ( cIntType == SAP_CHAR )
      zstrcpy( szDomainName, "Text" );
   else
   if ( cIntType == SAP_DATE )
      zstrcpy( szDomainName, "Date" );
   else
   if ( cIntType == SAP_TIME )
      zstrcpy( szDomainName, "Time" );
   else
   if ( cIntType == SAP_HEX )
      zstrcpy( szDomainName, "AlphaNumeric" );
   else
   if ( cIntType == SAP_FLOAT || cIntType == SAP_NUM || cIntType == SAP_PACKED )
   {
      ...
      {
      case 0:
         zstrcpy( szDomainName, "Decimal0" );
         break;
      case 1:
         zstrcpy( szDomainName, "Decimal1" );
         break;
      case 2:
         zstrcpy( szDomainName, "Decimal2" );
         break;
      case 3:
         zstrcpy( szDomainName, "Decimal3" );
         break;
      case 4:
         zstrcpy( szDomainName, "Decimal4" );
         break;
      case 5:
         zstrcpy( szDomainName, "Decimal5" );
         break;
      case 6:
         zstrcpy( szDomainName, "Decimal6" );
         break;
      case 7:
         zstrcpy( szDomainName, "Decimal7" );
         break;
      case 8:
         zstrcpy( szDomainName, "Decimal8" );
         break;
      case 9:
         zstrcpy( szDomainName, "Decimal9" );
         break;
      default:
         zstrcpy( szDomainName, "Decimal" );
      }
   }
   else
   {
      GetStringFromAttribute( szAttributeName, vERD, "ER_Attribute", "Name" );
      zstrcpy( szMsg, "Attribute '" );
      zstrcat( szMsg, szAttributeName );
      zstrcat( szMsg, "' does not have Domain assigned, SAP Data Type '" );
      zstrncat( szMsg, &cIntType, 1 );
      zstrcat( szMsg, "' is not implemented." );
      zwTZERSAPD_WriteErrorMsg( vSubtask, zBuildERD, szMsg, 1 );
      return( -1 );
   }

   nRC = ActivateMetaOI_ByName( vSubtask, &vDomain, 0, zREFER_DOMAIN_META,
                                zSINGLE, szDomainName, 0 );
   if ( nRC < 1 )
   {
      GetStringFromAttribute( szAttributeName, vERD, "ER_Attribute", "Name" );
      zstrcpy( szMsg, "Attribute '" );
      zstrcat( szMsg, szAttributeName );
      zstrcat( szMsg, "' does not have Domain assigned, Domain '" );
      zstrcat( szMsg, szDomainName );
      zstrcat( szMsg, "' was not found." );
      zwTZERSAPD_WriteErrorMsg( vSubtask, zBuildERD, szMsg, 1 );
      return( -1 );
   }
   else
   {
      IncludeSubobjectFromSubobject( vERD, "Domain",
                             ...
                             zSHORT  nIdentifierType )
{
   ...
   if ( CheckExistenceOfEntity( vERD, "ER_EntIdentifier" ) < zCURSOR_SET )
   {
      ...
      zstrcpy( szIdentifierName, szTableName );
      zstrcat( szIdentifierName, "_ID" );
      SetAttributeFromString( vERD, "ER_EntIdentifier", "Name",
                              szIdentifierName );
      SetAttributeFromString( vERD, "ER_EntIdentifier", "TE_KeyName",
                              szIdentifierName );
   }
                                 ...
                                 zPSHORT        pnExistFK )
{
   ...
   if ( cKeyFlag == 'X' )
   {
      ...
      SetAttributeFromString( vERD, "ER_Attribute", "NotNull", "Y" );
      // Create Identifier
      if ( zwTZERSAPD_CreateIdentifier( vSubtask, vERD,
                                        szTableName, zAttributeID ) < 0 )
         return( -1 );
   }

   // Include Standard Domain
   if ( zwTZERSAPD_IncludeDomain( vSubtask, vERD, cIntType, lDecimals ) < 0 &&
        lIgnoreError == 0 )
   {
      return( -1 );
   }
                                  ...
                                  zCHAR   cLanguage )
{
   ...
   pfnGetAttrList = (pfnSapGetAttrList) SysGetProc( hLibrary,
                                                    "ZSAP_GetAttrList" );
   if ( pfnGetAttrList == 0 )
   ...
   zltoa( lCountAttr, szCountAttr );
   for ( k = 0; k < lCountAttr; k++ )
   {
      nRC = fnTZERSAPD_CreateAttribAndIdent( vSubtask, vERD, szTableName,
                                             szCountAttr, pfnGetAttr,
                                             hAttribList, k, &nExistFK );
      if ( nRC < 0 )
      {
         break;
      }
   ...
   // An Entity is considered to be fundamental if it does not have a
   // foreign key beeing part of the key
   if ( nExistFK == 0 )
                                 ...
                                 zPCHAR  szTableName )
{
   ...
   // Read Table Informations and Table Data
   GetStringFromAttribute( szLanguage, vTZERSAPO, "SapEnvironment",
                           "LanguageType" );
   cLanguage = szLanguage[ 0 ];

   if ( fnTZERSAPD_SAP_LoadAttributeData( vSubtask, vERD, szTableName,
                                          cLanguage ) < 0 )
   {
      return( -1);
   }
                                ...
                                zPSHORT pnEntityInSA )
{
   ...
   if ( SetCursorFirstEntityByString( vERD, "ER_Entity", "TE_TableName",
                                      szTableName, "" ) >= zCURSOR_SET )
   {
      bEntityExists = TRUE;
      CreateViewFromViewForTask( &vTZERSAPO1, vTZERSAPO, 0 );
      if ( SetCursorFirstEntityByString( vTZERSAPO1, "Table", "TableName",
                                         szTableName, "" ) >= zCURSOR_SET &&
           CompareAttributeToInteger( vTZERSAPO1, "Table", "TablesIsImported",
                                      1 ) == 0 )
      {
   ...
   if ( bEntityExists )
   {
      ...
      if ( CompareAttributeToString( vTZERSAPO, "SapEnvironment",
                                     "OverwriteExistingEntity", "Y" ) != 0 )
      {
         zstrcpy( szMsg, "Table '" );
         zstrcat( szMsg, szTableName );
         zstrcat( szMsg, "' already exists in Data Model.\n" );
         zstrcat( szMsg, "Replace existing Entity?" );
                         ...
                         zVIEW vTZERSAPO )
{
   ...
   GetStringFromAttribute( szTableName, vTZERSAPO, "Table", "TableName" );
   ...
   // check exists of Entity in ERD
   nRC = fnTZERSAPD_CheckExistsOfEntity( vSubtask, vERD, vTZERSAPO, szTableName,
                                         &lPosY, &lPosX, &lZKey, &nEntityInSA );
   if ( nRC )
      return( nRC );
   ...
   if ( lZKey != 0 )
   {
      ...
      if ( GetViewByName( &vTZERSASO, "TZERSASO", vSubtask, zLEVEL_TASK ) > 0 &&
           nEntityInSA == 1 )
      {
         IncludeSubobjectFromSubobject( vTZERSASO, "ER_Entity",
                                        vERD, "ER_Entity", zPOS_FIRST );
      }
   }

   SetAttributeFromString( vERD, "ER_Entity", "Name", szTableName );
   SetAttributeFromString( vERD, "ER_Entity", "TE_TableName", szTableName );
   SetAttributeFromAttribute( vERD, "ER_Entity", "Desc",
                             vTZERSAPO, "Table", "Desc");
   ...
   // Create Attributes
   if ( zwTZERSAPD_CreateAttribAndIdent( vSubtask, vERD, vTZERSAPO,
                                         szTableName ) < 0 )
      return( -1 );
                            ...
                            zPVIEW  vERD )
{
   ...
   SetAttributeFromAttribute( *vERD, "EntpER_Model", "Name",
                              vTaskLPLR, "LPLR", "Name" );
   ...
   SetTitleWithCheckOutState( vERD_Window, "Data Model", "TZEREMDO", *vERD,
...
zwTZERSAPD_ExistStandardDomain( zVIEW vSubtask )
{
   ...
   if ( SetCursorFirstEntityByString( vDomainList, "W_MetaDef", "Name",
                                      "AlphaNumeric", "" ) < zCURSOR_SET )
   {
      bError = TRUE;
      zstrcpy( szDomainName, "AlphaNumeric" );
   }
   ...
   if ( bError )
   {
      zstrcpy( szMsg, "Import aborted, because Domain '" );
      zstrcat( szMsg, szDomainName );
      zstrcat( szMsg, "' does not exist. " );
                               ...
                               zSHORT  nReasonOfAbort )
{
   ...
   if ( CompareAttributeToString( vTZERSAPO, "SapEnvironment",
                                  "ImportFlags", zBuild_Tables ) == 0 )
   {
      if ( nReasonOfAbort == zAbortImport )
         bWriteMsg = FALSE;
      else
         zstrcpy( szMsg, "Import Tables completed with Errors." );
   }
   else
   if ( CompareAttributeToString( vTZERSAPO, "SapEnvironment",
                                  "ImportFlags", zBuild_RS_TE ) == 0 )
   {
      if ( nReasonOfAbort == zAbortBuild )
         zstrcpy( szMsg, "Cancel Build Relationships and TE." );
      else
         zstrcpy( szMsg, "TE not built." );
   }
   else
   if ( CompareAttributeToString( vTZERSAPO, "SapEnvironment",
                                  "ImportFlags", zBuild_TE_only ) == 0 )
   {
      if ( nReasonOfAbort == zAbortBuild )
         zstrcpy( szMsg, "Cancel Build TE." );
      else
         zstrcpy( szMsg, "TE not built." );
   }
   else
   {
      ...
      if ( nReasonOfAbort == zAbortImportBuild )
         zstrcpy( szMsg, "Cancel Import Tables, Build Relationships and TE." );
      else
      {
         zstrcpy( szMsg, "Relationships and TE was not build, " );
         zstrcat( szMsg, "because of Errors during Table Import." );
      }
   }
                          ...
                          zSHORT nRC )
{
   ...
   if ( SetCursorFirstEntityByInteger( vTZSAPERR, "ErrorMsg", "Error",
                                       1, "" ) >= zCURSOR_SET )
   {
      bShowErrorList = TRUE;
   ...
   if ( CompareAttributeToString( vTZSAPERR, "Import", "ShowErrorList",
                                  "Y" ) == 0 )
   {
      bShowErrorList = TRUE;
   }
   ...
   if ( bShowErrorList )
   {
      SetWindowActionBehavior( vSubtask, zWAB_ProcessImmediateAction |
                               zWAB_StartOrFocusModelessWindow,
                               "TZERSAPD", "ErrorList" );
                           ...
                           zSHORT  nIcon )
{
   ...
   if ( zstrcmp( szBuildFlag, zBuild_Tables ) == 0 )
      zstrcpy( szMsg, "Import Tables completed " );
   else
   if ( zstrcmp( szBuildFlag, zBuild_RS_TE ) == 0 )
      zstrcpy( szMsg, "Build Relationships and TE \ncompleted " );
   else
   if ( zstrcmp( szBuildFlag, zBuild_Tables_RS_TE ) == 0 )
      zstrcpy( szMsg, "Import Tables, Build Relationships and TE \ncompleted " );
   else
   if ( zstrcmp( szBuildFlag, zBuild_TE_only ) == 0 )
      zstrcpy( szMsg, "Build TE only completed " );

   zstrcat( szMsg, szSubMsg );
   zstrcat( szMsg, "." );
                             ...
                             zVIEW vTZERSAPO )
{
   ...
   zstrcpy( szMsg, "Build Relationships and TE will cause \n" );
   zstrcat( szMsg, "the ERD and the TE to be saved. \n\n" );
   zstrcat( szMsg, "Do you want to continue?" );
                              ...
                              zSHORT  nAllTables )
{
   ...
   if ( zwTZERSAPD_Build_AskForSave( vSubtask, vTZERSAPO ) < 0 )
   {
      ...
      zwTZERSAPD_RefreshAllWindows( vSubtask, vTZERSAPO, vTZSAPERR,
                                    zAbortImportBuild );
      return( 0 );
   }
   ...
   if ( SetCursorFirstEntityByInteger( vTZSAPERR, "ErrorMsg", "Error", 1,
                                       "" ) < zCURSOR_SET )
   {
      MB_SetMessage( vSubtask, 0, "Import Tables completed successfully" );
      // if Option Import Tables, Build Relationships and TE active?
      if ( CompareAttributeToString( vTZERSAPO, "SapEnvironment", "ImportFlags",
                                     zBuild_Tables_RS_TE ) == 0 )
      {
         // Build Relationships and TE
         nRC = zwTZERSAPD_Build_SAP_RS_TE( vSubtask, vERD );
         if ( nRC < 0 )
            fnTZERSAPD_SendMessageBox( vSubtask, zBuild_Tables_RS_TE,
                                       "with Errors", zICON_ERROR );
         else
            fnTZERSAPD_SendMessageBox( vSubtask, zBuild_Tables_RS_TE,
                                       "successfully", zICON_INFORMATION );
      }
      else
         fnTZERSAPD_SendMessageBox( vSubtask, zBuild_Tables, "successfully",
                                    zICON_INFORMATION );
   }
...
zwTZERSAPD_DeleteAll_SAP_Rels( zVIEW vERD )
{
   ...
   {
      if ( CompareAttributeToInteger( vERD, "ER_Entity_2", "SAP_Entity",
                                      1 ) == 0 )
      {
         SetCursorFirstEntityByEntityCsr( vERD, "ER_Entity",
                                          vERD, "ER_Entity_2", "" );
         SetCursorFirstEntityByEntityCsr( vERD, "ER_RelLink",
                                          vERD, "ER_RelLink_2", "" );
         if ( CompareAttributeToInteger( vERD, "ER_Entity_Other", "SAP_Entity",
                                         1 ) == 0 )
         {
                             ...
                             zLONG   lIndex )
{
   ...
   zstrcpy( szMsg, "Build Relationships,  from Entity: " );
   zstrcat( szMsg, szTableName );
   zstrcat( szMsg, ",  to Entity: " );
   zstrcat( szMsg, szFK_TableName );
   MB_SetMessage( vSubtask, 0, szMsg );
                                ...
                                zPCHAR  szCardLeft )
{
   ...
   nRC = IncludeSubobjectFromSubobject( vERD, "ER_Entity_2",
                                        vERD, "ER_Entity", zPOS_AFTER );
                               ...
                               zPCHAR  szCard )
{
   ...
   nRC = IncludeSubobjectFromSubobject( vERD, "ER_Entity_2",
                                        vERD_Copy, "ER_Entity", zPOS_AFTER );
                            ...
                            zPCHAR szFK_FieldName )
{
   ...
   if ( SetCursorFirstEntityByString( vERD, "ER_Attribute", "TE_ColumnName",
                                      szFK_FieldName, "" ) >= zCURSOR_SET &&
        CompareAttributeToInteger( vERD, "ER_Attribute", "SAP_Attribute",
                                   1 ) == 0 )
   {
                           ...
                           zPCHAR szFK_FieldName )
{
   ...
   zstrncat( szName, szFK_FieldName, 28 );
   _strlwr( szName );
   zstrcpy( szMsg, "Automatically imported as Target of a Key Relationship '" );
   ...
   // Create Attributes
   if ( zwTZERSAPD_CreateAttribAndIdent( vSubtask, *pvERD, vTZERSAPO,
                                         szFK_TableName ) < 0 )
      return( -1 );
                          ...
                          zCHAR   cKey )
{
   ...
   // Create First RelLink and include ER_Entity
   fnTZERSAPD_CreateFirstRelLink( vSubtask, vERD, vERD_Copy,
                                  szFK_FieldName, szCard );
   SetAttributeFromAttribute( vTZSapRel, "SAP_Rel", "ZKey",
                              vERD, "ER_RelLink_2", "ZKey" );

   // if Relationship a Key, craete new ER_FactType
   if ( cKey == 'X' )
      lRC = zwTZERSAPD_CreateIdentifier( vSubtask, vERD,
                                         szTableName, zRelLinkID );
                               ...
                               zLONG          lIndex )
{
   ...
   lRC = (*pfnGetRel) ( hRelList, lIndex, szFK_FieldName, szFK_TableName,
                        szFK_Type, szCardLeft, szCard, szDesc, &cKey );
   if ( lRC < 0 )
   {
   ...
   // Set DIL Message
   fnTZERSAPD_SAP_RelSetDilMsg( vSubtask, szTableName, szFK_TableName,
                                szCountRel, lIndex );

   // if Relationship a Key Relationship and the related Entity is not in
   // ERD, import the SAP Table automatically
   if ( cKey == 'X'  &&
        SetCursorFirstEntityByString( vERD_Copy, "ER_Entity", "TE_TableName",
                                      szFK_TableName, "" ) < zCURSOR_SET )
   {
      if ( fnTZERSAPD_EntityForKeyRS( vSubtask, &vERD, szFK_TableName,
                                      szTableName, szFK_FieldName ) < 0 )
         return( -1 );
   }

   lRC = 0;
   // Exists related Entity in Data Model as SAP Entity?
   if ( SetCursorFirstEntityByString( vERD_Copy, "ER_Entity", "TE_TableName",
                                      szFK_TableName, "" ) >= zCURSOR_SET &&
        CompareAttributeToInteger( vERD_Copy, "ER_Entity", "SAP_Entity",
                                   1 ) == 0 )
   {
      ...
      {
         lRC = fnTZERSAPD_CreateERD_Rel( vSubtask, vTZSapRel, vERD,
                                         vERD_Copy, szTableName,
                                         szFK_FieldName, szFK_Type, szCard,
                                         szCardLeft, cKey );
      }
   }
                                ...
                                zLONG          lIndex )
{
   ...
   zstrcpy( szWorkName, szTableName );
   zstrcat( szWorkName, " " );
   zstrcat( szWorkName, szFK_TableName );

   CreateViewFromViewForTask( &vTZERSAPO_Copy, vTZERSAPO, 0 );

   if ( SetCursorFirstEntityByString( vTZERSAPO_Copy, "Table", "WorkName",
                                      szWorkName, "" ) < zCURSOR_SET )
   {
      CreateEntity( vTZERSAPO, "Table", zPOS_AFTER );
      ...
      if ( cKey == 'X' )
         zstrcpy( szIndentName, "      * " );
      else
         zstrcpy( szIndentName, "         " );

      zstrcat( szIndentName, szFK_TableName );
                               ...
                               zSHORT nCreateRelatedEntity )
{
   ...
   pfnGetRelList = (pfnSapGetRelList) SysGetProc( hLibrary,
                                                  "ZSAP_GetRelationshipList" );
   if ( pfnGetRelList == 0 )
   ...
   {
      GetStringFromAttribute( szLanguage, vView, "SapEnvironment", "LanguageType" );
      cLanguage = szLanguage[ 0 ];
   }
   else
      cLanguage = 0;
   ...
   zltoa( lCountRel, szCountRel );
   CreateViewFromViewForTask( &vView_Copy, vView, 0 );
   for ( k = 0; k < lCountRel; k++ )
   {
      if ( nCreateRelatedEntity == zBuildRelatedEntity )
         nRC = fnTZERSAPD_CreateRelatedEntity( vSubtask, vView, szTableName,
                                               szCountRel, pfnGetRel,
                                               hRelList, k );
      else
         nRC = fnTZERSAPD_CreateRelationship( vSubtask, vView, vView_Copy,
                                              szTableName, szCountRel,
                                              pfnGetRel, hRelList, k );
      if ( nRC < 0 )
      {
         break;
      }
                         ...
                         zVIEW  vTZSapRel )
{
   ...
   for ( nRC = SetCursorFirstEntityByInteger( vERD, "ER_Entity", "SAP_Entity",
                                              1, "" );
         nRC >= zCURSOR_SET;
         nRC = SetCursorNextEntityByInteger( vERD, "ER_Entity", "SAP_Entity",
                                             1, "" ) )
   {
      GetStringFromAttribute( szTableName, vERD, "ER_Entity", "TE_TableName" );
      ...
      if ( zwTZERSAPD_CreateRelationship( vSubtask, vERD, szTableName,
                                          zBuildRelationship ) < 0 )
      {
         nError = 1;
         break;
      }
         ...
         nRC = SetCursorNextEntity( vERD, "ER_RelLink", "EntpER_Model" ) )
   {
      ...
      {
         SetCursorFirstEntityByAttr( vERD, "ER_RelLink_2", "ZKey",
                                     vERD, "ER_RelLink", "ZKey", "EntpER_Model" );
         ...
         IncludeSubobjectFromSubobject( vERD, "ER_RelLink_Other",
                                        vERD, "ER_RelLink_2", zPOS_AFTER );
                             ...
                             zVIEW  vTZTEDBLO )
{
   ...
   SetCursorFirstEntityByString( vTZTEDBLO, "TE_DBMS_Source", "SironDB_Type",
                                 "S", "" );

   // Delete all SAP Data Sources
   for ( nRC = SetCursorFirstEntityByString( vDTE, "TE_DBMS_Source",
                                             "SironDB_Type", "S", "" );
         nRC >= zCURSOR_SET;
         nRC = SetCursorNextEntityByString( vDTE, "TE_DBMS_Source",
                                            "SironDB_Type", "S", "" ) )
   {
                       ...
                       zVIEW  vERD )
{
   ...
   GetStringFromAttribute( szName, vCM_List, "W_MetaDef", "Name" );
   zstrcat( szFileName, szName );
   zstrcat( szFileName, ".dte" );
                   ...
                   zPVIEW pvDTE )
{
   ...
   *pvDTE = 0;
   ...
   if ( CheckExistenceOfEntity( vCM_List, "W_MetaDef" ) < zCURSOR_SET )
   {
      GetStringFromAttribute( szName, vTaskLPLR, "LPLR", "Name" );
      ...
      SetAttributeFromString( vDTE, "TE_DB_Environ", "Desc",
                              "Create By SAP Import" );
   ...
   nRC = ActivateOI_FromFile( &vDTE, "TZTENVRO", vSubtask, szFileName,
...
//  switched off (old).
// vDTE_Copy1 is pointing to a TE_FieldDataRel which is the target of
//  the switch (new). It is implemented as an ER attribute.
static zSHORT
fnTZERSAPD_SwitchForeignToERAttr( zVIEW  vDTE,
                                  zVIEW  vDTE_SwitchTo )
{
   // the FK to be switched away should NOT be part of the key.
   ...
   if ( SetCursorFirstEntityByAttr( vDTE_SwitchTo, "ER_RelLink", "ZKey",
                                    vDTE, "ER_RelLink", "ZKey",
                                    "" ) < zCURSOR_SET )
   {
      IncludeSubobjectFromSubobject( vDTE_SwitchTo, "ER_RelLink",
...
// vDTE_ERA is pointing to a an ER attribute (TE_FileDataRel) which is to
//  be turned to a foreign key. It should have the Base Key of the
//  current FK (pointed to by vDTE_FK ).
...
SetBaseKeyAs_PK( zVIEW vDTE_ERA, zVIEW vDTE_FK )
{
   ...
   if ( nRC < zCURSOR_SET )
   {
      ...
      IncludeSubobjectFromSubobject( vDTE2, "TE_FieldDataRelAsFK",
                                     vDTE_ERA, "TE_FieldDataRel", zPOS_AFTER );
   }
                                 ...
                                 zLONG  lCurrentZKey )
{
   ...
   nRC = SetCursorFirstEntityByInteger( vDTE_ER, "TE_FieldDataRel", "ZKey",
                                        lCurrentZKey, "TE_DBMS_Source" );

   if ( nRC >= zCURSOR_SET &&
        CheckExistenceOfEntity( vDTE_ER, "ER_Attribute" ) >= zCURSOR_SET &&
        SetCursorFirstEntityByAttr( vTZSapRel, "SAP_Enitiy", "TE_TableName",
                                    vDTE, "TE_TablRec", "Name",
                                    "" ) >= zCURSOR_SET &&
        SetCursorFirstEntityByAttr( vTZSapRel, "SAP_Rel", "ZKey",
                                    vDTE, "ER_RelLink", "ZKey",
                                    "" ) >= zCURSOR_SET )

   {
      SetAttributeFromAttribute( vDTE, "TE_FieldDataRel", "Name",
                                 vTZSapRel, "SAP_Rel", "FieldName" );
                              ...
                              zPCHAR szFieldName )
{
   ...
   nRC = SetCursorFirstEntityByString( vDTE_FieldDataRel, "TE_FieldDataRel", "Name",
                                       szFieldName, "" );
   if ( nRC >= zCURSOR_SET &&
        CompareAttributeToAttribute( vDTE_FieldDataRel, "TE_FieldDataRel", "ZKey",
                                     vDTE, "TE_FieldDataRel", "ZKey" ) == 0 )
   {
      nRC = SetCursorNextEntityByString( vDTE_FieldDataRel, "TE_FieldDataRel", "Name",
                                         szFieldName, "" );
   }
                          ...
                          zPCHAR szCheckTable )
{
   ...
   while ( bSwitchFK && nRC >= zCURSOR_SET )
   {
      ...
      if ( CompareAttributeToString( vTZSapRel, "SAP_Rel", "FK_Art", "" ) == 0 )
      {
         ...
         GetStringFromAttribute( szFieldName, vTZSapRel, "SAP_Rel", "FieldName" );
         nRC = fnTZERSAPD_CheckExistsOfName( vDTE, vDTE_FieldDataRel, vTZSapRel,
                                             szFieldName );
         if ( nRC < zCURSOR_SET )
         {
      ...
      nRC = SetCursorNextEntityByString( vTZSapRel, "SAP_Rel", "CheckTable",
                                         szCheckTable, "" );
                              ...
                              zVIEW  vTZSapRel )
{
         ...
         nRC = SetCursorNextEntity( vDTE, "TE_FieldDataRel_PK", "TE_DBMS_Source" ) )
   {
      ...
      if ( CheckExistenceOfEntity( vDTE_BaseKey, "ER_Attribute" ) >= zCURSOR_SET )
      {
         ...
         GetStringFromAttribute( szCheckTable, vDTE_BaseKey, "TE_TablRec", "Name" );
         GetStringFromAttribute( szBaseKeyName, vDTE_BaseKey, "TE_FieldDataRel", "Name" );

         // Position Root of Relationship-Workobject to the current table.
         if ( SetCursorFirstEntityByAttr( vTZSapRel, "SAP_Enitiy", "TE_TableName",
                                         vDTE, "TE_TablRec", "Name",
                                         "" ) >= zCURSOR_SET )
         {
         ...
         if ( bSwitchFK )
         {
            ...
            if ( SetCursorFirstEntityByInteger( vDTE_SwitchTo, "TE_FieldDataRel_PK", "ZKey",
                                                lBaseZKey, "TE_TablRec" ) >= zCURSOR_SET )
            {
            ...
            else
            {
                       ...
                       szBaseKeyName, "TE_TablRec" ) >= zCURSOR_SET )
               {
                  ...
                  zstrcpy( szMsg, "ER Attribute '" );
                  zstrcat( szMsg, szBaseKeyName );
                  zstrcat( szMsg, "' used as Foreign Key." );
                  zwTZERSAPD_WriteErrorMsg( vDTE, zBuildTE, szMsg, 0 );
               }
               else
               {
                  // now, we see no more way to get around the error.
                  GetStringFromAttribute( szCheckTable, vDTE, "ER_RelLink", "Name" );
                  zstrcpy( szMsg, "Internal TE build error. Missing Foreign Key for ");
                  zstrcat( szMsg, "Relationship '" );
                  zstrcat( szMsg, szCheckTable );
                  zstrcat( szMsg, "'." );
   ...
   if ( GetViewByName( &vTZTEERR, "TZTEERR", vSubtask, zLEVEL_TASK ) >= 0 )
   {
      if ( CheckExistenceOfEntity( vTZTEERR, "ErrorMsg" ) >= zCURSOR_SET )
      {
               ...
               nRC = SetCursorNextEntity( vTZTEERR, "ErrorMsg", "" ) )
         {
            ...
            zstrcpy( szMsgText, "Error:   " );
            GetStringFromAttribute( szMsg, vTZTEERR, "ErrorMsg", "MessageText" );
            zstrcat( szMsgText, szMsg );
            SetAttributeFromString( vTZSAPERR, "ErrorMsg", "ErrorText", szMsgText );
            SetAttributeFromAttribute( vTZSAPERR, "ErrorMsg", "EntityName",
                                       vTZTEERR, "ErrorMsg", "EntityName" );
            SetAttributeFromInteger( vTZSAPERR, "ErrorMsg", "Error", 1 );
         }

         if ( GetSubtaskForWindowName( vSubtask, &vWindow, "ErrorList" ) >= 0 &&
              CompareAttributeToString( vTZSAPERR, "Import", "ShowErrorList",
                                        "Y" ) == 0 )
         {
            zwTZERSAPD_RefreshErrorList( vWindow );
         }
                         ...
                         zVIEW  vTZSapRel )
{
   ...
   nRC = oTZTENVRO_BuildTablRecsFromEMD( vSubtask, vDTE,
                                         vERD, "TE_DBMS_Source" );
                            ...
                            zVIEW  vERD )
{
   ...
   if ( nRC >= 0 &&
        ...
        SetCursorFirstEntityByInteger( vTZSAPERR, "ErrorMsg", "Error", 1,
                                       "" ) >= zCURSOR_SET )
   {
      nRC = -1;
   }
...
zwTZERSAPD_BuildRelationships_TE( zVIEW vSubtask )
{
   ...
   nRC = zwTZERSAPD_Build_SAP_RS_TE( vSubtask, vERD );
   if ( nRC < 0 )
      fnTZERSAPD_SendMessageBox( vSubtask, zBuild_RS_TE,
                                 "with Errors", zICON_ERROR );
   else
      fnTZERSAPD_SendMessageBox( vSubtask, zBuild_RS_TE,
                                 "successfully", zICON_INFORMATION );
...
zwTZERSAPD_ImportAllTables( zVIEW vSubtask )
{
   ...
   if ( zwTZERSAPD_Import_SAP_Tables( vSubtask, vTZERSAPO,
                                      zImportAllTables ) < 0 )
      return( -1 );
...
zwTZERSAPD_ImportTables( zVIEW vSubtask )
{
   ...
   // if Table selected?
   if ( SetCursorFirstSelectedEntity( vTZERSAPO, "Table",
                                      "" ) < zCURSOR_SET )
   {
...
zwTZERSAPD_SetCtrlStateForImport( zVIEW vSubtask )
{
   ...
   if ( SetFocusToCtrl( vSubtask, "rbGerman" ) >= 0 )
   {
      ...
      {
         CreateViewFromViewForTask( &vERD_Copy, vERD, 0 );
         if ( SetCursorFirstEntityByInteger( vERD_Copy, "ER_Entity",
                                             "SAP_Entity", 1, "" ) < zCURSOR_SET )
         {
            nEnable = 0;
         }
         DropView( vERD_Copy );
      ...
      SetCtrlState( vSubtask, "rbBuildRelsAndTE",
                    zCONTROL_STATUS_ENABLED, nEnable );
   }
...
zwTZERSAPD_SetCountError( zVIEW vSubtask )
{
   ...
   if ( CheckExistenceOfEntity( vTZSAPERR, "Import" ) >= zCURSOR_SET )
   {
      ...
      {
         if ( CompareAttributeToInteger( vTZSAPERR, "ErrorMsg", "Error",
                                         1 ) == 0 )
            lCountError++;
         else
            lCountWarning++;
...
zwTZERSAPD_CreateNewErrorRoot( zVIEW vSubtask )
{
   ...
   SetAttributeFromString( vTZSAPERR, "Import", "SearchDateTime",
                           szCurrentDateTime );
   SetAttributeFromAttribute( vTZSAPERR, "Import", "ShowErrorList",
                              vTZERSAPO, "SapEnvironment", "ShowErrorList" );
...
zwTZERSAPD_ErrorListSaveToFile( zVIEW vSubtask )
{
                               ...
                               "Text Files (*.txt)|*.txt|", "txt", ulZFlags ) == 1 )
   {
      ...
      zstrcpy( szMsg, "Zeidon:  SAP Import Error List from " );
      GetStringFromAttributeByContext( szTemp, vTZSAPERR, "Import",
                                       "SearchDateTime", "DD.MM.YYYY HH:MM:SS",
                                       20 );
      ...
      for ( nRC = SetCursorFirstEntity( vTZSAPERR, "ErrorMsg", "" );
            ...
            nRC = SetCursorNextEntity( vTZSAPERR, "ErrorMsg", "" ) )
      {
         GetStringFromAttribute( szTemp, vTZSAPERR, "ErrorMsg", "EntityName" );
         if ( zstrcmp( szTemp, "" ) != 0 )
         {
         ...
         zstrcat( szMsg, "\t" );
         GetStringFromAttribute( szTemp, vTZSAPERR, "ErrorMsg", "ErrorText" );
         zstrcat( szMsg, szTemp );
         SysWriteLine( vSubtask, FileHandle, szMsg );
      }
...
fnTZERSAPD_RemoveTablesFromList( zVIEW  vTZERSAPO )
{
   ...
   SetMatchingAttributesByName( vTZERSAPO, "RemovedTable",
                                vTZERSAPO, "Table", zSET_NULL );
...
zwTZERSAPD_RemoveTablesFromList( zVIEW vSubtask )
{
         ...
         nRC = SetCursorNextSelectedEntity( vTZERSAPO, "Table", "" ) )
   {
      ...
      if ( CompareAttributeToInteger( vTZERSAPO, "Table", "IndentLvl",
                                      0 ) == 0 )
      {
         GetStringFromAttribute( szTableName, vTZERSAPO, "Table", "ParentName" );
         for ( nRC = SetCursorFirstEntityByString( vTZERSAPO, "Table", "ParentName",
                                                   szTableName, "" );
               nRC >= zCURSOR_SET;
               nRC = SetCursorNextEntityByString( vTZERSAPO, "Table", "ParentName",
                                                  szTableName, "" ) )
         {
                              ...
                              zVIEW vTZERSAPO )
{
                                   ...
                                   0 ) == 0 )
   {
      ...
      if ( SetCursorFirstEntityByString( vTZERSAPO, "RemovedTable", "ParentName",
                                         szTableName, "" ) >= zCURSOR_SET )
      {
         for ( nRC = SetCursorFirstEntityByString( vTZERSAPO, "RemovedTable",
                                                   "ParentName", szTableName, "" );
               nRC >= zCURSOR_SET;
               nRC = SetCursorNextEntityByString( vTZERSAPO, "RemovedTable",
                                                  "ParentName", szTableName, "" ) )
         {
            CreateEntity( vTZERSAPO, "Table", zPOS_AFTER );
            SetMatchingAttributesByName( vTZERSAPO, "Table",
                                         vTZERSAPO, "RemovedTable", zSET_NULL );
      ...
      {
         // LoadRelatedTables = 0 means, related Tables does not exists for this
         // SAP Tables or is loaded
         if ( CompareAttributeToInteger( vTZERSAPO, "Table", "LoadRelatedTables",
                                         1 ) == 0 )
         {
            // read related Table from SAP
            if ( zwTZERSAPD_CreateRelationship( vSubtask, vTZERSAPO, szTableName,
                                                zBuildRelatedEntity ) < 0 )
            {
               return( -1 );
            }
            SetAttributeFromInteger( vTZERSAPO, "Table", "LoadRelatedTables", 0 );
...
zwTZERSAPD_RemoveAllRelatedTabl( zVIEW vSubtask )
{
   ...
   for ( nRC = SetCursorFirstEntityByInteger( vTZERSAPO, "Table", "IndentLvl",
                                              1, "" );
         nRC >= zCURSOR_SET;
         nRC = SetCursorNextEntityByInteger( vTZERSAPO, "Table", "IndentLvl",
                                             1, "" ) )
   {
      fnTZERSAPD_RemoveTablesFromList( vTZERSAPO );
   }
   ...
   if ( SetCursorFirstEntityByString( vTZERSAPO, "Table", "TableName",
                                      szTableName, "" ) >= zCURSOR_SET )
   {
      SetSelectStateOfEntity( vTZERSAPO, "Table", 1 );
   }
                                  ...
                                  zVIEW  vTZERSAPO )
{
   ...
   for ( nRC = SetCursorFirstEntityByInteger( vTZERSAPO, "RemovedTable",
                                             "IndentLvl", 0, "" );
         nRC >= zCURSOR_SET;
         nRC = SetCursorNextEntityByInteger( vTZERSAPO, "RemovedTable",
                                            "IndentLvl", 0, "" ) )
   {
      CreateEntity( vTZERSAPO, "Table", zPOS_AFTER );
      SetMatchingAttributesByName( vTZERSAPO, "Table",
...
zwTZERSAPD_BuildTE_Only( zVIEW vSubtask )
{
   ...
   if ( nRC < 0 )
      fnTZERSAPD_SendMessageBox( vSubtask, zBuild_TE_only,
                                 "with Errors", zICON_ERROR );
   else
      fnTZERSAPD_SendMessageBox( vSubtask, zBuild_TE_only,
                                 "successfully", zICON_INFORMATION );
