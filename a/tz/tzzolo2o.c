                          ...
                          zPCHAR    szAddER_EntityFlag )
{
   ...
   { 
      ...
      GetStringFromAttribute( szTempString_3, OldRecursiveLOD, "ER_EntityRec", "Name" );
      ...
      { 
         ...
         { 
            ...
            { 
               ...
               GetStringFromAttribute( szTempString_3, SourceERD, "ER_AttributeIdentifier", "Name" );
   ...
   { 
      ...
      { 
         //:SET CURSOR FIRST NewERD.ER_Entity WHERE NewERD.ER_Entity.Name = OldRecursiveLOD.ER_EntityRec.Name
         GetStringFromAttribute( szTempString_8, OldRecursiveLOD, "ER_EntityRec", "Name" );
   ...
   { 
      ...
      { 
         ...
         GetStringFromAttribute( szTempString_8, OldRecursiveLOD, "ER_AttributeRec", "Name" );
         ...
         GetStringFromAttribute( szTempString_8, OldRecursiveLOD, "DB_ER_AttributeRec", "Name" );
   ...
   { 
      ...
      GetStringFromAttribute( szTempString_8, OldRecursiveLOD, "LOD_EntityConstraintOperRec", "Name" );
                                  ...
                                  zVIEW     vSubtask )
{
   ...
   GetStringFromAttribute( szTempString_0, OldRecursiveLOD, "DomainRec", "Name" );
         ...
         { 
            ...
            { 
               ...
               { 
                  ...
                  //:                   CurrentLPLR.LPLR.wFullyQualifiedFileName,
                  //:                   DomainName, vSubtask )
                  GetStringFromAttribute( szTempString_0, CurrentLPLR, "LPLR", "wFullyQualifiedFileName" );
                             ...
                             zVIEW     SourceLPLR )
{
   ...
   { 
      ...
      GetStringFromAttribute( SourceFileName2, DirLPLR, "LPLR", "PgmSrcDir" );
      ...
      { 
         ...
         GetStringFromAttribute( szTempString_0, OldMainLOD, "LOD_ConstraintOper", "Name" );
                              ...
                              zVIEW     vSubtask )
{
   ...
   { 
      ...
      { 
         ...
         GetStringFromAttribute( szTempString_0, vLOD, "Domain", "Name" );
                       ...
                       zVIEW     vSubtask )
{
   ...
   { 
      ...
      { 
         ...
         { 
            ...
            { 
               ...
               GetStringFromAttribute( SourceFileName, SourceLPLR2, "LPLR", "MetaSrcDir" );
               ZeidonStringConcat( SourceFileName, 1, 0, "\\", 1, 0, 514 );
      ...
      { 
         ...
         GetStringFromAttribute( szTempString_2, OldTE, "TE_DBMS_Source", "Name" );
   ...
   { 
      ...
      { 
         ...
         GetStringFromAttribute( szTempString_2, OldMainLOD, "SourceFile", "Name" );
         ...
         { 
            ...
            GetStringFromAttribute( TargetFileName, CurrentLPLR, "LPLR", "PgmSrcDir" );
         ...
         { 
            ...
            GetStringFromAttribute( szTempString_7, OldMainLOD, "Operation", "Name" );
            ...
            { 
               ...
               { 
                  ...
                  GetStringFromAttribute( szTempString_7, NewMainLOD, "Operation", "Name" );
      ...
      { 
         ...
         GetStringFromAttribute( szTempString_8, OldMainLOD, "LOD_ConstraintOper", "Name" );
         RESULT = SetCursorFirstEntityByString( NewMainLOD, "Operation", "Name", szTempString_8, "LOD" );
         //:IF RESULT >= zCURSOR_SET
         if ( RESULT >= zCURSOR_SET )
         { 
   ...
   { 
      ...
      { 
         ...
         GetStringFromAttribute( szTempString_10, SourceVOR_LPLR, "W_MetaDef", "Name" );
      ...
      { 
         ...
         { 
            ...
            { 
               ...
               GetStringFromAttribute( szTempString_0, vLOD, "ER_Entity", "Name" );
         ...
         { 
            ...
            { 
               ...
               { 
                  ...
                  GetStringFromAttribute( szTempString_0, vLOD, "ER_Attribute", "Name" );
   ...
   { 
      ...
      { 
         ...
         { 
            ...
            GetStringFromAttribute( szTempString_0, OldLOD, "TE_DBMS_SourceForEntity", "Name" );
                           ...
                           zPCHAR    szParentNames )
{
   ...
   { 
      ...
      { 
         ...
         GetStringFromAttribute( szTempString_0, SourceLOD, "LOD_EntityParent", "Name" );
   ...
   { 
      ...
      { 
         ...
         GetStringFromAttribute( szTempString_1, TargetLOD, "LOD_EntityParent", "Name" );
                                 ...
                                 zVIEW     SourceLOD )
{
   ...
   { 
      ...
      { 
         ...
         GetStringFromAttribute( szTempString_0, SourceLOD, "Operation", "Name" );
         ...
         { 
            ...
            { 
               ...
               GetStringFromAttribute( szTempString_1, SourceLOD, "Parameter", "ShortDesc" );
            ...
            { 
               ...
               GetStringFromAttribute( szTempString_1, TargetLOD, "Parameter", "ShortDesc" );
   ...
   { 
      ...
      { 
         ...
         GetStringFromAttribute( szTempString_0, TargetLOD, "Operation", "Name" );
                           ...
                           zVIEW     vSubtask )
{
   ...
   { 
      ...
      { 
         ...
         GetStringFromAttribute( szTempString_0, SourceLOD, "ER_AttributeRec", "Name" );
