                            ...
                            zVIEW     vSubtask )
{
   ...
   { 
      ...
      { 
         ...
         GetStringFromAttribute( szTempString_0, vReportDef, "Control", "Text" );
   ...
   { 
      ...
      { 
         ...
         RESULT = IncludeSubobjectFromSubobject( vReportDef, "ControlDef", vPE, "ControlDef", zPOS_AFTER );
         //:lTitleSize = GetStringLength( vReportDef.Control.Text )
         GetStringFromAttribute( szTempString_1, vReportDef, "Control", "Text" );
...
oTZRPSRCO_InitReportStructure( zVIEW     vReportDef )
{
   ...
   GetStringFromAttribute( szTempString_0, vReportDef, "DrivingLOD", "Name" );
   ...
   GetStringFromAttribute( szTempString_1, vReportDef, "DrivingLOD", "Name" );
                       ...
                       zVIEW     DialogWindow )
{
   ...
   GetStringFromAttribute( szDirectoryFileName, vTaskLPLR, "LPLR", "ExecDir" );
      ...
      { 
         ...
         { 
            ...
            case 2 :
               ...
               GetStringFromAttribute( szTempString_1, CurrentLPLR, "LPLR", "Name" );
                       ...
                       zVIEW     vSubtask )
{
   ...
   GetStringFromAttribute( szTempString_0, OrigRC, "ControlDef", "Tag" );
                      ...
                      zVIEW     vSubtask )
{
   ...
   { 
      ...
      GetStringFromAttribute( szTempString_0, OrigReport, "ViewObjRef", "Name" );
                              ...
                              zVIEW     vSubtask )
{
   ...
   { 
      ...
      { 
         ...
         GetStringFromAttribute( szTempString_3, vReport, "ViewObjRef", "Name" );
                         ...
                         zVIEW     vSubtask )
{
   ...
   { 
      ...
      GetStringFromAttribute( szTempString_0, CurrentLPLR, "LPLR", "PgmSrcDir" );
      GetStringFromAttribute( szTempString_1, CurrentLPLR, "LPLR", "ExecDir" );
      ...
      GetStringFromAttribute( SourceFileName1, SourceLPLR, "LPLR", "ExecDir" );
      ZeidonStringConcat( SourceFileName1, 1, 0, "\\", 1, 0, 514 );
      ZeidonStringConcat( SourceFileName1, 1, 0, SourceName, 1, 0, 514 );
      ZeidonStringConcat( SourceFileName1, 1, 0, ".XSQ", 1, 0, 514 );
      //:SourceFileName2 = CurrentLPLR.LPLR.ExecDir + "\" + SourceName + ".XSQ"
      GetStringFromAttribute( SourceFileName2, CurrentLPLR, "LPLR", "ExecDir" );
      ZeidonStringConcat( SourceFileName2, 1, 0, "\\", 1, 0, 514 );
      ZeidonStringConcat( SourceFileName2, 1, 0, SourceName, 1, 0, 514 );
      ...
      GetStringFromAttribute( szTempString_2, CurrentLPLR, "LPLR", "PgmSrcDir" );
      GetStringFromAttribute( szTempString_3, CurrentLPLR, "LPLR", "ExecDir" );
                                 ...
                                 zVIEW     vPE_Control )
{
   ...
   { 
      ...
      { 
         ...
         GetStringFromAttribute( szTempString_1, vUserSpec, "UIS_Entity", "HeaderText" );
         lTitleSize = GetStringLength( szTempString_1 );
         //:vReportDef.Control.SZDLG_X = lTitleSize * nCharacterWidth * 16
         lTempInteger_4 = lTitleSize * nCharacterWidth * 16;
         SetAttributeFromInteger( vReportDef, "Control", "SZDLG_X", lTempInteger_4 );
   ...
   { 
      ...
      { 
         ...
         SetAttributeFromInteger( vReportDef, "Control", "PSDLG_Y", lVerticalPos );
         //:lTitleSize = GetStringLength( vUserSpec.UIS_Entity.HeaderText )
         GetStringFromAttribute( szTempString_4, vUserSpec, "UIS_Entity", "HeaderText" );
   ...
   { 
      ...
      { 
         ...
         { 
            ...
            GetStringFromAttribute( szTempString_5, vUserSpec, "M_ER_Attribute", "PromptPaintLit" );
         ...
         { 
            ...
            GetStringFromAttribute( szTempString_6, vUserSpec, "M_ER_Attribute", "Name" );
   ...
   { 
      ...
      { 
         ...
         GetStringFromAttribute( szTempString_10, vUserSpec, "UIS_Entity", "FooterText" );
                               ...
                               zPCHAR    szPositionType )
{
   ...
   { 
      ...
      { 
         ...
         { 
            //:lTitleSize = GetStringLength( vUserSpec.M_ER_Attribute.Name )
            GetStringFromAttribute( szTempString_0, vUserSpec, "M_ER_Attribute", "Name" );
            lTitleSize = GetStringLength( szTempString_0 );
            //:ELSE
         } 
         else
         { 
            ...
            GetStringFromAttribute( szTempString_1, vUserSpec, "M_ER_Attribute", "ListPaintLit" );
            lTitleSize = GetStringLength( szTempString_1 );
         } 
