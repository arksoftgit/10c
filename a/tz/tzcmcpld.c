...
zwfnTZCMCPLD_ActivateREPO_Enqueue( zVIEW vSubtask )
{
   ...
   if ( nRC >= zCURSOR_SET )
   {
      ...
      zstrcat( szMsg, "). \n\n " );
      zstrcat( szMsg, "Respond YES to exit the dialog now.\n" );
      zstrcat( szMsg, "Responding NO will allow you into the dialog,\n" );
      zstrcat( szMsg, "however, any current enqueues will be deleted.\n" );
      zstrcat( szMsg, "            Exit Dialog Now?" );
...
zwTZCMCPLD_CheckLoginValues( zVIEW vSubtask )
{
   ...
   GetStringFromAttribute( szPassword, vTZCMWIPO, "ROOT", "Password" );
...
zwTZCMCPLD_CheckRepoEnqueue( zVIEW vSubtask )
{
   ...
   if ( nRC >= zCURSOR_SET )
   {
      ...
      if ( nRC >= zCURSOR_SET )
      {
         zstrcpy( szMsg, "Be careful, the repository was enqueued \non\t" );
         GetStringFromAttributeByContext( szDateEnqueue,
...
zwTZCMCPLD_DeleteCPL( zVIEW vSubtask )
{
   ...
   zstrcpy( szMsg, "OK to delete CPL '" );
...
zwTZCMCPLD_DeleteCPLR( zVIEW vSubtask )
{
   ...
   GetStringFromAttribute( szName, vTZCMCPRO, "CPLR", "Name" );
   zstrcpy( szMsg, "OK to delete CPLR '" );
   zstrcat( szMsg, szName );
   zstrcat( szMsg, "'?" );
...
zwTZCMCPLD_DeleteMetaFromListAll( zVIEW vSubtask )
{
         ...
         nRC = SetCursorNextSelectedEntity( vCPLR_AllMetas, "Z_MetaDef", 0 ) )
   {
      ...
      {
         GetStringFromAttribute( szName, vCPLR_AllMetas, "Z_MetaDef", "Name" );
         zstrcpy( szMsg, "Meta '" );
         zstrcat( szMsg, szName );
         zstrcat( szMsg, "' could not be deleted because it is checked out.\n" );
         zstrcat( szMsg, "Remove check out status before deleting." );
...
zwTZCMCPLD_DeleteMetaFromList( zVIEW vSubtask )
{
         ...
         nRC = SetCursorNextSelectedEntity( vCPLR_MetaList, "Z_MetaDef", 0 ) )
   {
      ...
      {
         GetStringFromAttribute( szName, vCPLR_MetaList, "Z_MetaDef", "Name" );
         zstrcpy( szMsg, "Meta '" );
         zstrcat( szMsg, szName );
         zstrcat( szMsg, "' could not be deleted because it is checked out.\n" );
         zstrcat( szMsg, "Remove check out status before deleting." );
...
zwTZCMCPLD_DeleteMeta( zVIEW vSubtask )
{
   ...
   GetStringFromAttribute( szName, vCPLR_AllMetas, "Z_MetaDef", "Name" );
   zstrcpy( szMsg, "OK to delete Component '");
   zstrcat( szMsg, szName );
   zstrcat( szMsg, "'?" );
...
zwTZCMCPLD_DeleteInstallUser( zVIEW    vSubtask )
{
   ...
   {
      zstrcpy( szMsg, "You cannot delete a User with current authority." );
   ...
   // Ask if delete is OK.
   GetStringFromAttribute( szUserName, vTZCMREPO, "User", "Name" );
   GetStringFromAttribute( szUserDesc, vTZCMREPO, "User", "Desc" );
   zstrcpy( szMsg, "OK to delete User '" );
   zstrcat( szMsg, szUserName );
   zstrcat( szMsg, " (" );
   zstrcat( szMsg, szUserDesc );
   zstrcat( szMsg, ")'?" );
...
zwTZCMCPLD_AddInstallUser( zVIEW vSubtask )
{
   ...
   GetStringFromAttribute( szPassword, vTZCMREPO, "User", "Password" );
...
zwTZCMCPLD_CPLR_OK( zVIEW vSubtask )
{
   ...
   GetStringFromAttribute( szCPLR_Name, vTZCMCPLR, "CPLR", "Name" );
...
zwTZCMCPLD_LoadUser( zVIEW    vSubtask )
{
   ...
   if ( nRC < 0 )
   {
      ...
      if ( GetIncrementalUpdateFlags( vTZCMREPO, "User", zSET_INCR_CREATED ) != 1 )
      {
         GetStringFromAttribute( szName, vTZCMREPO, "User", "Name" );
         zstrcpy( szERR_Msg, "Unable to Activate User '" );
         zstrcat( szERR_Msg, szName );
         zstrcat( szERR_Msg, "'." );
                          ...
                          zVIEW vMetaList, zSHORT nStatus, zLONG lCount, zLONG Type )
{
   ...
   if ( nStatus == 3 )
   {
      if ( CheckExistenceOfEntity( vTZCMCUSR, "User" ) == zCURSOR_SET )
         GetStringFromAttribute( szName, vTZCMCUSR, "User", "Name" );
      else
         return( lCount );
   }
   ...
   {
      lCount++;
      zltoa( lCount, &szMsg[ 110 ] );
      zstrcpy( szMsg, &szMsg[ 110 ] );
      zstrcat( szMsg, " of " );
      zltoa( lCountMetas, &szMsg[ 110 ] );
      zstrcat( szMsg, &szMsg[ 110 ] );
      ...
      if ( nStatus == 3 ) // Checked Out By User
      {
         ...
         {
            GetStringFromAttribute( szCO_Name, vAllMetas, "User", "Name" );
...
zwTZCMCPLD_RemoveReusableCPLR( zVIEW  vSubtask )
{
   ...
   zstrcpy( szMsg, "OK to remove CPLR '" );
   GetStringFromAttribute( szCPLR, vReusableCPLR, "CPLR", "Name" );
   zstrcat( szMsg, szCPLR );
   zstrcat( szMsg, "'?" );
                                       ...
                                       zSHORT nCheckType )
{
   ...
   GetStringFromAttribute( szCPLR_CPL_Name, vTZCMRCRO, "CPLR", "CPLR_CPL_Name" );
...
zwTZCMCPLD_ReusSetCountError( zVIEW vSubtask )
{
   ...
   if ( CheckExistenceOfEntity( vReusError, "ErrorMsg" ) >= zCURSOR_SET )
   {
      ...
      zltoa( lCount, szCount );
      zstrcpy( szControlText, "  " );
      zstrcat( szControlText, szCount );
      zstrcat( szControlText, " duplicate Component(s) found" );
   }
   else
   {
      zstrcpy( szControlText, "  No duplicate Component(s)" );
   }

   SetCtrlText( vSubtask, "txtCountError", szControlText );

   // Set ListBox Title and Textfield Text
   zstrcpy( szControlText, "Add Reusable CPLR:" );
   zstrcpy( szListBoxTitle, "CPLR to be reused" );

   if ( CheckExistenceOfEntity( vReusError, "ErrorList" ) >= zCURSOR_SET )
   {
      GetStringFromAttribute( szReusedBy, vReusError, "ErrorList", "CheckReusedBy" );
      if ( zstrcmp( szReusedBy, "Y" ) == 0 )
      {
         zstrcpy( szControlText, "Check reusing CPLR:" );
         zstrcpy( szListBoxTitle, "CPLR reusing the current one" );
      }
   }
                          ...
                          zVIEW vCurrentReusables, zVIEW vReusableToAdd )
{
   ...
   zstrcpy( szMsg, "CPLR reuse rejected because following Component " );
   zstrcat( szMsg, "is defined more than once:\n\n\t" );
   zstrcat( szMsg, szMetaType );

   if ( lMetaType == zSOURCE_ERD_META || lMetaType == zSOURCE_PENV_META )
   {
      zstrcpy( szMetaName, "" );
      zstrcat( szMsg, " exists " );
      zstrcat( szMsg, "\n\t\tin CPLR '" );
   }
   else
   {
   ...
   {
      GetStringFromAttribute( szTemp, vCurrentReusables, "CPLR", "Name" );
      zstrcat( szMsg, szTemp );
      zstrcat( szMsg, "' and \n\t\tin CPLR '" );
      GetStringFromAttribute( szTemp, vReusableToAdd, "CPLR", "Name" );
   }
   else
   {
      GetStringFromAttribute( szTemp, vReusableToAdd, "CPLR", "Name" );
   ...
   zstrcat( szMsg, szTemp );
   zstrcat( szMsg, "'.\n\n" );
   zstrcat( szMsg, "Would you like to continue to check duplicate Components?" );
}
                            ...
                            zBOOL bCheckAllMetas, zSHORT nCheckType )
{
   ...
   GetStringFromAttribute( szMetaName, vCurrentReusables, "Z_MetaDef", "Name" );
                                   ...
                                   zSHORT nCheckType )
{
   ...
   while ( nRC >= zCURSOR_SET )
   {
      GetStringFromAttribute( szName, vReusableToAdd, "Z_MetaDef", "Name" );
...
zwTZCMCPLD_RemoveCO_Status( zVIEW  vSubtask )
{
                                ...
                                == zCURSOR_SET )
   {
      ...
      {
         GetStringFromAttribute( szName, vCPLR_AllMetas, "Z_MetaDef", "Name" );
         zstrcpy( szMsg, "OK to Remove Check Out Status for '" );
         zstrcat( szMsg, szName );
         zstrcat( szMsg, "'?" );
...
zwTZCMCPLD_DeleteWorkstation( zVIEW  vSubtask )
{
   ...
   zstrcpy( szMsg, "OK to delete Workstation '" );
   GetStringFromAttribute( szZKey, vTZCMREPO, "RepositoryClient", "WKS_Id" );
   zstrcat( szMsg, szZKey );
   zstrcat( szMsg, "'?" );
   ...
   SetAttributeFromString( vKZDBHQUA, "QualAttrib", "AttributeName", "ZKey" );
   SetAttributeFromString( vKZDBHQUA, "QualAttrib", "Oper", "=" );
   GetStringFromAttribute( szZKey, vTZCMREPO, "RepositoryClient", "ZKey" );
   SetAttributeFromString( vKZDBHQUA, "QualAttrib", "Value", szZKey );
...
zwTZCMCPLD_BuildWS_UserList( zVIEW  vSubtask )
{
   ...
   if ( nRC < 0 )
   {
      GetStringFromAttribute( szWKS_Desc, vTZCMREPO, "RepositoryClient", "Desc" );
      zstrcpy( szERR_Msg, "Unable to Activate Workstation " );
      zstrcat( szERR_Msg, szWKS_Desc );
      zstrcat( szERR_Msg, "!" );
...
zwTZCMCPLD_SetDIL_Message( zVIEW vSubtask )
{
   ...
   if ( CheckExistenceOfEntity( vTZCMCPL, "CPL" ) == zCURSOR_SET )
   {
      GetStringFromAttribute( szWorkMessage,  vTZCMCPL, "CPL", "Desc" );
      MB_SetMessage( vSubtask, 1, szWorkMessage );
   }

   if ( CheckExistenceOfEntity( vTZCMCPL, "CPLR" ) == zCURSOR_SET )
   {
      GetStringFromAttribute( szWorkMessage,  vTZCMCPL, "CPLR", "Desc" );
      MB_SetMessage( vSubtask, 1, szWorkMessage );
   }
...
zwTZCMCPLD_DeleteFile( zVIEW vSubtask )
{
   ...
   GetStringFromAttribute( szName, vTZCMFILE, "File", "Name" );
   GetStringFromAttribute( szExtension, vTZCMFILE, "File", "Extension" );
   zstrcpy( szMsg,"W A R N I N G");
   zstrcat( szMsg, "\n\n You are going to delete a file from Repository \n'");
   zstrcat( szMsg, szName );
   zstrcat( szMsg, "." );
   zstrcat( szMsg, szExtension );
   zstrcat( szMsg, "'.\n\n" );
   zstrcat( szMsg, "This could  D E S T R O Y the Repository,\n" );
   zstrcat( szMsg, "if you do not fully understand what you are doing!" );
   zstrcat( szMsg, "\n\nContinue?" );
...
zwTZCMCPLD_CheckOutItems( zVIEW vSubtask )
{
   ...
   if ( nNewActivate == 1 )
   {
      ...
      if ( nRC < 0 )
      {
         GetStringFromAttribute( szWKS_Desc, vTZCMWKUS, "RepositoryClient", "Desc" );
         zstrcpy( szERR_Msg, "Unable to Activate Workstation " );
         zstrcat( szERR_Msg, szWKS_Desc );
         zstrcat( szERR_Msg, "!" );
         MessageSend( vSubtask, "CM00138", "Configuration Management",
...
zwTZCMCPLD_SaveAsSetCPLName( zVIEW vSubtask )
{
   ...
   if ( CheckExistenceOfEntity( vTZCMCPL, "CPL" ) >= zCURSOR_SET )
   {
      GetStringFromAttribute( szCPL_Name, vTZCMCPL, "CPL", "Name" );
...
zwTZCMCPLD_SaveAsCheckData( zVIEW vSubtask )
{
   ...
   GetStringFromAttribute( szNewName, vTZCMCPRO_New, "CPLR", "SaveAsName" );
                                  ...
                                  zVIEW vSubtask )
{
   ...
   while ( nRC == zCURSOR_SET )
   {
                      ...
                      vTZCMCPRO_Source, "User", "ZKey", 0 ) >= zCURSOR_SET )
      {
         ...
         zstrcpy( szMessage, "Copying Access Authority for User: " );
         GetStringFromAttribute( szName, vTZCMREPO, "User", "Name" );
         zstrcat( szMessage, szName );
                               ...
                               zVIEW vSubtask )
{
   ...
   while ( nRC == zCURSOR_SET )
   {
      ...
      {
         //Set DIL Message Text
         zstrcpy( szMessage, "Copying Reusable CPLR: " );
         GetStringFromAttribute( szName, vTZCMCPL, "CPLR", "Name" );
         zstrcat( szMessage, szName );
         MB_SetMessage( vSubtask, 1, szMessage );
                             ...
                             zPCHAR szExtension )
{
   ...
   zstrcpy( szMessage, "Error while copying File: " );
   zstrcat( szMessage, szName );
   zstrcat( szMessage, "." );
   zstrcat( szMessage, szExtension );
   zstrcat( szMessage, ".\n\n Save as aborted!" );
                               ...
                               zVIEW vTZCMCPRO_Source )
{
   ...
   GetIntegerFromAttribute( &lType, vTZCMCPRO_New, "Z_MetaDef", "Type" );
   GetStringFromAttribute( szName, vTZCMCPRO_New, "Z_MetaDef", "Name" );
   zstrcpy( szExtension, SRC_CMOD[ lType ].szOD_EXT + 1 );
   ...
   zstrcat( szTempName, szName );
   zstrcat( szTempName, ".tmp" );
                                 ...
                                 zVIEW   vSubtask )
{
   ...
   GetIntegerFromAttribute( (zPLONG) &ulZKey, vTZCMCPRO_Source,
                            "CPLR", "ZKey" );
   GetStringFromAttribute( szDateTime, vTZCMCPRO_Source,
                             ...
                             zVIEW vSubtask )
{
   ...
   while ( nRC == zCURSOR_SET )
   {
      ...
      {
         //Set DIL Message Text
         zstrcpy( szMessage, "Error while copying Audit Trail for Component: " );
         GetVariableFromAttribute( &szMessage[ 47 ], 0, zTYPE_STRING, 125,
                   vTZCMAUDO_New, "AuditTrailMeta", "MetaDefType", "CM_Type", 0 );
         zstrcat( szMessage, " " );
         GetStringFromAttribute( szName, vTZCMAUDO_New,
                                 "AuditTrailMeta", "MetaDefName" );
         zstrcat( szMessage, szName );
                       ...
                       zVIEW vSubtask )
{
   ...
   while ( nRC == zCURSOR_SET )
   {
      GetStringFromAttribute( szName, vTZCMCPRO_Source, "File", "Name" );
      GetStringFromAttribute( szExtension, vTZCMCPRO_Source, "File", "Extension" );
      ...
      if ( !bFound )
      {
         ...
         //Set DIL Message Text
         zstrcpy( szMessage, "Copying File: " );
         zstrcat( szMessage, szName );
         zstrcat( szMessage, "." );
         zstrcat( szMessage, szExtension );
         MB_SetMessage( vSubtask, 1, szMessage );
                   ...
                   zVIEW vTZCMCPRO_New )
{
   ...
   {
      GetStringFromAttribute( szName, vTZCMCPRO_New, "CPLR", "Name" );
      zstrcpy( szMessage, "Couldn't commit CPLR " );
      zstrcat( szMessage, szName );
      zstrcat( szMessage, "\n\n Save as aborted!" );
...
zwTZCMCPLD_SetCPLR_CPL_Name( zVIEW vSubtask )
{
   ...
   if ( GetViewByName( &vTZCMCPLR, "TZCMCPLR", vSubtask, zLEVEL_TASK ) > 0 )
   {
      GetStringFromAttribute( szName, vTZCMCPLR, "CPLR", "Name" );
   }
   else
   {
      zstrcpy( szName, "" );
   ...
   zstrcpy( szTitle, "CPLR: " );
   zstrcat( szTitle, szName );
   zstrcat( szTitle, ",  CPL: " );
   GetStringFromAttribute( szName, vTZCMCPL, "CPL", "Name" );
   zstrcat( szTitle, szName );
...
zwTZCMCPLD_SaveAsCPLR( zVIEW vSubtask )
{
   ...
   {
      GetStringFromAttribute( szOutName, vTZCMCPRO_Source, "CPLR", "Name" );
      zstrcpy( szMessage, "Unable to Activate CPLR " );
      zstrcat( szMessage, szOutName );
...
zwTZCMCPLD_Password_OK( zVIEW vSubtask )
{
   ...
   GetViewByName( &vTZCMREPO, "TZCMREPO", vSubtask, zLEVEL_TASK );
   GetStringFromAttribute( szPassword, vTZCMREPO, "Installation", "Password" );
...
zwfnTZCMCPLD_LoadMetas( zVIEW vSubtask, zVIEW vReusableCPLR )
{
   ...
   GetIntegerFromAttribute( (zPLONG) &ulZKey, vReusableCPLR, "CPLR", "ZKey" );
   GetStringFromAttribute( szName, vReusableCPLR, "CPLR", "Name" );

   zstrcpy( szMsg, "Activating Reusable CPLR " );
   zstrcat( szMsg, szName );
   MB_SetMessage( vSubtask, 0, szMsg );
         ...
         nRC = SetCursorNextEntity( vReusableComponents, "Z_MetaDef", "" ) )
   {
      ...
      GetStringFromAttributeByContext( &szMsg[ zstrlen( szMsg ) ],
                                       ...
                                       "CM_Type", 50 );
      zstrcat( szMsg, ": " );
      GetStringFromAttribute( szMetaName, vReusableComponents, "Z_MetaDef", "Name" );
      zstrcat( szMsg, szMetaName );
      MB_SetMessage( vSubtask, 0, szMsg );
...
zwfnTZCMCPLD_LoadCompForReusable( zVIEW vSubtask, zPCHAR szViewName, zBOOL bShowMetas )
{
   ...
   if ( bShowMetas )
   {
      if ( CheckExistenceOfEntity( vReusableCPLR, "Z_MetaType" ) < zCURSOR_SET )
      {
         ...
         zstrcpy( szMsg, "CPLR '" );
         zstrcat( szMsg, szName );
         zstrcat( szMsg, "' has no Components." );
         MessageSend( vSubtask, "CM00101", "Configuration Management",
...
zwfnTZCMCPLD_ReusableSetButtonText( zVIEW vSubtask, zPCHAR szViewName )
{
   ...
   if ( CheckExistenceOfEntity( vReusableCPLR, "Z_MetaType" ) >= zCURSOR_SET )
      zstrcpy( szButtonText, "Re&move Comp." );
   else
      zstrcpy( szButtonText, "&Components" );
...
zwfnTZCMCPLD_WriteErrorListTitle( zVIEW vReusError, zLONG  FileHandle )
{
   ...
   zstrcpy( szMsg, "Zeidon:  Error List from " );
   ...
   GetStringFromAttribute( szTemp, vReusError, "ErrorList", "ReusableCPLR_CPL_Name" );
   if ( zstrcmp( szReusedBy, "Y" ) == 0 )
   {
      zstrcpy( szMsg, "         Check reusing CPLR '" );
      zstrcat( szMsg, szTemp );
      zstrcat( szMsg, "'" );
   }
   else
   {
      zstrcpy( szMsg, "         Add Reusable CPLR '" );
      zstrcat( szMsg, szTemp );
      zstrcat( szMsg, "' to CPLR '" );
      GetStringFromAttribute( szTemp, vReusError, "CPLR", "Name" );
      zstrcat( szMsg, szTemp );
      zstrcat( szMsg, "'" );
   }
   ...
   zstrcpy( szMsg, "Meta Name:                         " );
   zstrcat( szMsg, "Meta Type:                      " );
   zstrcat( szMsg, "CPLR:                              " );
   if ( zstrcmp( szReusedBy, "Y" ) == 0 )
      zstrcat( szMsg, "CPLR reusing the current one:     " );
   else
      zstrcat( szMsg, "CPLR to be reused:                " );

   SysWriteLine( vReusError, FileHandle, szMsg );

   zstrcpy( szMsg, "___________________________________" );
   zstrcat( szMsg, "________________________________" );
   zstrcat( szMsg, "___________________________________" );
   zstrcat( szMsg, "__________________________________" );
   SysWriteLine( vReusError, FileHandle, szMsg );
   SysWriteLine( vReusError, FileHandle, "" );
}
...
zwfnTZCMCPLD_WriteErrorListToFile( zVIEW vReusError, zLONG  FileHandle )
{
   ...
   {
      GetStringFromAttribute( szTemp, vReusError, "ErrorMsg", "MetaName" );
      zstrcpy( szMsg, szTemp );
      ...
      zstrcat( szMsg, "  " );
      GetStringFromAttribute( szTemp, vReusError, "ErrorMsg", "CurrentCPLR" );
      if ( zstrcmp( szTemp, "" ) != 0 )
      {
         zstrcat( szMsg, szTemp );
         for ( i = zstrlen( szTemp ); i < 33; i++ )
      ...
      zstrcat( szMsg, "  " );
      GetStringFromAttribute( szTemp, vReusError, "ErrorMsg", "CPLR_ToBeReused" );
      if ( zstrcmp( szTemp, "" ) != 0 )
      {
         zstrcat( szMsg, szTemp );
         for ( i = zstrlen( szTemp ); i < 33; i++ )
