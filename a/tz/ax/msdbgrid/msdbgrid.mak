...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /GX /Od /I "$(KZD):\$(KZV)\w\incz" /I "$(KZD):\$(KZV)\w\incr" /I "$(KZD):\$(KZV)\a\incz" /I "$(KZD):\$(KZV)\a\incr" /I "$(KZD):\$(KZV)\a\zdr" /I "..\tzaxctl" /D "_AFXEXT" /D "_RELEASE" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "__WIN32__" /D "_WINDLL" /FR"$(INTDIR)\\" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c
...
CPP=cl.exe
CPP_PROJ=/nologo /MDd /W3 /GX /ZI /Od /I "c:\zocx\src" /I "$(KZD):\$(KZV)\w\incz" /I "$(KZD):\$(KZV)\w\incr" /I "$(KZD):\$(KZV)\a\incz" /I "$(KZD):\$(KZV)\a\incr" /I "$(KZD):\$(KZV)\a\zdr" /I "..\tzaxctl" /D "_AFXEXT" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "__WIN32__" /D "_WINDLL" /D "_AFXDLL" /FR"$(INTDIR)\\" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c
...
LINK32_FLAGS=ZdCtl.lib ZdrApp.lib kzoengaa.lib /nologo /dll /incremental:yes \
  ...
  /out:"..\..\..\..\w\bin\msdbgrid.dll" /implib:"..\..\..\..\w\libr\msdbgrid.lib" /pdbtype:sept \
