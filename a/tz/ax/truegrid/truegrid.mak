...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /GX /ZI /Od /I "$(KZD):\$(KZV)\w\incz" /I "$(KZD):\$(KZV)\w\incr" /I "$(KZD):\$(KZV)\a\incz" /I "$(KZD):\$(KZV)\a\incr" /I "$(KZD):\$(KZV)\a\zdr" /I "..\tzaxctl" /D "_RELEASE" /D "_WINDLL" /D "_USE_DATASET_" /D "_AFXEXT" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "__WIN32__" /D "zGRID_COMPILE" /D "TB_DROPDOWN_IMPLEMENT" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=ZdCtl.lib ZdrApp.lib kzoengaa.lib /nologo /dll /incremental:yes /pdb:"$(OUTDIR)\truegrid.pdb" /debug /machine:I386 /def:".\truegrid.def" /out:"..\..\..\..\w\bin\truegrid.dll" /implib:"..\..\..\..\w\libz/truegrid.lib" /pdbtype:con /libpath:"$(KZD):\$(KZV)\w\libz" /libpath:"$(KZD):\$(KZV)\w\libr" /libpath:".\release" 
DEF_FILE= \
	".\truegrid.def"
LINK32_OBJS= \
	"$(INTDIR)\tdbg6.obj" \
...
LINK32=link.exe
LINK32_FLAGS=ZdCtl.lib ZdrApp.lib kzoengaa.lib /nologo /dll /incremental:yes /pdb:"$(OUTDIR)\truegrid.pdb" /debug /machine:I386 /def:".\truegrid.def" /out:"..\..\..\..\w\bin\truegrid.dll" /implib:"..\..\..\..\w\libz/truegrid.lib" /pdbtype:sept /libpath:"$(KZD):\$(KZV)\w\libz" /libpath:"$(KZD):\$(KZV)\w\libr" /libpath:".\debug" 
DEF_FILE= \
	".\truegrid.def"
LINK32_OBJS= \
	"$(INTDIR)\tdbg6.obj" \
...
CPP_SWITCHES=/nologo /MD /W3 /GX /ZI /Od /I "$(KZD):\$(KZV)\w\incz" /I "$(KZD):\$(KZV)\w\incr" /I "$(KZD):\$(KZV)\a\incz" /I "$(KZD):\$(KZV)\a\incr" /I "$(KZD):\$(KZV)\a\zdr" /I "..\tzaxctl" /D "_RELEASE" /D "_WINDLL" /D "_USE_DATASET_" /D "_AFXEXT" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "__WIN32__" /D "zGRID_COMPILE" /D "TB_DROPDOWN_IMPLEMENT" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
CPP_SWITCHES=/nologo /MDd /W3 /GR /GX /ZI /Od /I "$(KZD):\$(KZV)\w\incz" /I "$(KZD):\$(KZV)\w\incr" /I "$(KZD):\$(KZV)\a\incz" /I "$(KZD):\$(KZV)\a\incr" /I "$(KZD):\$(KZV)\a\zdr" /I "..\tzaxctl" /D "_DEBUG" /D "_AFXEXT" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "__WIN32__" /D "zGRID_COMPILE" /D "TB_DROPDOWN_IMPLEMENT" /D "_NOANCHOR" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\truegrid.pch" /Yc"tdbg6.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
