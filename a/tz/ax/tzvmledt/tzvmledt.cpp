...
{
   zstrcpy( lpszFileName, m_strFileName );
}
...
ZVMLWrap::LoadLodDefinition( CString strObjectName )
{
   ...
   else
   {
      ...
      while( nRC >= zCURSOR_SET && bFound == FALSE )
      {
         ...
         GetStringFromAttribute( szLodName, vLOD_List, "W_MetaDef", "Name" );
      ...
      if ( bFound )
      {
         GetStringFromAttribute( szLodDesc, vLOD_List, "W_MetaDef", "Desc" );
         ...
         if ( nRC >= 0 )
         {
            ...
            while ( nRC == zCURSOR_SET )
            {
               ...
               GetStringFromAttribute( szEntityDesc, vLOD, "LOD_Entity", "Desc" );
               ...
               while ( nRC == zCURSOR_SET )
               {
                  ...
                  GetStringFromAttribute( szAttributeName, vLOD, "ER_Attribute", "Name" );
                  GetStringFromAttribute( szAttributeDesc, vLOD, "ER_Attribute", "Desc" );
...
ZVMLWrap::PopulateFunctions( LPDISPATCH ListCtrl )
{
   ...
   {
      char szFunc[255];
      GetStringFromAttribute( szFunc, vTZOPSIGK, "Operation", "Name" );
      COleVariant v;
