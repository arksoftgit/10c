...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /GX /ZI /Od /I "$(KZD):\$(KZV)\a\tz" /I "$(KZD):\$(KZV)\a\incr" /I "$(KZD):\$(KZV)\a\incz" /I "$(KZD):\$(KZV)\w\incr" /I "$(KZD):\$(KZV)\a\zdr" /D "_RELEASE" /D "_WINDLL" /D "_USE_DATASET_" /D "_AFXEXT" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "__WIN32__" /D "zGRID_COMPILE" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=tzlodopr.lib ZdCtl.lib ZdrApp.lib kzoengaa.lib tzvmpopr.lib tzvmlopr.lib /nologo /dll /incremental:yes /pdb:"$(OUTDIR)\tzvmledt.pdb" /debug /machine:I386 /def:".\tzvmledit.def" /out:"..\..\..\..\w\bin\tzvmledt.dll" /implib:"..\..\..\..\w\libz/tzvmledt.lib" /pdbtype:con /libpath:"$(KZD):\$(KZV)\w\libz" /libpath:"$(KZD):\$(KZV)\w\libr" /libpath:".\release" 
DEF_FILE= \
	".\tzvmledit.def"
LINK32_OBJS= \
	"$(INTDIR)\tzcswrpr.obj" \
...
CPP=cl.exe
CPP_PROJ=/nologo /MDd /W3 /GR /GX /ZI /Od /I "$(KZD):\$(KZV)\a\tz" /I "$(KZD):\$(KZV)\a\incr" /I "$(KZD):\$(KZV)\a\incz" /I "$(KZD):\$(KZV)\w\incr" /I "$(KZD):\$(KZV)\a\zdr" /D "_DEBUG" /D "_AFXEXT" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "__WIN32__" /D "zGRID_COMPILE" /D "_NOANCHOR" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\tzvmledt.pch" /YX"zstdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=tzlodopr.lib ZdCtl.lib ZdrApp.lib kzoengaa.lib tzvmpopr.lib tzvmlopr.lib /nologo /dll /incremental:yes /pdb:"$(OUTDIR)\tzvmledt.pdb" /debug /machine:I386 /def:".\tzvmledit.def" /out:"..\..\..\..\w\bin\tzvmledt.dll" /implib:"..\..\..\..\w\libz/tzvmledt.lib" /pdbtype:sept /libpath:"$(KZD):\$(KZV)\w\libz" /libpath:"$(KZD):\$(KZV)\w\libr" /libpath:".\debug" 
DEF_FILE= \
	".\tzvmledit.def"
LINK32_OBJS= \
	"$(INTDIR)\tzcswrpr.obj" \
