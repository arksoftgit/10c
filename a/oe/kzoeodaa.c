...
typedef ProcessInfoRecord zFAR *LPPROCESSINFO;
   ...
   switch ( *pchAttrName )
   {
      ...
      case 'D':
         if ( zstrcmp( pchAttrName, szlDFT_DBNAME ) == 0 )
         {
            ...
            if ( lpLName )
            {
               ...
               zstrcpy( lpViewOD->szDfltDBName, lpLName->szPName );
            }
            else
               zstrcpy( lpViewOD->szDfltDBName, lpProcessInfo->szLine );
         }
         else
         if ( zstrcmp( pchAttrName, szlDFT_SERVER ) == 0 )
         {
            ...
            if ( lpLName )
            {
               ...
               zstrcpy( lpViewOD->szDfltServer, lpLName->szPName );
            }
            else
               zstrcpy( lpViewOD->szDfltServer, lpProcessInfo->szLine );
         }
         else
      ...
      case 'E':
         if ( zstrcmp( pchAttrName, "ER_DATE" ) == 0 )
            zstrcpy( lpViewOD->szER_Date, lpProcessInfo->szLine );
         ...
         if ( zstrcmp( pchAttrName, szlGKHANDLER ) == 0 )
         {
            ...
            if ( lpGKHandler == 0 )
            {
               ...
               if ( lpGKHandler )
               {
                  ...
                  zstrcpy( lpGKHandler->szName, lpProcessInfo->szLine );
      ...
      case 'H':
         if ( zstrcmp( pchAttrName, szlHANDLER ) == 0 )
         {
            ...
            while ( lpDBHandler &&
                    zstrcmp( lpDBHandler->szName, lpProcessInfo->szLine ) != 0 )
            {
            ...
            if ( lpDBHandler == 0 )
            {
               ...
               if ( lpDBHandler )
               {
                  lpDBHandler->hNextDBHandler =
                                       lpProcessInfo->lpApp->hFirstDBHandler;
                  lpProcessInfo->lpApp->hFirstDBHandler = hndl;

                  zstrcpy( lpDBHandler->szName, lpProcessInfo->szLine );
      ...
      case 'N':
         if ( zstrcmp( pchAttrName, szlNAME ) == 0 )
            zstrcpy( lpViewOD->szName, lpProcessInfo->szLine );
         else
         if ( zstrcmp( pchAttrName, szlNETWORK ) == 0 )
            zstrcpy( lpViewOD->szNetwork, lpProcessInfo->szLine );
         else
      ...
      case 'O':
         ...
         if ( zstrcmp( pchAttrName, szlOPER_LIBNM ) == 0 )
            zstrcpy( lpViewOD->szOperLibname, lpProcessInfo->szLine );
         else
         if ( zstrcmp( pchAttrName, szlOCEOPER ) == 0 )
            zstrcpy( lpViewOD->szOCEOpername, lpProcessInfo->szLine );
         else
   ...
   switch ( pchAttrName[ 0 ] )
   {
      ...
      case 'D':
         if ( zstrcmp( pchAttrName, szlDBNAME ) == 0 )
         {
            if ( zstrcmp( lpViewOD->szDfltDBName, lpProcessInfo->szLine ) == 0 )
               zstrcpy( lpViewEntity->szDBName, lpViewOD->szDfltDBName );
            else
               zstrcpy( lpViewEntity->szDBName, lpProcessInfo->szLine );
         }
         else
      ...
      case 'E':
         ...
         if ( zstrcmp( pchAttrName, szlECEOPER ) == 0 )
            zstrcpy( lpViewEntity->szECEOpername, lpProcessInfo->szLine );
         else
      ...
      case 'N':
         if ( zstrcmp( pchAttrName, szlNAME ) == 0 )
            zstrcpy( lpViewEntity->szName, lpProcessInfo->szLine );
...
// "KZOEE063 - Entity attrib RECURSIVE Y, but not structurally recursive "
      ...
      case 'S':
         if ( zstrcmp( pchAttrName, szlSERVER ) == 0 )
         {
            if ( zstrcmp( lpViewOD->szDfltServer, lpProcessInfo->szLine ) == 0 )
               zstrcpy( lpViewEntity->szServer, lpViewOD->szDfltServer );
            else
               zstrcpy( lpViewEntity->szServer, lpProcessInfo->szLine );
         }
      ...
      case 'X':
         if ( zstrcmp( pchAttrName, "XML_NAME" ) == 0 )
            zstrcpy( lpViewEntity->szXML_Name, lpProcessInfo->szLine );
   ...
   switch ( pchAttrName[ 0 ] )
   {
            ...
            if ( lpDomain )
            {
               ...
               switch ( lpDomain->cType )
               {
                  ...
                  case zTYPE_BLOB:
                     ...
                     lpViewAttrib->ulLth = sizeof( zPCHAR ) +
                                          sizeof( zSHORT ) + sizeof( zCHAR );
                     break;
      ...
      case 'D':
         ...
         if ( zstrcmp( pchAttrName, szlDERIVEDF ) == 0 )
            zstrcpy( lpViewAttrib->szDerivedOper, lpProcessInfo->szLine );
         else
      ...
      case 'N':
         if ( zstrcmp( pchAttrName, szlNAME ) == 0 )
            zstrcpy( lpViewAttrib->szName, lpProcessInfo->szLine );
      ...
      case 'P':
         ...
         {
            if ( lpProcessInfo->bType ||
                 lpProcessInfo->bLth  ||
                 lpProcessInfo->bDomain )
            {
               LPTASK lpTask = zGETPTR( lpProcessInfo->lpView->hTask );
         ...
         if ( zstrcmp( pchAttrName, szlTYPE ) == 0 )
         {
            ...
            else
            {
               ...
               if ( lpDomain->cType != lpProcessInfo->szLine[ 0 ] )
               {
                  ...
                  zstrcpy( szTempMsg, lpViewOD->szName );
                  zstrcat( szTempMsg, ", " );
                  zstrcat( szTempMsg, lpViewEntity->szName );
      ...
      case 'X':
         if ( zstrcmp( pchAttrName, "XML_SIMPLE_NAME" ) == 0 )
            zstrcpy( lpViewAttrib->szXML_SimpleName, lpProcessInfo->szLine );
         else
         if ( zstrcmp( pchAttrName, "XML_NAME_EXTERNAL" ) == 0 )
            zstrcpy( lpViewAttrib->szXML_ExternalName, lpProcessInfo->szLine );
         else
   ...
   switch ( pchAttrName[ 0 ] )
   {
      ...
      case 'R':
         ...
         if ( zstrcmp( pchAttrName, szlRECNAME ) == 0 )
            zstrcpy( lpDataRecord->szRecordName, lpProcessInfo->szLine );
   ...
   switch ( pchAttrName[ 0 ] )
   {
      ...
      case 'F':
         ...
         if ( zstrcmp( pchAttrName, szlFLDNAME ) == 0 )
            zstrcpy( lpDataField->szFldName, lpProcessInfo->szLine );
         else
                          ...
                          LPPROCESSINFO lpProcessInfo )
{
   ...
   switch ( pchAttrName[ 0 ] )
   {
      ...
      case 'R':
         ...
         if ( zstrcmp( pchAttrName, szlRECNAME ) == 0 )
            zstrcpy( lpRelRecord->szRecordName, lpProcessInfo->szLine );
      ...
      case 'S':
         ...
         if ( zstrcmp( pchAttrName, szlSETNAME1 ) == 0 )
            zstrcpy( lpRelRecord->szSetName1, lpProcessInfo->szLine );
         else
         if ( zstrcmp( pchAttrName, szlSETNAME2 ) == 0 )
            zstrcpy( lpRelRecord->szSetName2, lpProcessInfo->szLine );
         break;
                         ...
                         LPPROCESSINFO lpProcessInfo )
{
   ...
   switch ( pchAttrName[ 0 ] )
   {
      ...
      case 'F':
         if ( zstrcmp( pchAttrName, szlFLDNAME ) == 0 )
            zstrcpy( lpRelField->szFldName, lpProcessInfo->szLine );
...
// }
   ...
   zstrcpy( ProcessInfo.szFileName, lpApp->szObjectDir );
   zstrcat( ProcessInfo.szFileName, cpcViewOD_Name );
   zstrcat( ProcessInfo.szFileName, szObjectSuffix );
   ...
   zstrlower( ProcessInfo.szFileName );
      ...
      if ( ProcessInfo.szLine[ 0 ] == 'e' )
      {
               ...
               zstrncmp( &ProcessInfo.szLine[ 1 ], szlENTITY, 6 ) == 0) )
         {
            ...
            else
            {
               ...
               SysParseLine( ProcessInfo.szAttrName, &ProcessInfo.szLine,
                             &ProcessInfo.szLine[ 1 ] );
                ...
                zBOOL   bSystemObject )
{
   ...
   if ( fnCheckIfViewOD_IsUsed( lpView, lpViewOD ) == zCALL_ERROR )
   {
      ...
      zsprintf( szMsg, "View referencing '%s' = ", lpViewOD->szName );
