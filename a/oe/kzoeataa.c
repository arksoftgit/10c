   ...
   else
   {
      switch ( lpViewAttribute->cType )
      {
         ...
         case zTYPE_INTEGER:
            ...
            *pulReturnLth = 0;
            if ( *(zPLONG) *(zPLONG zFAR *) lpReturnAddr == lNullInteger )
               nRC = -1;
            else
               nRC = 0;
         ...
         case zTYPE_DATETIME:
            ...
            *pulReturnLth = sizeof( DateTimeRecord );
            if ( fnCompareDateTimeToDateTime(
                           *((LPDTINTERNAL zFAR *) lpReturnAddr),
                          ...
                          zCPCHAR         cpcContextName )
{
   ...
   if ( nRC == 0 )
   {
      ...
      switch ( lpViewAttrib->cType )
      {
         ...
         {
            if ( ulMaxLth == 0 )
               zstrcpy( pchReturnString, pchPtr );
            else
            {
               pchReturnString[ 0 ] = 0;

               // DKS 1997.10.14: get string of correct length
               zstrncat( pchReturnString, pchPtr, (unsigned int) ulMaxLth - 1 );
//             pchReturnString[ ulMaxLth - 1 ] = 0;
         ...
         case zTYPE_INTEGER:
            if ( ulMaxLth == 0 )
               zltoa( *((zPLONG) pchPtr), pchReturnString );
            else
            {
               pchReturnString[ 0 ] = 0;
               zltoa( *((zPLONG) pchPtr), szTemp );
               zstrncat( pchReturnString, szTemp, (unsigned int) ulMaxLth - 1 );
            }
         ...
         case zTYPE_DECIMAL:
            if ( ulMaxLth == 0 )
            {
               ConvertDecimalToString( pchReturnString, lpViewAttrib,
                                       *((zPDECIMAL) pchPtr), 0 );
            }
            else
            {
         ...
         case zTYPE_DATETIME:
         {
            ...
            nRC = UfDateTimeToString( (LPDATETIME) pchPtr,
                                      pchReturnString, nTempLth );
            break;
         }
...
//
//  PURPOSE:    To retrieve a structure representing the persistent
//              attribute list
//
                          ...
                          zCPCHAR cpcEntityName )
{
   ...
   else
   {
...
#ifdef TRACE_STRUCT
      {
         ...
         TraceLine( "GetStructFromEntityAttrs Def: %s   Entity: %s",
                    cpcEntityName, lpViewOD->szName );
      }
#endif
         ...
         else
         {
            switch ( lpViewAttrib->cType )
            {
               case zTYPE_STRING:
               {
                  ...
                  zstrcpy( pchReturnStruct, pchRecordString );
#ifdef TRACE_STRUCT
   ...
   *pulReturnLth = 0; // initialize to 0.
   ...
   if ( lpViewAttrib->hDomain )
   {
      ...
      else
      {
         ...
         zstrcpy( sz, cpcEntityName );
         zstrcat( sz, ", " );
         zstrcat( sz, cpcAttributeName );
         zstrcat( sz, ", " );
         lpDomain = zGETPTR( lpViewAttrib->hDomain );
         zstrcat( sz, lpDomain->szName );
                           ...
                           zLONG            lIntegerValue )
{
   ...
   if ( lpViewAttrib->cType == zTYPE_STRING )
   {
      ...
      if ( lIntegerValue != lNullInteger )
         zltoa( lIntegerValue, szAttribValue );
                             ...
                             zLONG            lIntegerValue )
{
   ...
   if ( lpViewAttrib->cType == zTYPE_INTEGER )
   {
      ...
      if ( *lplLong != lNullInteger )
      {
         ...
         // everything by two so we don't have to convert longs to
         // decimals.
         zLONG l1 = *lplLong / 2;
                             ...
                             zCPCHAR cpcSrcEntityName )
{
   ...
   if ( lpSrcEntityInstance )
   {
      ...
      {
         pchRecord = fnRecordForEntityAttr( lpSrcEntityInstance,
                                            lpWrkViewAttrib );
         if ( pchRecord )
         {
            ...
            if ( pchBlob )
            {
               ...
               *lplLong = lpWrkViewAttrib->lERAttTok;
            }
            ...
            switch ( lpWrkViewAttrib->cType )
            {
               case zTYPE_STRING:
                  ...
                  if ( pchRecord[ 0 ] )
                  {
                     ...
                     // if this is the blob creation pass, set the data
                     // in the blob
                     if ( pchBlob )
                     {
                        ...
                        pchWork++;
                        zstrcpy( pchWork, pchRecord );
                        pchWork += zstrlen( pchWork ) + 1;
                     }
                     else
                     {
                        // Bump the length and blob pointers
               ...
               case zTYPE_INTEGER:
                  ...
                  if ( *lplLong2 != lNullInteger )
                  {
                     ...
                     {
                        // Increment length for attribute token, attribute
               ...
               case zTYPE_DECIMAL:
                  ...
                  if ( SysCompareDecimalToNull( lpdDecimal2 ) != 0 )
                  {
                     if ( pchBlob )
                     {
                        ...
                        SysAssignDecimalFromDecimal( lpdDecimal,
                                                     lpdDecimal2 );
               ...
               case zTYPE_BLOB:   // Blob attribute
                  if ( pchRecord[ 0 ] == (zCHAR) '\xff' )
                  {
                     ...
                     if ( pchBlob )
                     {
                        ...
                        zmemcpy( pchWork, (zPCHAR) lpuBlobLth,
                                 sizeof( zULONG ) );
               ...
               zLONG   lControl )
{
   ...
   zstrcpy( lpBlobOI->cpcViewOD_Name, lpViewOD->szName );

   if ( SysReadFile( lpSrcView, hFile,
                     pchData + sizeof( BlobOI_Record ), ulLth ) != ulLth )
   {
                ...
                zLONG   lControl )
{
   ...
   *plpTgtView = 0;
   ...
   if ( lControl & zNEW_OBJECT_NAME )
      zstrcpy( lpOI_Data->cpcViewOD_Name, pchReturnViewOD_Name );
   else
   if ( pchReturnViewOD_Name )
      zstrcpy( pchReturnViewOD_Name, lpOI_Data->cpcViewOD_Name );
...
//             TraceLineI( "(at) in SAFA SetAttrFromBlob nRC-", nRC );
         ...
         case zTYPE_DATETIME:
         {
            ...
            else
            {
               ...
               fnGetStringFromAttribute( szDateTime, 18, lpSrcView,
                                         lpSrcViewEntityCsr,
                                         lpSrcViewAttrib, 0 );
      ...
      switch ( lpSrcViewAttrib->cType )
      {
         ...
         case zTYPE_STRING:
            ...
            if ( szContextName[ 0 ] )
               ...
               GetStringFromAttribute( &szConcatBuffer[ idx ], lpView,
         ...
         case zTYPE_DECIMAL:
         {
            ...
            // together and overwrite the value we just concatenated to the
            // buffer.
            break;
         }
         ...
         case zTYPE_INTEGER:
         {
            ...
            zltoa( lIntValue, &szConcatBuffer[ idx ] );
...
// lpCurrentTask = fnFindTask( 0 );  // dks 2006.05.07  back to 10B
   ...
   if ( nRC < 0 )
   {
      ...
      if ( nRC < 0 )
      {
         SysMessageBox( lpView, "Internal Core Error",
                        "Error reading OI from buffer", 1 );
         return( zCALL_ERROR );
      }
   ...
   SetAttributeFromString( vStackObject, "OperationCall", "Name",
                           szOperName );
                            ...
                            zSHORT           nFlag )
{
        ...
        (lpVariable == 0 || *((zPCHAR) lpVariable) == 0) )
   {
      ...
      strcpy( szEntityName, "Entity:\t" );
      strcat( szEntityName, lpViewEntity->szName );

      strcpy( szAttribName, "Attribute:\t" );
      strcat( szAttribName, lpViewAttrib->szName );
   ...
   switch ( cDomainType )
   {
      ...
      case zDM_TYPE_FORMAT:
         if ( cVariableType != zTYPE_STRING )
         {
            ...
            sz1[ 7 ] = 0;
            zstrcat( sz1, ", Domain: " );
            zstrcat( sz1, lpDomain->szName );
            zstrcpy( sz2, lpViewEntity->szName );
            zstrcpy( sz2, ", " );
            zstrcpy( sz2, lpViewAttrib->szName );
         ...
         else
         {
            ...
            else
            {
               ...
               zstrcpy( pch, (zPCHAR) lpVariable );
               nRC = 0;
               if ( UfEditFormatString( pch, zGETPTR( lpContext->hEditString ) ) )
               {
                  zCHAR sz1[ 128 ];

                  zstrcpy( sz1, lpViewEntity->szName );
                  zstrcat( sz1, "." );
                  zstrcat( sz1, lpViewAttrib->szName );
                  zstrcat( sz1, "." );
                  zstrcpy( sz1, lpDomain->szName );
                  zstrcat( sz1, "." );
                  zstrcat( sz1, TrueName( cpcContextName, 0 ) );
              ...
              // the domain errors.  So instead we will issue the MessageSend here.
               ...
               //                sz1 );
                  zstrcpy( sz1, "Invalid data format.  Your data should be in the format: " );
                  zstrcat( sz1, zGETPTR( lpContext->hEditString ) );

                  //return( MessageSend( zView, szMsgID, pchTitle, szMsg, lMsgType, 0 ) );
                  MessageSend( lpView, "361",
      ...
      case zDM_TYPE_ALGORITHM:
         ...
         if ( nRC == zDME_NOT_HANDLED )
         {
            ...
            zsprintf( szMsg, "Operation '%s' does not handle an Entry "
      ...
      case zDM_TYPE_FORMAT:
         if ( cVariableType == zTYPE_PIC )
         {
            ...
            if ( lpContext )
            {
               ...
               {
                  zUSHORT u = zstrlen( zGETPTR( lpContext->hEditString ) );
                  if ( u > ulVariableLth )
                  {
                     LPTASK lpTask = zGETPTR( lpView->hTask );
               ...
               case 0:
               {
                  ...
                  if ( lpContext )
                  {
                                          ...
                                          zGETPTR( lpContext->hEditString ) ) )
                     {
                        ...
                        zstrcat( sz1, "/" );
                        zstrcat( sz1, lpViewAttrib->szName );
                        zstrcpy( sz2, lpDomain->szName );
                        zstrcat( sz2, "/" );
                        zstrcat( sz2, TrueName( cpcContextName, 0 ) );
...
//             ppvTablePosition - Used for internal positioning
//
                                ...
                                zPPVOID ppvTablePosition )
{
   ...
   switch ( cDomainType )
   {
      ...
      default:
         ...
         fnIssueCoreError( lpCurrentTask, lpView, 8, 244, 0, cpcEntityName,
                           cpcAttributeName );
         nRC = zCALL_ERROR;
   }
