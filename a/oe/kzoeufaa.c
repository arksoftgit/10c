        ...
        zSHORT nLth )
{
   ...
   zstrncpy( pchAsciiString + nPos, szTemp, k );
                  ...
                  zCPCHAR cpcEditString )
{
   ...
   zSHORT   n;
   zSHORT   nWSLength;           // length of WorkString

   pchReturnString[ 0 ] = 0;  // init to null string

   nWSLength = zstrlen( cpcDateTimeString );
   if ( nWSLength == 17 ||
        nWSLength == 14 ||
        nWSLength ==  8 ||
        nWSLength == 12 ||
   ...
   {
      // If no edit string, just copy the input work string to the
      // return string.
      zstrcpy( pchReturnString, cpcDateTimeString );
      return( 0 );
   }
   else
   {
      ...
      if ( zstrchr( cpcEditString, 'A' ) ||
           zstrchr( cpcEditString, 'P' ) )
      {
         bTwelveHour = TRUE;
         bAM = TRUE;
      }
         ...
         switch ( *pchEditString )
         {
            ...
            if ( *(pchEditString + 1) == 'M' )
            {
               ...
               if ( bAM )
               {
                  LPINTERNATIONAL lpInternational =
                                    zGETPTR( AnchorBlock->hInternational );
               ...
               zstrncpy( pchOutString, pchTrailer, n );
               pchOutString[ n ] = 0;
               pchOutString += n;
               pchEditString += 2;
            }
          ...
          case 'D':
            if ( zstrncmp( (pchEditString + 1), "ddd", 3 ) == 0 )
            {
               ...
               zstrcpy( pchOutString, g_pchDOW[ lDOW ] );
            ...
            {
               zLONG lDOW = UfGetDayOfWeek( cpcDateTimeString );
               zstrncpy( pchOutString, g_pchDOW[ lDOW ], 3 );
               pchOutString += 3;
               pchEditString += 3;
            }
            else
            ...
            if ( *(pchEditString + 1) == 'D' ||
                 *(pchEditString + 1) == 'd' )
            {
               // move the day of the month (w/leading zero if < 10 )
               // to output
            ...
            {
               // move the day of the month (w/o leading zero if < 10 )
               // to output
          ...
          case 'H':
            if ( nWSLength >= 12 ) // ensure WorkString contains HH
            {
          ...
          case 'j':
            ...
            {
               zltoal( UfGetDayOfYear( cpcDateTimeString ),
                       pchOutString, 3 );
               pchOutString += 3;
               pchEditString += 3;
            }
          ...
          case 'M':
            ...
            {
               if ( nWSLength >= 12 ) // Ensure WorkString contains MI
               {
            ...
            else
            {
               ...
               {
                  zstrcpy( pchOutString, g_pchMon[ lMonth ] );
               ...
               {
                  zstrncpy( pchOutString, g_pchMon[ lMonth ], 3 );
                  pchOutString += 3;
                  pchEditString += 3;
               }
               else
          ...
          case 'S':
            ...
            {
               if ( nWSLength >= 14 ) // Ensure WorkString contains SS
               {
                      ...
                      zCPCHAR cpcEditString )
{
   ...
   *(szDT + k) = 0;
   ...
   while ( *cpcEditString )
   {
      ...
      switch ( *cpcEditString )
      {
         ...
         case 'j':
            ...
            {
               if ( isdigit( *pchDTString ) &&
                    isdigit( *(pchDTString + 1) ) &&
                    isdigit( *(pchDTString + 2) ) )
               {
                  zstrncpy( szJulian, pchDTString, 3 );
                  szJulian[ 3 ] = 0;
                  bConvertJulian = TRUE;
                  bDayNeeded = TRUE;
                  cpcEditString += 3;
   ...
   if ( bError == FALSE )
   {
      ...
      {
         zCHAR szG[ 9 ];
         zstrncpy( sz, szDT, 4 ); // copy YYYY
         sz[ 4 ] = 0;
         zstrcat( sz, szJulian ); // copy jjj
...
UfStringToDateTime( zCPCHAR cpcDateTimeString, LPDATETIME lpDateTime )
{
   ...
   switch ( usStringLth )
   {
      ...
      case 15:   // YYYYMMDDHHmmSST
         ...
         zstrcpy( szWorkString, (zPCHAR) (cpcDateTimeString + 14) );
      ...
      case 8:    // YYYYMMDD
         ...
         // Get Year Value
         zstrncpy( szWorkString, cpcDateTimeString, 4 );
         szWorkString[ 4 ] = 0;
                    ...
                    zSHORT nMaxLth )
{
   ...
   zltoal( (zLONG) usYear, pchReturnString, 4 );          // year to string
   zltoal( (zLONG) usMonth, pchReturnString + 4, 2 );     // month to string
   zltoal( (zLONG) usDay, pchReturnString + 6, 2 );       // day to string
   if ( nMaxLth == 9 )
      return( 0 );

   zltoal( (zLONG) usHour, pchReturnString + 8, 2 );      // hour to string
   zltoal( (zLONG) usMinute, pchReturnString + 10, 2 );   // minute to string
   if ( nMaxLth == 13 )
      return( 0 );

   zltoal( (zLONG) usSeconds, pchReturnString + 12, 2 );  // seconds to string
   if ( nMaxLth == 15 )
      return( 0 );

   // milliseconds to string
   zltoal( (zLONG) usTSeconds, pchReturnString + 14,
           (zSHORT) (((nMaxLth - 15 ) > 3) ? 3 : (nMaxLth - 15)));
...
{
   return( fnCompareDateTimeToDateTime( (LPDTINTERNAL) lpDateTime1,
...
fnSetDateTimeComponent( LPDATETIME lpDateTime, zSHORT nCID, zLONG lValue )
{
   ...
   {
      case zDT_YEAR:
         zltoa( lValue + 10000L, sz );
         zmemcpy( szDateTime, sz + 1, 4 );
         break;

      case zDT_MONTH:
         zltoa( lValue + 100L, sz );
...
UfJulianToGregorian( zCPCHAR cpcJulian, zPCHAR pchGregorian )
{
   ...
   // Get Day Value
   zstrcpy( sz, (zPCHAR) (cpcJulian + 4) );
   usDay = (zUSHORT) zatol( sz );

   // Get Year Value
   zstrncpy( sz, cpcJulian, 4 );
   sz[ 4 ] = 0;
   ...
   {
      if ( (ulWorkYear % 4) == 0 &&
           ((ulWorkYear % 100) || (ulWorkYear % 400) == 0) )
      {
...
// TraceLineS( szMsg, "" );
   ...
   while ( (zUSHORT) nInLth > uLth || nInLth > 25 )
      nInLth -= uLth;
...
// zsprintf( szMsg, "UfEncryptString Out: \"%s\"", pchOut );
// TraceLineS( szMsg, "" );
   return( 0 );
}
...
// zsprintf( szMsg, "UfDecryptString Length: %d   In: \"%s\"", uLth, pchIn );
// TraceLineS( szMsg, "" );
   ...
   pchOut[ uChar ] = 0;
// zsprintf( szMsg, "UfDecryptString Out: \"%s\"", pchOut );
// TraceLineS( szMsg, "" );
   return( nReturnLth );
}
                 ...
                 zSHORT       nAmountType )
{
   ...
   // DGC:TODO -- use view passed in to get current task.  Uncomment other uses
   // of lpCurrentTask
   ...
   if ( fnCompareDateTimeToDateTime( &stNullDateTime,
                                     &dt ) == 0 )
      ...
      case zDT_MONTH:
         ...
         if ( nRC == 0 )
         {
            ...
            if ( nRC == zCALL_ERROR )
            {
               ...
               usDay = (zUSHORT) fnGetDateTimeComponent( (LPDATETIME) &dt,
                                                         zDT_DAY );
   ...
   if ( bDone == FALSE )
   {
      ...
      else
      {
         ...
         if ( fnCompareDateTimeToDateTime( &dt, (LPDTINTERNAL) lpDateTime )
              == -1 )
         {
            // overflow
            // "KZOEE235 - Integer overflow"
...
UfEditFormatString( zPCHAR pchReturnString, zCPCHAR cpcFormat )
{
   ...
   while ( pchReturnString[ j ] )
   {
      switch ( cpcFormat[ k ] )
      {
         ...
         case  ' ':
            // This code treats all spaces in pchReturnString as one space,
            // seems like we should consider how many spaces are in
            // cpcFormat.
                  ...
                  zLONG   lMaxTgtLth )
{
   ...
   zstrncpy( pchTgtString + lTgtIdx, cpcSrcString + lSrcIdx, lNbrToCopy );
                    ...
                    zLONG   lMaxTgtLth )
{
   ...
   {
      SysMessageBox( 0, szlOE_SystemError,
                     "ZeidonStringConcat: Invalid parameter.", 1 );
      return( qINVALIDPARAMETER );
   }
   ...
   {
      SysMessageBox( 0, szlOE_SystemError,
                     "ZeidonStringConcat: Target string has negative length.", 1 );
      return( qMAXRECEIVEISNEGATIVE );
   }
   ...
   {
      SysMessageBox( 0, szlOE_SystemError,
                     "ZeidonStringConcat: Source string has negative length.", 1 );
      return( qMAXCOPYISNEGATIVE );
   }
   ...
   {
      SysMessageBox( 0, szlOE_SystemError,
                     "ZeidonStringConcat: Target string is too small.", 1 );
      return( qMAXRECEIVEEXCEEDSTARGETLEN );
   }
   ...
   zstrncpy( pchTgtString + lTgtIdx, cpcSrcString + lSrcIdx, lNbrToConcat );
                     ...
                     zLONG   lMaxTgtLth )
{
   ...
   {
      SysMessageBox( 0, szlOE_SystemError,
                     "ZeidonStringCompare: Target string has negative length.", 1 );
      return( qMAXRECEIVEISNEGATIVE );
   }
   ...
   {
      SysMessageBox( 0, szlOE_SystemError,
                     "ZeidonStringCompare: Source string has negative length.", 1 );
      return( qMAXCOPYISNEGATIVE );
   }
   ...
   {
      SysMessageBox( 0, szlOE_SystemError,
                     "ZeidonStringCompare: Target string is too short.", 1 );
      return( qMAXRECEIVEEXCEEDSTARGETLEN );
   }
                               ...
                               zCPCHAR  cpcNumberType )
{
   ...
   {
      SysMessageBox( 0, szlOE_SystemError,
                     "ZeidonStringConvertFromNumber: Target string has negative length.", 1 );
      return( qMAXRECEIVEISNEGATIVE );
   }
...
//      return( qMAXRECEIVEEXCEEDSTARGETLEN );
   ...
   // if lMaxReceive is the default of 0 then the Max is really
   // lMaxTgtLth - lTgtIdx +1 ( as lTgtIdx is 1-based )
   if ( lMaxReceive == 0 )
      lMaxReceive = lMaxTgtLth -lTgtIdx +1;
   ...
   {
      SysMessageBox( 0, szlOE_SystemError,
                     "ZeidonStringConvertFromNumber: Invalid parameter.", 1 );
      return( qINVALIDPARAMETER );
   }
                        ...
                        zLONG   lMaxTgtLth )
{
   ...
   zstrcpy( pchTgtString + lTgtIdx, pchTgtString + lSrcIdx );
   return( zstrlen( pchTgtString ) );
}
               ...
               zCHAR  cReplace )
{
   ...
   for ( pch = pch2 = pchStr; *pch; pch++ )
   {
      ...
      if ( pchPrevChars )
      {
         // If we are at the beginning of the string then there is no prev
         // char so don't remove the char.
         if ( pch2 == pchStr )
         {
            *pch2++ = *pch;
            continue;
         ...
         // If pchPrevChars contains a '*', then we only remove the current
         // char if it is the same char as the previous char.
         if ( *pchPrevChars == '*' )
         {
            if ( *pch != *(pch2 - 1) )
            {
         ...
         {
            // The previous char is not in the pchPrevChars string, so we don't
            // want to remove the current char.
            *pch2++ = *pch;
            continue;
         }
      }

      // If we are replacing the removed char with something, then do it.
      // Since this doesn't make the string any shorter, continue.
      if ( cReplace )
      {
         *pch2++ = cReplace;
         continue;
      ...
      // By not copying the char we've deleted it. If we are deleting ALL
      // chars, continue loop.
      if ( cQualifier == 'A' )
         continue;
      ...
      if ( nLth > nShortNameLth )
         continue;  // Name still isn't short enough.

      // Name is short enough.  Copy the rest of the string and
      // break loop.
      for ( ; *pch; pch++, pch2++ )
         *pch2 = *pch;
...
//              nShortNameLth      max lth of output name
...
//       Phase 5. truncate the string to nShortNameLth.
//
//            NOTE: the algorith stops at the end of any phase that has a
//            result that is less than or equal to nShortNameLth unless
                ...
                zSHORT  nPhasesToForce )
{
   ...
   */
   ...
   nPhasesDone = 0;
   if ( nPhasesDone >= nPhasesToForce && zstrlen( sz ) <= nShortNameLth )
      goto EndOfFunction;
   ...
   *pch2 = 0;
   ...
   if ( pchUnderscoreMode && pchUnderscoreMode[ 0 ] )
   {
      ...
      fnRemoveChars( sz, nShortNameLth, pchUnderscoreMode[ 0 ], "_",
                     pchPrevChar, cReplace );
   }
   ...
   {
      fnRemoveChars( sz, nShortNameLth, pchLowerVowels[ 0 ], "aeiou", 0, 0 );

      if ( pchLowerVowels[ 1 ] == 'c' )
         fnRemoveChars( sz, nShortNameLth, pchLowerVowels[ 0 ],
   ...
   {
      fnRemoveChars( sz, nShortNameLth, pchOtherChars[ 0 ],
                     pchOtherChars + 1, 0, 0 );
   }
   ...
   //========================================================================
   //
   // 5. truncate the string to nShortNameLth.
   //
   //========================================================================
   sz[ nShortNameLth ] = 0;
            ...
            zBOOL  bTurnPriorProbeOff )
{
   ...
   if ( nProbeOn < 0)
   {
      ...
      ZeidonStringCopy( g_pProbeArea->Probes[ nProbeOn ].zp_Desc, 1, 0,
                        pchDesc, 1, 0, MAX_ZPROBEDESC );
   }
   else
   {
      if ( g_pProbeArea->Probes[ nProbeOn ].zp_Desc[ 0 ] != 0 )
      {
         ...
         if ( zstrcmpi( g_pProbeArea->Probes[ nProbeOn ].zp_Desc, pchDesc ) != 0 )
         {
            if ( g_pProbeArea->nErrShown3 < MAX_ZPROBEERRS )
            {
               ...
               TraceLineS( "UfZProbeOn: Invalid probe descriptor (current): ",
                           g_pProbeArea->Probes[ nProbeOn ].zp_Desc );
...
UfZProbeTrace( zPCHAR pchDesc )
{
   ...
   fElapsedTimeAll = (double) ( SysGetTickCount( )
                     - g_pProbeArea->ProbSetInitTime ) / zTICKS_PER_SECOND;
   ...
   zsprintf( szMsg, "======= Probe Trace - %30s ===START===", pchDesc );
   TraceLineS( szMsg, "" );
   zsprintf( szMsg, "zp.ALL. -- elapsed for Init to Trace->:%8.3f seconds",
             fElapsedTimeAll );
   TraceLineS( szMsg, "" );
   for ( k = 0; k <= g_pProbeArea->nProbes; k++)
   {
      ulCount = g_pProbeArea->Probes[ k ].zp_CountOff;
      fElapsedTime = (double) ( g_pProbeArea->Probes[ k ].zp_TotalTime )
                              / zTICKS_PER_SECOND;
      if ( ulCount == g_pProbeArea->Probes[ k ].zp_CountOn )
         zsprintf( szMsg, "zp.%03d. %30s:%8.3f secs. (avg.%8.3f for %8d times)",
                   k, g_pProbeArea->Probes[ k ].zp_Desc,
                   fElapsedTime, (fElapsedTime / ulCount), ulCount );
      else
         zsprintf( szMsg, "zp.%03d. %30s:%8.3f secs. (avg.%8.3f for %8d times OFF, but ON is %d times)",
                   k, g_pProbeArea->Probes[ k ].zp_Desc,
                   fElapsedTime, (fElapsedTime / ulCount), ulCount,
                   g_pProbeArea->Probes[ k ].zp_CountOn );

      TraceLineS( szMsg, "" );
   }

   zsprintf( szMsg, "======= Probe Trace - %30s === END ===", pchDesc );
   TraceLineS( szMsg, "" );
