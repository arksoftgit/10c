      ...
      if ( lpRPViewEntity->bRequiredChild )
      {
                 ...
                 lpScanViewEntity->nLevel > nVEStopLevel )
         {
                 ...
                 lpScanViewEntity->uCardMin )
            {
               ...
               strcpy( szRel, "\nEntity: \t" );
               strcat( szRel, lpScanViewEntity->szName );
              ...
              lpViewEntity != lpWrkViewEntity2 )
         {
                    ...
                    lpWrkViewEntity2->nHierNbr < lpViewEntity->nHierNbr )
            {
                    ...
                    lpWrkViewEntity2->uCardMin )
               {
                  ...
                  strcpy( szRel, "\nRelationship: \t" );
                  strcat( szRel, lpWrkViewEntity1->szName );
                  strcat( szRel, " <--> " );
                  strcat( szRel, lpWrkViewEntity2->szName );
                               ...
                               zSHORT nPosition )
{
   ...
   {
      strcpy( cpcEntityName, "\nEntity: \t" );
      strcat( cpcEntityName, lpSrcViewEntity->szName );
   ...
   {
      strcpy( cpcEntityName, "\nEntity: \t" );
      strcat( cpcEntityName, lpTgtViewEntity->szName );
        ...
        zstrcmp( lpSrcViewOD->szER_Date, lpTgtViewOD->szER_Date ) != 0 )
   {
      ...
      zsprintf( szMsg, "Out-of-sync error. Target LOD = %s, date = %s",
                lpTgtViewOD->szName, lpTgtViewOD->szER_Date );
      TraceLineS( "ERROR: ", szMsg );

      zsprintf( szMsg, "Out-of-sync error. Source LOD = %s, date = %s",
        ...
        lpSrcViewEntity->hFirstDataRecord == 0 )
   {
      ...
      zsprintf( szMsg, "%s.%s", lpViewOD->szName, lpTgtViewEntity->szName );
      TraceLineS( "   Target entity = ", szMsg );

      lpViewOD = zGETPTR( lpSrcView->hViewOD );
      zsprintf( szMsg, "%s.%s", lpViewOD->szName, lpSrcViewEntity->szName );
        ...
        lpTgtViewEntityCsr->hEntityInstance != UNSET_CSR )
   {
      ...
      if ( lpParentEntityInstance )
      {
                                               ...
                                               lpTgtViewEntity->lERRelTok ) )
         {
            ...
            zsprintf( szMsg, "Source view entity = %s, Target view entity = %s",
