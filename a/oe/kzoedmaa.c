...
//./ END + 3
zSHORT OPERATION
GetContext( zLPCONTEXT zFAR *lpReturnContext,
            LPDOMAIN lpDomain,
            zCPCHAR cpcContextName )
{
...
//./ END + 2
zSHORT OPERATION
GetDefaultContext( zLPCONTEXT zFAR *lpReturnContext,
                   LPDOMAIN lpDomain )
{
...
//./ END + 5
zCHAR
fnDomainProcessingRequired( LPTASKDOMAIN  zFAR *lpReturnTaskDomain,
                            zVIEW         lpView,
                            LPTASK        lpCurrentTask,
                            LPDOMAIN      lpDomain )
{
...
fnGetTableEntryForDomain( zVIEW lpView, LPVIEWENTITY lpViewEntity,
                          ...
                          zCPCHAR cpcContextName, zPVOID pvData,
                          ...
                          zLONG lFlag )  // 1-required   2-next
{
   ...
   if ( lpDomain->szDomainOper[ 0 ] )
   {
      ...
      if ( lpTaskDomain->pfDomainOper )
      {
         ...
         {
            zsprintf( szWorkString, "Operation '%s' does not handle an Entry "
      ...
      {
         zstrcpy( szWorkString, "Operation, " );
         zstrcat( szWorkString, lpDomain->szDomainOper );
         zstrcat( szWorkString, ", not found for Domain: " );
         zstrcat( szWorkString, lpDomain->szName );
         MessageSend( lpView, "TZDMD101", "System Error",
                      szWorkString, zMSGQ_DOMAIN_ERROR, 0 );
         nRC = -1;
      }
   ...
   if ( lFlag & 2 )  // next
   {
      ...
      lpTableEntry = *((LPTABLEENTRY zFAR *) pvTablePosition );
   ...
   nRC = *((LPTABLEENTRY zFAR *) pvTablePosition) ? 0 : -1 ; // -1 is end of table
   return( nRC );
}
      ...
      case zDME_GET_VARIABLE:
         ...
         if ( nRC == 0 )
         {
            ...
            if ( nLth <= ulMaxStringLth )
               zstrcpy( (zPCHAR) pvData, szWorkString2 );
            else
               zstrncpy( (zPCHAR) pvData, szWorkString2, ulMaxStringLth );
         }
         ...
         switch ( chType )
         {
            case zTYPE_INTEGER:
               ...
               // and return the corresponding internal value.
                  ...
                  zltoa( *((zPLONG) pvData), szIntString );
                  ...
                  case zTYPE_STRING:
                     ...
                     */
                     ...
                     else
                     {
                        ...
                        {
                           nRC = 1;
                           zstrcpy( (zPCHAR) pvData, szWorkString );
                        }
                     }
